 ...
 ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                ...
                <div class="card mb-4">
                    <form id="validation-form" method="post" enctype="multipart/form-data" action="save-raw-product-grn.php">
                        <div class="card-body">
<div class="form-row">

 <div class="form-group col-md-12">
<label class="form-label"> Vendor<span class="text-danger">*</span></label>
 <select class="selectpicker form-control" style="width: 100%;padding-top: 12px;" name="VedId" id="VedId" data-live-search="true">
...
<label class="form-label"> Raw Product<span class="text-danger">*</span></label>
 <select class="selectpicker form-control" name="ProdId" id="ProdId" onchange="getAvailProdStock(this.value,<?php echo $_SESSION['FranchiseId'];?>)" style="width: 100%;padding-top: 12px;"  data-live-search="true">

<option selected="" value="">Select Product</option>
<?php 
echo $sql12 = "SELECT tp.ProductName,tp.id FROM tbl_cust_products2 tp WHERE tp.id IN ($AllocatedProdIds) AND tp.ProdType='1' ORDER BY tp.ProductName";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
...
<script>
 ...
 function getProdDetails(id,frid){
  ...
  function getAvailProdStock(id,frid){
      getProdDetails(id,frid);
