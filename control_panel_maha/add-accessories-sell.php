...
$row7 = getRecord($sql7);
    ...
    $sql8 = "SELECT MAX(id) AS MaxId FROM tbl_accessories_sell";
$row8 = getRecord($sql8);
$MaxId = $row8['MaxId'] + 1;
$Invoice_No = "00".$MaxId;
...
$sql2 = "SELECT MAX(SrNo) as maxid FROM tbl_general_ledger WHERE Type='PR'";
    ...
    $sql3 = "INSERT INTO tbl_general_ledger SET SrNo='0',Code='',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',TotAmt='$TotalAmt',TotPaidAmt='0',TotBalAmt='0',PaidAmt='$TotalAmt',BalAmt='0',CrDr='dr',Roll=5,Type='INV',ProcFees='$ProcFees',CreatedDate='$CreatedDate',AccSellId='$SellId'";
    $conn->query($sql3);

    $sql4 = "INSERT INTO tbl_general_ledger SET SrNo='$SrNo',Code='$Code',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',TotAmt='$TotalAmt',TotPaidAmt='$DownPayment',TotBalAmt='$Balance',PaidAmt='$TotalAmt',BalAmt='$Balance',CrDr='cr',Roll=5,Type='PR',CreatedDate='$CreatedDate',AccSellId='$SellId',ProcFees='$ProcFees'";
    $conn->query($sql4);
echo "<script>alert('New Accessories Sell Added Successfully!');window.location.href='view-accessories-sells.php';</script>";
}
?>
...
<input type="text" name="InvoiceNo" class="form-control" id="InvoiceNo" placeholder="" value="<?php echo $Invoice_No; ?>" required>
<div class="clearfix"></div>
</div>
...
<label class="form-label">Accessories <span class="text-danger">*</span></label>
 <select class="form-control" name="AccId[]" id="AccId1"  onchange="getProdDetails(this.value,document.getElementById('srno1').value)" required>
...
<input type="number" name="Qty[]" id="Qty1" class="form-control" placeholder="e.g.,1" value="1" autocomplete="off" min="1" oninput="getTotal(document.getElementById('Qty1').value,document.getElementById('Price1').value,document.getElementById('srno1').value)" required>
</div>
...
<input type="text" name="SubTotal" id="SubTotal" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" readonly>
</div>

<div class="form-group col-md-3">
<label class="form-label">Service Charges <span class="text-danger">*</span></label>
<input type="text" name="ProcFees" id="ProcFees" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" oninput="getGrandTotal(document.getElementById('SubTotal').value,document.getElementById('Discount').value,document.getElementById('ProcFees').value)" required>
</div>

<div class="form-group col-md-3">
<label class="form-label">Discount <span class="text-danger">*</span></label>
<input type="text" name="Discount" id="Discount" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" oninput="getGrandTotal(document.getElementById('SubTotal').value,document.getElementById('Discount').value,document.getElementById('ProcFees').value)" required>
</div>

<div class="form-group col-md-3">
<label class="form-label">Total <span class="text-danger">*</span></label>
<input type="text" name="TotalAmt" id="TotalAmt" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" readonly>
</div>
