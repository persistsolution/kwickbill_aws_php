    ...
    <div class="card-body">
      ...
      <!--  <div class="form-group col-12 file-upload-block">
          ...
          <label>Upload Image</label>
             <input type="file" class="form-control" id="Photo21" name="Photo" accept=".png">
        </div>
        
        <div class="form-group float-label active col-12">
                                    <input type="file" class="form-control" id="Photo51" accept=".png" multiple onchange="convertToPDF(1)">
                                    <label class="form-control-label">Upload Multiple Photo For Making PDF</label>
                                    </div>
                                    <input type="hidden" class="form-control" name="Photo2" id="PdfLink1" value="<?php echo $result33['Photo2']; ?>" autofocus readonly>
        
                          <!-- <div class="form-group col-md-12">
          <label>Upload PDF</label>
             <input type="file" class="form-control" id="Photo21" name="Photo2" accept=".pdf">
        </div>-->
    ...
    <script>
        $(document).ready(function() {
            $('#validation-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "ajax_files/ajax_vendor_expenses_test.php",
                    method: "POST",
...
function stopProgress2() {
    ...
    const randomDecimal = Math.random();
      ...
      fetch("uploadmultphotos2.php", {
        method: "POST",
        body: formData
      })
      .then(response => response.text())
      .then(data => {
          $('#PdfLink'+srno).val('converted-images'+randomDecimal+'.pdf');
