...
if($_GET["action"]=="delete")
{
  ...
  ?>
    <script type="text/javascript">
      ...
      window.location.href="view-pending-orders.php";
    </script>
<?php } 
...
<table id="example" class="table mb-0 dataTable no-footer" role="grid" aria-describedby="report-table_info">
        ...
        <tbody>
            ...
            $sql = "SELECT *,'2024' AS Year FROM tbl_customer_invoice WHERE Roll=2 AND Status=0 AND FrId='$BillSoftFrId'";
            if($_POST['FromDate']){
            ...
            $sql.= "SELECT *,'2025' AS Year FROM tbl_customer_invoice_2025 WHERE Roll=2 AND Status=0 AND FrId='$BillSoftFrId'";
            if($_POST['FromDate']){
                $FromDate = $_POST['FromDate'];
                $sql.= " AND InvoiceDate>='$FromDate'";
            }
