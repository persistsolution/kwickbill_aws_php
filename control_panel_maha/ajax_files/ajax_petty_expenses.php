...
$sql = "SELECT * FROM tbl_expense_request WHERE UserId = '$user_id' AND Amount='$Amount' AND ExpenseDate='$ExpenseDate'";
$rncnt = getRow($sql);
if($rncnt > 0){
    echo 0;
}
    ...
    if($Roll == 1 || $Roll == 7){
        $qx = "INSERT INTO tbl_expense_request SET UserId = '$user_id',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst',TempPrdId='$TempPrdId',TempPrdId2='$TempPrdId2',VedPhone='$VedPhone',FrId='$FrId',Photo='$Photo',Photo2='$Photo2',Photo3='$Photo3',ExpCatId='$ExpCatId',TotDays='$TotDays',Locations='$Locations',AdminStatus=1,AccBy='$user_id',AdminApproveDate='$CreatedDate',Claims='$Claims'";
  $conn->query($qx); 
...
$qx = "INSERT INTO tbl_expense_request SET UserId = '$user_id',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst',TempPrdId='$TempPrdId',TempPrdId2='$TempPrdId2',VedPhone='$VedPhone',FrId='$FrId',Photo='$Photo',Photo2='$Photo2',Photo3='$Photo3',ExpCatId='$ExpCatId',TotDays='$TotDays',Locations='$Locations',Claims='$Claims'";
  $conn->query($qx); 
    }
  echo 1;
}
