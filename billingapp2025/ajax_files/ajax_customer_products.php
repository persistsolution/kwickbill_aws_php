...
if($_POST['action'] == 'Add'){
    ...
    $sql = "INSERT INTO tbl_cust_products SET ProductName='$ProductName',CatId='$CatId',MinPrice='$MinPrice',Status='$Status',SrNo='$SrNo',CreatedDate='$CreatedDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',ProdPrice='$ProdPrice',CgstAmt='$CgstAmt',SgstAmt='$SgstAmt',IgstAmt='$IgstAmt',BarcodeNo='$BarcodeNo',StockQty='$StockQty',TempPrdId='$TempPrdId',CreatedBy='$BillSoftFrId',modified_time='$modified_time',Transfer='$Transfer',Photo='$Photo',MinQty='$MinQty'";
    $conn->query($sql);
...
if($_POST['action'] == 'Edit'){
    ...
    $sql = "UPDATE tbl_cust_products SET ProductName='$ProductName',CatId='$CatId',MinPrice='$MinPrice',Status='$Status',SrNo='$SrNo',Photo='$Photo',ModifiedDate='$CreatedDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',ProdPrice='$ProdPrice',CgstAmt='$CgstAmt',SgstAmt='$SgstAmt',IgstAmt='$IgstAmt',BarcodeNo='$BarcodeNo',StockQty='$StockQty',modified_time='$modified_time',push_flag=1,Transfer='$Transfer',MinQty='$MinQty' WHERE id='$id'";
    $conn->query($sql);
    $ProdId = $_POST['id'];
