...
$dest = '../taskfiles/'. $randno . "_".$fnm . $ext;
...
$Photo = $imagepath ;
          ...
          {  
            if(trim($_POST["Task"][$i2] != ''))  
              { 
                ...
                $Task = $_POST['Task'][$i2];
                $sql = "INSERT INTO tbl_task_new SET UserId='$ExeId',TaskDate='$TaskDate',DueDate='$DueDate',TaskName='$Task',CreatedBy='$user_id',CreatedDate='$date',Status='0',Photo='$Photo'";
                $conn->query($sql);
  ...
  $VedPhone = $row2['Phone'];
                ...
                $smstxt = "Hello ".$VedName.", a new task has been assigned to you. Please check the Maha Connect app for task details. Please complete the task as soon as possible. - Maha Chai";
  $dltentityid = "1501701120000037351";
  $dlttempid = "1707175050197947524";
  $Phone = $VedPhone;
  include '../incsmsapi.php';  
    ...
    echo "<script>alert('Task Allocated Successfully!');window.location.href='view-task2.php';</script>";
        }
  }
?>
 ...
 <div class="form-group col-md-12">
                                            ...
                                            <span id="show_photo">
                                                <div class="ui-feed-icon-container float-left pt-2 mr-3 mb-3"><a
                                                        ...
                                                        src="../taskfiles/<?php echo $row7['Photo'];?>" alt=""
