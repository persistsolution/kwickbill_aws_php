...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_quotation SET CompId='$CompId',CustId='$CustId',CellNo='$CellNo',CustName = '$CustName',Status='$Status',Address='$Address',InvoiceNo='$InvoiceNo',InvoiceDate = '$InvoiceDate',QtnSubject='$QtnSubject',Details='$Details',TermsCondition='$TermsCondition',CreatedDate='$CreatedDate',CreatedBy='$user_id',RefEnqNo='$RefEnqNo',KindAttn='$KindAttn',TotalAmt='$TotalAmt'";
  $conn->query($qx);
            ...
            if(trim($_POST["ProductId"][$i] != ''))  
              {
                ...
                $sql22 = "INSERT INTO tbl_quotation_order_products SET SGST='$SGST',CGST='$CGST',IGST='$IGST',UserId='$CustId',SellId='$SellId',ProductName='$ProductName',Purity='$Purity',Weight='$Weight',Price='$Price',Making='$Making',HmCharge='$HmCharge',Qty='$Qty',TotalRate='$TotalRate',ProductId='$ProductId',ModelNo='$ModelNo',SellDate='$InvoiceDate'";
                $conn->query($sql22);
...
if($number > 0)  
  ...
  echo "<script>alert('Quotation Updated Successfully!');window.location.href='view-quotation.php';</script>";
