...
<head>
    <title><?php echo $Proj_Title; ?> - <?php if($_GET['id']) {?>Edit <?php } else{?> Add <?php } ?> Freelancer Account
    </title>
    <meta charset="utf-8">
...
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0"><?php if($_GET['id']) {?>Edit <?php } else{?> Add
                            <?php } ?> Business Partner Account</h4>

                        <div class="card mb-4">
                            <div class="card-body">
                                <div id="alert_message"></div>
                                <form id="validation-form" method="post" autocomplete="off" action="ajax_files/ajax_freelancer.php" enctype="multipart/form-data">
 ...
 <legend>Personal Detail</legend>
                                    <div class="form-row">
                                       ...
                                       <div class="form-group col-md-12">
                                            <label class="form-label">Business Partner Name <span
 ...
 <div class="form-group col-md-12">
                                       ...
                                       <!-- <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Referal No Of Partner 1</label>
                                            <input type="text" name="ReferalNo1" class="form-control"
                                                placeholder="" value="<?php echo $row7["ReferalNo1"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
                                        
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Referal No Of Partner 2</label>
                                            <input type="text" name="ReferalNo2" class="form-control"
                                                placeholder="" value="<?php echo $row7["ReferalNo2"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
                                        
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Nominee Of Partner Name</label>
                                            <input type="text" name="NomineePartnerName" class="form-control"
                                                placeholder="" value="<?php echo $row7["NomineePartnerName"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
                                        
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Nominee Of Partner Relation</label>
                                            <input type="text" name="NomineePartnerRelation" class="form-control"
                                                placeholder="" value="<?php echo $row7["NomineePartnerRelation"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
                                        
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Nominee Of Partner Contact No</label>
                                            <input type="text" name="NomineePartnerPhone" class="form-control"
                                                placeholder="" value="<?php echo $row7["NomineePartnerPhone"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
...
<!-- <input type="hidden" name="Roll" id="Roll" value="9"> -->
<div class="row">

  <div class="form-group col-md-12">
<label class="form-label"> Under By<span class="text-danger">*</span></label>
 <select class="select2-demo form-control" name="UnderUser" id="UnderUser" required>
<option selected="" value="0">Self</option>

<optgroup label="Managing Director">
 <?php 
  $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND Roll=62";
  $row12 = getList($sql12);
...
<optgroup label="Area Manager">
 <?php 
  $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND Roll=22";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
  <option <?php if($_POST["UserId"] == $result['id']) {?> selected <?php } ?> value="<?php echo $result['id'];?>">
...
<optgroup label="Regional Manager">
 <?php 
  $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND Roll=23";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
  <option <?php if($_POST["UserId"] == $result['id']) {?> selected <?php } ?> value="<?php echo $result['id'];?>">
...
<div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" id="Roll" name="Roll" required="">
                                                ...
                                                <option value="9" <?php if($row7["Roll"]=='9') {?> selected
                                                    <?php } ?>>Business Devlopment Manager </option>
                                                <option value="22" <?php if($row7["Roll"]=='22') {?> selected
                                                    <?php } ?>>Area Manager </option>
                                                <option value="23" <?php if($row7["Roll"]=='23') {?> selected
                                                    <?php } ?>>Regional Manager </option>
                                                <option value="62" <?php if($row7["Roll"]=='62') {?> selected
                                                    <?php } ?>>Managing Director </option>     
                                            </select>
                                            <div class="clearfix"></div>
                                        </div>
 ...
 <div class="form-group col-md-6">
                                            <label class="form-label">KYC Status <span class="text-danger">*</span></label>
                                            <select class="form-control" id="KycStatus" name="KycStatus" required="">
                                                <option selected="" disabled="" value="">Select KYC Status</option>
                                                <option value="1" <?php if($row7["KycStatus"]=='1') {?> selected
                                                    <?php } ?>>Active</option>
                                                <option value="0" <?php if($row7["KycStatus"]=='0') {?> selected
                                                    <?php } ?>>Pending</option>
                                            </select>
                                            <div class="clearfix"></div>
                                        </div>
                                      ...
                                      <div class="form-group col-md-6">
                                            ...
                                            <input type="date" name="KycDate" class="form-control"
                                                placeholder="" value="<?php echo $row7["KycDate"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
    ...
    $(document).ready(function() {
        ...
        $('#validation-form').on('submit', function(e) {
            ...
            if ($('#validation-form').valid()) {
                ...
                $.ajax({
                    url: "ajax_files/ajax_freelancer.php",
                    method: "POST",
