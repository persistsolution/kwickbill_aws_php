...
<h4 class="font-weight-bold py-3 mb-0">Transfer Stock Godown To COCO Franchise</h4>
...
<?php 
  $sql12 = "SELECT * FROM tbl_users_bill WHERE Roll=5 AND Status=1 AND OwnFranchise=1";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
