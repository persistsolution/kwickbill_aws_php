     ...
     <div class="layout-wrapper layout-1 layout-without-sidenav">
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <?php
                $id = $_GET['id'];
                $sql8 = "SELECT MAX(SrNo) AS MaxId FROM tbl_customer_invoice WHERE Roll=1";
                $row8 = getRecord($sql8);
                $MaxId = $row8['MaxId'] + 1;
                $Invoice_No = "00" . $MaxId;
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO tbl_customer_invoice SET AccCode='$AccCode',SrNo='$MaxId',CustId='$CustId',CustName='$CustName',
                            ...
                            BankName2='$BankName2',UpiNo2='$UpiNo2',Amount1='$Amount1',Amount2='$Amount2',Status='$Status',Roll=1";
                    $conn->query($sql);
                    ...
                    echo "<script>alert('Invoice Created Successfully!');window.location.href='view-franchise-invoices.php';</script>";
                }
                ?>
                <div class="layout-content">

                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Create Franchise Invoice</h4>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="select2-demo form-control" style="width: 100%" data-allow-clear="true" name="CustId" id="CustId">
                                                <option value="">Search Franchise</option>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <select class="form-control" style="width: 100%" data-allow-clear="true" name="ProdId[]" id="ProdId1" onchange="getPrice(this.value,document.getElementById('srno1').value)">
                                                                    ...
                                                                    <?php
                                                                    $sql4 = "SELECT * FROM products WHERE Status=1 AND ProdFor IN (1)";
                                                                    $row4 = getList($sql4);
                                                                    foreach ($row4 as $result) {
                                                                    ?>
