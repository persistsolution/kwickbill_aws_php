...
$qx = "INSERT INTO home_sliders SET Name = '$Name',Status='$Status',Photo='$Photo',Photo2='$Photo2',Roll='$Roll'";
	$conn->query($qx);
	echo 1;
}
...
$ModifiedDate = date('Y-m-d');
  $query2 = "UPDATE home_sliders SET Name = '$Name',Status='$Status',Photo='$Photo',Photo2='$Photo2',Roll='$Roll' WHERE id = '$id'";
 	$conn->query($query2);
  echo 1;
}
 ...
 $srno = 1;
  ...
  ?>
           <tr>
             ...
             <td><?php if($nx['Roll']=='1'){echo "Franchise";} 
             else if($nx['Roll']=='2') { echo "Employee"; } 
             else if($nx['Roll']=='4') { echo "Customer"; } 
             else if($nx['Roll']=='5') { echo "Barcode Customer"; } 
             else { echo "All";} ?></td>
             <?php if($_SESSION['Roll']==1) {?>
