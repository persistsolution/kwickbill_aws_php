...
<head>
<title><?php echo $Proj_Title; ?> | Year</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">List Of Year
...
<span class="font-weight-light">Year</span>
</h5>
...
<input type="text" name="Name" class="form-control" id="Name" placeholder="Year" required>
  ...
  $(document).ready(function() {
    ...
    $('#example').DataTable( {
      ...
      $('#add_button').click(function(){  
           $('.modal-title').html("Add <span class='font-weight-light'>Year</span>");  
           $('#action').val("Add");  
           $('#id').val('');
                ...
                success:function(data){  
                    ...
                    $('#Status').val(data.Status).attr("selected",true);  
                     ...
                     $('#action').val('Edit'); 
                       ...
                       $('#submit').text("Update");   
                       $('.insert_frm').modal('show');
                         $('.modal-title').html("Update <span class='font-weight-light'>Year</span>"); 
 ...
 //alert(id);
   swal({
            ...
            if (isConfirm) {
                ...
                success:function(data){
              swal("Deleted!", "Year has been deleted.", "success");
              ...
              category_lists();
                ...
                swal("Cancelled", "Year is safe :)", "error");
            }
        });
