...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO tbl_transfer_godown_raw_prod_stock_2025 SET GodownId='$GodownId',FranchiseId='$FranchiseId',StockDate='$StockDate',TotQty='$TotQty',Narration='$Narration',CreatedBy='$user_id',CreatedDate='$CreatedDate',TotalAmount='$TotalAmount',InvoiceNo='$InvoiceNo',GstAmount='$GstAmount',OwnShop=0";
    $conn->query($sql);
...
<h4 class="font-weight-bold py-3 mb-0">Transfer Stock Godown To Franchise</h4>
...
<?php 
  $sql12 = "SELECT * FROM tbl_users_bill WHERE Roll=5 AND Status=1 AND OwnFranchise=0";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
