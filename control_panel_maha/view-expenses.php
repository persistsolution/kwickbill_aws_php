...
<head>
<title><?php echo $Proj_Title; ?> | View Expenses List</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">View Expenses List
    <?php if(in_array("14", $Options)) {?>   
<span style="float: right;">
<a href="add-expenses.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
        ...
        <tbody>
           ...
           <?php if(in_array("10", $Options) || in_array("11", $Options)) {?>
            <td>
              ...
              <a href="add-expenses.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="lnr lnr-pencil mr-2"></i></a>
