...
<head>
<title><?php echo $Proj_Title; ?> | View Users Account List</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">View Users Account List
    <?php if(in_array("14", $Options)) {?>   
<span style="float: right;">
<a href="add-user.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            $sql = "SELECT tu.*,tb.Name As Branch FROM tbl_users tu LEFT JOIN tbl_branch tb ON tu.BranchId=tb.id WHERE tu.id!=1 AND tu.Roll NOT IN(5,6) ";
            if($Roll == 4){
                $sql.=" AND tu.SupervsId='$user_id'";
            }
            if($Roll == 7){
             $sql.=" AND tu.CatId='$UserCat'";   
            }
            ...
            <td>
              ...
              <a href="add-user.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="lnr lnr-pencil mr-2"></i></a>&nbsp;&nbsp;
