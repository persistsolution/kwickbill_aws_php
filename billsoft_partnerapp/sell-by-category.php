...
$Calendar = $_REQUEST['calendar'];
 $sql2 = "SELECT tcc.Name,tcid.CatId,SUM(tcid.Total) AS Total,SUM(tcid.Qty) AS TotProd FROM tbl_customer_invoice_details tcid INNER JOIN tbl_customer_invoice tci ON tci.id=tcid.InvId INNER JOIN tbl_cust_category tcc ON tcc.id=tcid.CatId WHERE tci.Roll=2 AND tci.FrId='$FranchiseId' AND tcc.CreatedBy='$FranchiseId' AND tcid.ServerInvId!=0";
