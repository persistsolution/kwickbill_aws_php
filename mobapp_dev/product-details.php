...
<head>
    ...
    <link rel='stylesheet' href='../fancy/lightslider.css'>
...
<script src='../fancy/lightslider.min.js'></script>
<script src='../fancy/jquery.fancybox.min.js'></script>
<script  src="../fancy/function.js"></script>
</head>
<style>
    .gallery-top {
  height: 100%;
 ...
 <input type="hidden" id="Prod_Id" value="<?php echo $_GET['id'];?>">
        <div class="main-container">
            <div class="container mb-4">
                ...
                <div class="card-body">
                    <!-- Swiper -->
                    <div class="swiper-container gallery-top" height="100%" width="100%">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide has-background">
                                <div id="lightSlider" class="">
                                    <a href="../uploads/<?php echo $row2['Files'];?>" data-fancybox="gallery"><img src="../uploads/<?php echo $row2['Files'];?>" width="100%" alt=""></a>
                                </div>
                            </div>
                            <?php }} else {?>
                            <div class="swiper-slide has-background">
                                <div id="lightSlider" class="">
                                    <a href="../uploads/<?php echo $row7['Photo'];?>" data-fancybox="gallery"><img src="../uploads/<?php echo $row7['Photo'];?>"  width="100%" alt=""></a>
                                </div>
                            </div>
                            <?php } ?>
                    ...
                    <div class="swiper-container gallery-thumbs">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide has-background">
                                <div class="">
                                    <img src="../uploads/<?php echo $row2['Files'];?>"  width="100%" alt="">
                                </div>
                            </div>
                            <?php }} else{?>
                            ...
                            <div class="swiper-slide has-background">
                                <div class="">
                                    <img src="../uploads/<?php echo $row7['Photo'];?>"  width="100%" alt="">
                                </div>
                            </div>
                            <?php } ?>
                        </div>
            ...
            <div class="container">
                ...
                <h5 class="text-success"><span id="MinPrice3">&#8377; <?php echo number_format($row7["MinPrice"],2); ?></span>
                               <?php if($row7['MaxPrice'] != $row7['MinPrice']){?>
                ...
                <hr>-->
                <p class="text-mute" style="text-align: justify;"><?php echo $row7["Details"]; ?></p>
                <br>
...
<div class="footer" style="height: 55px;">
    <div class="row no-gutters" style="padding-top: 10px;">
                    ...
                    <div class="col-auto" id="cart_btn">
                        <button class="btn btn-default rounded" id="add-cart"><i class="material-icons">local_mall</i> Add Cart</button>
                    </div>
                </div>
