...
if($_GET['id']==''){
    if($Roll == 1){
        $qx = "INSERT INTO tbl_expense_request SET Locations='$Locations',UserId = '$UserId',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst',TempPrdId='$TempPrdId',TempPrdId2='$TempPrdId2',VedPhone='$VedPhone',FrId='$FrId',ExpCatId='$ExpCatId',AdminStatus=1,AccBy='$user_id',AdminApproveDate='$CreatedDate'";
  $conn->query($qx); 
  ...
  $conn->query($sql);
     ...
     $qx = "INSERT INTO tbl_expense_request SET Locations='$Locations',UserId = '$UserId',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst',TempPrdId='$TempPrdId',TempPrdId2='$TempPrdId2',VedPhone='$VedPhone',FrId='$FrId',ExpCatId='$ExpCatId'";
  $conn->query($qx); 
    }
  $to = $row55['ExpMail'];
...
<?php 
    ...
    $query2 = "UPDATE tbl_expense_request SET Locations='$Locations',Photo='$Photo',Photo2='$Photo2',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',Gst='$Gst',VedPhone='$VedPhone',FrId='$FrId',ExpCatId='$ExpCatId' WHERE id = '$id'";
  $conn->query($query2);
  ?>
  <script type="text/javascript">
...
<option value="<?php echo $result['id'];?>" <?php if($row7["ExpCatId"] == $result['id']) {?> selected <?php } ?>>
   <?php echo $result['Name'];?></option>
     <?php } ?>
                                  ...
                                  <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Expense Category</label>
                            </div>
...
<option value="1" <?php if($row7["Claims"] == 1) {?> selected <?php } ?>>
   ...
   New Execution</option>
                                  ...
                                  <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Expense Claim</label>
                            </div>
...
<option value="<?php echo $result['id'];?>" <?php if($row7["FrId"] == $result['id']) {?> selected <?php } ?>>
   <?php echo $result['ShopName']." (".$result['Phone'].")";?></option>
     <?php } ?>
                                  ...
                                  <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Franchise</label>
                            </div>
   ...
   <?php echo $result['Name'];?></option>
     <?php } ?>
                   ...
                   <div class="form-group float-label active">
                            ...
                            <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Amount</label>
                        </div>
                        
                         <div class="form-group float-label active">
                            <input type="date" class="form-control" name="ExpenseDate" id="ExpenseDate" value="<?php echo $row7['ExpenseDate']; ?>">
                            <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Expense Date</label>                            
                        </div>
...
<option value="Online" <?php if($row7["PaymentMode"] == 'Online') {?> selected <?php } ?>>
    By Online</option>
                                  ...
                                  <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Payment Type</label>
                            </div>

 <div class="form-group float-label active">
                            <input type="number" class="form-control" name="VedPhone" id="VedPhone" value="<?php echo $row7['VedPhone']; ?>" required>
                            <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Vendor Mobile No</label>                            
                        </div>
                   

                        <div class="form-group float-label active">
                            <input type="text" class="form-control" id="Narration" name="Narration" value="<?php echo $row7['Narration']; ?>" required>
                            <label class="form-control-label" style="top: 0;font-size: 11px;line-height: 16px;">Narration</label>                            
                        </div>
                        
                         <div class="form-group float-label active">
                            <input type="file" class="form-control" id="Photo" name="Photo" accept=".png">
                            <label class="form-control-label active" style="top: 0;font-size: 11px;line-height: 16px;">Upload Receipt</label>                            
                        </div>
                      ...
                      <div class="form-group float-label active">
                            ...
                            <label class="form-control-label active" style="top: 0;font-size: 11px;line-height: 16px;">Upload Payment Receipt</label>                            
                        </div>
                        ...
                        <div class="form-group float-label active">
                            ...
                            <label class="form-control-label active" style="top: 0;font-size: 11px;line-height: 16px;">Upload PDF</label>                            
                        </div>
                        ...
                        <a href="../uploads/<?php echo $row7['Photo3']; ?>"><?php echo $row7['Photo3']; ?></a><?php } ?>
                         ...
                         <div class="form-group float-label active">
                            ...
                            <label class="form-control-label active" style="top: 0;font-size: 11px;line-height: 16px;">Upload Product Image</label>                            
                        </div>
...
<option value="No" <?php if($row7["Gst"] == 'No') {?> selected <?php } ?>>
  ...
  <option value="Yes" <?php if($row7["Gst"] == 'Yes') {?> selected <?php } ?>>
   Yes</option>
                                  ...
                                  <label class="form-control-label active" style="top: 0;font-size: 11px;line-height: 16px;">GST</label>
                            </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <?php if($result['ManagerStatus']=='2' || $result['AdminStatus']=='2'){?>
                                    <div class="col-auto pl-0">
                                        <button class="btn btn-40 bg-default-light text-default rounded-circle">
                                            <a href="add-expenses.php?id=<?php echo $result['id'];?>" class="btn-danger btn btn-sm btn-30 rounded"><i class="fa fa-edit"></i></a>
                                        ...
                                        <a href="view-expenses-new.php?action=delete&id=<?php echo $result['id'];?>"  class="btn-danger btn btn-sm btn-30 rounded"><i class="fa fa-trash"></i></a>
...
function uploadImageSingle2(prdid){
 ...
 $(document).ready(function() {
     ...
     $.ajax({  
                url :"ajax_files/ajax_expenses_test.php",  
                method:"POST",  
...
function(isConfirm){
  if (isConfirm) {
          window.location.href="view-expenses-new.php";
  }
}); });
