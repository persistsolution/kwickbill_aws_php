 ...
 ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                ...
                <div class="card mb-4">
                    <form id="validation-form" method="post" enctype="multipart/form-data" action="save-ved-selling-stock.php">
                        <div class="card-body">
<div class="form-row">
...
<?php 
  $sql12 = "SELECT id,ProductName FROM tbl_cust_products_2025 WHERE Status='1' AND CreatedBy='$FranchiseId' AND ProdType=0 AND ProdType2 IN (1,3) AND delete_flag=0 AND ProdType=0 AND checkstatus=1 ORDER BY ProductName";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
