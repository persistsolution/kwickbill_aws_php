            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO tbl_invoice SET AccCode='$AccCode',SrNo='$MaxId',CustId='$CustId',CustName='$CustName',
                            ...
                            GstAmt='$GstAmt',Status=1,CreatedBy='$user_id',CreatedDate='$CreatedDate',
            ...
            if(trim($_POST["TravelId"][$i] != ''))  
              {
                ...
                $TrainName = addslashes(trim($_POST['TrainName'][$i]));
                ...
                $sql22 = "INSERT INTO tbl_invoice_details SET InvId='$SellId',TravelId='$TravelId',TrainName='$TrainName',
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="select2-demo form-control" style="width: 100%" data-allow-clear="true" name="CustId" id="CustId">
                                                ...
                                                ?>
                                                    <option <?php if ($row7["UserId"] == $result['id']) { ?> selected <?php } ?> value="<?php echo $result['id']; ?>"><?php echo $result['Name'] . " - " . $result['Phone']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-2">
                                                                ...
                                                                <select class="form-control" style="width: 100%" data-allow-clear="true" name="TravelId[]" id="TravelId" onchange="getTrainName(this.value,document.getElementById('srno1').value)">
                                                            ...
                                                            <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-control" style="width: 100%" data-allow-clear="true" name="TrainNameId[]" id="TrainNameId1">
                                                                    <option selected value="" disabled>...</option>
                                                            ...
                                                            <div class="form-group col-md-2">
                                                                ...
                                                                <select class="form-control" style="width: 100%" data-allow-clear="true" name="FareClassId[]" id="FareClassId1">
                                                                    <option selected value="" disabled>...</option>
                                                            ...
                                                            <!-- <div class="form-group col-md-2">
                                                                ...
                                                                <input type="date" name="Dob[]" class="form-control" placeholder="e.g.,Rohit Sharma" value="" autocomplete="off" onchange="calAge(this.value,1)">
                                                            </div> -->

                                                            <div class="form-group col-md-1">
                                                                <label class="form-label">Age </label>
                                                                <div class="input-group">
                                                                    <input type="text" name="Age[]" id="Age1" class="form-control" placeholder="e.g.,32" value="" autocomplete="off" >
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="Price[]" id="Price1" class="form-control txt" placeholder="e.g.,5000" value="" autocomplete="off" required oninput="getSubTotal()">
                                                                    <div class="clearfix"></div>
