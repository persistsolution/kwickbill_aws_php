...
$CreatedDate = date('Y-m-d');
 ...
 //$TicketNo= "#".rand(1000,9999);
    ...
    $query2 = "UPDATE tbl_advance_salary SET HrApproveDate='$ApproveDate',HrComment='$HrComment',HrStatus='$HrStatus',HrBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);

  echo "<script>alert('Approved Successfully!');window.location.href='hr-pending-advance-request.php';</script>";
...
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Approve Advance Request</h4>
