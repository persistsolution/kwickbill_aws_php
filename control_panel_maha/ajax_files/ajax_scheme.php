...
$qx = "INSERT INTO tbl_scheme SET Name = '$Name',Status='$Status',Photo='$Photo',Phone = '$Phone',Phone2='$Phone2',EmailId='$EmailId',Address='$Address'";
	$conn->query($qx);
	echo 1;
}
}
...
if($row_cnt > 0){
  ...
  $query2 = "UPDATE tbl_scheme SET Name = '$Name', Status='$Status',Photo='$Photo',Phone = '$Phone',Phone2='$Phone2',EmailId='$EmailId',Address='$Address' WHERE id = '$id'";
 	$conn->query($query2);
 }
  echo 1;
}
