...
if($row['Roll'] == 5){
    ...
    echo "<script>window.location.href='../custapp_dev/home.php';</script>";
    exit();
}
else if($row['Roll'] == 3){
    echo "<script>window.location.href='../vedapp_dev/home.php';</script>";
    exit();
}
else{
    echo "<script>window.location.href='../exeapp_dev/home.php';</script>";
    exit();
}
?>
<!doctype html>
...
<style>
    .addsendcarousel .swiper-slide p {
  opacity: 1;
    }
    small, .small {
  font-size: 85%;
...
<!-- page content start -->
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;border-radius: 10px !important; ">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
            <?php 
                           $sql = "SELECT Photo FROM home_sliders WHERE Roll IN(1,3) ORDER BY id ASC";
                           $rx = $conn->query($sql);
        ...
        <a style="display: none" href="http://www.jssor.com">jquery content slider</a>
             ...
             <div class="container mb-2">
                <div class="row">
                    <div class="col  mb-2">
                        <h5 class="subtitle" style="font-size:13px;font-family: Consolas;letter-spacing: 8px;text-transform: uppercase;color: #000;">Shop by Category</h5>
                    </div>
                </div>
             <div class="">
                    <div class=" text-center ">
                        <div class="row">
                              <?php 
                          $sql2 = "SELECT * FROM category WHERE Status='1' AND Service!=1 AND Roll IN(1,3) ORDER BY id asc";
...
letter-spacing: 2px;"><?php echo $row2["Name"];?></small></p>
 ...
 <div class="container mb-2">
     <div class="row">
                    <div class="col  mb-2">
                        <h5 class="subtitle"  style="font-size:13px;font-family: Consolas;letter-spacing: 8px;text-transform: uppercase;color: #000;">Bestseller Products</h5>
                    </div>
                </div> 
    <?php 
     ...
     $start_from = ($page - 1) * $results_per_page;  
                        $CatId = $_GET['cat_id'];
                        $SubCatId = $_GET['subid'];
                        $query = "SELECT * FROM products WHERE Status='1' AND Bestseller='1' AND ProdFor IN(1,3)  ORDER BY id DESC";
                        //echo $query;
...
-ms-box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.05); border-radius: 15px; background: #fff;">
             ...
             <?php } ?>
                    ...
                    <div class="media-body " style="padding-top: 2px; padding-right:3px;" align="left">
                        ...
                        <?php } ?>
                        <span style="font-weight: 500; color:green;" id="MinPrice3<?php echo $result["id"];?>">&#8377; <?php echo number_format($result["MinPrice"],2); ?> </span>
