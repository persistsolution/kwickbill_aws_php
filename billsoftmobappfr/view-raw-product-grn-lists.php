...
<?php } ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                    ...
                    INNER JOIN tbl_cust_products2 p ON ts.ProdId=p.id WHERE ts.InvId='$id'";
                            $row = getList($sql);
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="text-secondary"><?php echo date("d/m/Y", strtotime(str_replace('-', '/',$result['StockDate'])))?><br>
                                           <strong style="font-family: arial;font-weight: bold;color: black !important;">Qty :</strong> <?php echo $result['Qty2']." ".$result['Unit2'];?> <br>
                                          <strong style="font-family: arial;font-weight: bold;color: black !important;"> Purchase Price :</strong> &#8377;<?php echo $result['PurchasePrice'];?> | <strong style="font-family: arial;font-weight: bold;color: black !important;">Total Price :</strong> &#8377;<?php echo $result['SellPrice'];?>
                                       </p>
