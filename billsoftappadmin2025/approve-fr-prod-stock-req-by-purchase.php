...
echo "<script>alert('Approved Successfully');window.location.href='view-mrp-product-stock-request.php';</script>";
}
?>
            <div class="layout-container">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Approve MRP Product Stock Request</h4>
...
<div style="overflow-x: auto; width: 100%;">
  ...
  $total = $result['Qty'] * $result['PurchasePrice'];
            $grandTotal += $result['Qty'];
  ?>
  <tr>
    <td><?php echo $i;?></td>
  ...
  <td><input type="text" name="PurchaseQty[]" class="form-control" value="<?php echo $result['PurchaseQty'];?>"></td>
