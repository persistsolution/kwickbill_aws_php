...
<h4 class="font-weight-bold py-3 mb-0">List Of Outlet Audit Questions
...
<?php 
        $q = "select * from tbl_audit_category WHERE Status='1'";
        $r = $conn->query($q);
...
function category_lists(){
  var action = 'view';
      $.ajax({
  type: "POST",
  url: "ajax_files/ajax_audit_questions.php",
   data:{action:action},   
