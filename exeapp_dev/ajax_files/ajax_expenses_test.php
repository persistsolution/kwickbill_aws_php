...
$ext = end(explode(".", $FileName3));
if($ext == 'pdf'){
    $randno = rand(1,100);
$src = $_FILES['Photo3']['tmp_name'];
$fnm = substr($_FILES["Photo3"]["name"], 0,strrpos($_FILES["Photo3"]["name"],'.')); 
$fnm = str_replace(" ","_",$fnm);
$ext = substr($_FILES["Photo3"]["name"],strpos($_FILES["Photo3"]["name"],"."));
$dest = '../../uploads/'. $randno . "_".$fnm . $ext;
$imagepath =  $randno . "_".$fnm . $ext;
if(move_uploaded_file($src, $dest))
{
...
$ext = end(explode(".", $FileName4));
if($ext == 'pdf'){
    $randno = rand(1,100);
$src = $_FILES['Photo4']['tmp_name'];
$fnm = substr($_FILES["Photo4"]["name"], 0,strrpos($_FILES["Photo4"]["name"],'.')); 
$fnm = str_replace(" ","_",$fnm);
$ext = substr($_FILES["Photo4"]["name"],strpos($_FILES["Photo4"]["name"],"."));
$dest = '../../uploads/'. $randno . "_".$fnm . $ext;
$imagepath =  $randno . "_".$fnm . $ext;
if(move_uploaded_file($src, $dest))
{
