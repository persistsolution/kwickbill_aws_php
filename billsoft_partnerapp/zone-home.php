...
<div class="swiper-container categories2tab1 text-center mb-4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <?php if($ownfr == 1){?>
                            <a href="zone-home.php?ownfr=1&zoneid=<?php echo $_REQUEST['zoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">COCO</a>
                            <?php } else {?>
                            <a href="zone-home.php?ownfr=1&zoneid=<?php echo $_REQUEST['zoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">COCO</a>
                            <?php } ?>
                        </div>
                        <div class="swiper-slide">
                            <?php if($ownfr == 2){?>
                            <a href="zone-home.php?ownfr=2&zoneid=<?php echo $_REQUEST['zoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">FOFO</a>
                            <?php } else {?>
                            <a href="zone-home.php?ownfr=2&zoneid=<?php echo $_REQUEST['zoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">FOFO</a>
                            <?php } ?>
                        </div>
                        <div class="swiper-slide">
                           <?php if($ownfr == 0){?>
                            <a href="zone-home.php?ownfr=0&zoneid=<?php echo $_REQUEST['zoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">Other</a>
                            <?php } else {?>
                            <a href="zone-home.php?ownfr=0&zoneid=<?php echo $_REQUEST['zoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">Other</a>
                            <?php } ?>
                        </div>
...
$Calendar = $_REQUEST['calendar'];
 $sql = "SELECT SUM(NetAmount) AS NetAmount,COUNT(*) AS TotInv,tc.FrId,tu.ShopName,tu.Address FROM tbl_customer_invoice tc INNER JOIN tbl_users_bill tu ON tu.id=tc.FrId WHERE tu.Roll='5' AND tu.OwnFranchise='".$ownfr."' AND tu.id IN($frids)";
if($Roll != 1){
