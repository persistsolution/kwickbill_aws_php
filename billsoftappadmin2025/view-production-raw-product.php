...
$MainPage="Production";
$Page = "View-Production-Raw-Product";
?>
<!DOCTYPE html>
...
{
  $id = $_REQUEST["id"];
  $sql11 = "DELETE FROM tbl_raw_production_products WHERE id = '$id'";
  $conn->query($sql11);
  ?>
    <script type="text/javascript">
      alert("Deleted Successfully!");
      window.location.href="view-production-raw-product.php";
    </script>
<?php } ?>
...
<a href="add-production-raw-product.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            <?php 
            $i=1;
            $sql = "SELECT tp.* FROM tbl_raw_production_products tp 
           ...
           <?php if(in_array("10", $Options) || in_array("11", $Options)) {?>
            <td>
              ...
              <a href="add-production-raw-product.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="lnr lnr-pencil mr-2"></i></a>
