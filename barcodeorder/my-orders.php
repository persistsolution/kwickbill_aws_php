...
padding-left: 1px;">
                ...
                <div class="card mb-3">
                     <div class="card-header border-bottom">
                        <h6 class="mb-0" style="text-align: center;">My Regular Orders</h6>
                    </div>
                     <?php 
                                     ...
                                     $ToDate = date("Y-m-d", strtotime(str_replace('/', '-',$_POST['ToDate'])));
                                       ...
                                       $sql2 = "SELECT ord.*,os.Name As OrderStatus,pm.Name As Payment_Method FROM orders ord 
                                           ...
                                           WHERE ord.UserId='$user_id' AND ord.Status=1 AND ord.Type='Cart' AND ord.PayStatus=1 ORDER BY ord.srno DESC"; 
                                    ...
                                    //echo $sql2;
                                        ...
                                        $Total_Order = $row["OrderTotal"]+$row["ServiceFee"]-$row["Promoprice"]-$row["Discount"];
                                     ?>
