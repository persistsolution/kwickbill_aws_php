...
$qx = "INSERT INTO home_banners SET Name = '$Name',Status='$Status',Photo='$Photo',Roll='$Roll'";
	$conn->query($qx);
	echo 1;
}
...
$ModifiedDate = date('Y-m-d');
  $query2 = "UPDATE home_banners SET Name = '$Name',Status='$Status',Photo='$Photo',Roll='$Roll' WHERE id = '$id'";
 	$conn->query($query2);
  echo 1;
}
