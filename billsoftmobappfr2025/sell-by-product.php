...
$Calendar = $_REQUEST['calendar'];
 $sql2 = "SELECT tcc.ProductName,tcc.MinPrice,tcid.ProdId,SUM(tcid.Total) AS Total,SUM(tcid.Qty) AS TotProd FROM tbl_customer_invoice_details_2025 tcid INNER JOIN tbl_customer_invoice_2025 tci ON tci.id=tcid.InvId INNER JOIN tbl_cust_products_2025 tcc ON tcc.id=tcid.ProdId WHERE tci.Roll=2 AND tci.FrId='$FranchiseId' AND tcc.CreatedBy='$FranchiseId'";
