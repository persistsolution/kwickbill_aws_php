    ...
    <main class="flex-shrink-0 main">
        ...
        <div class="main-container">
            <div class="container mb-4">
                <form action="PaytmKit/pgRedirect.php" method="post" id="validation-form" autocomplete="off">
...
<input type="hidden" id="Phone" name="Phone" autocomplete="off" value="<?php echo $Phone1;  ?>">
            ...
            size="12" name="CHANNEL_ID" autocomplete="off" value="WEB">
                ...
                <div class="form-group mb-1" style="padding-top:15px;padding-bottom:15px;">
                    <input type="number" style="background-color: #fff;" class="form-control large-gift-card" value="500" name="TXN_AMOUNT" id="Amount" placeholder="00.00">
                </div>
                ...
                <button type="button" name="submit" class="btn btn-default mb-2 mx-auto rounded" style="background-color: #e36012;" onclick="addMoney()">Add Money</button>
            </div>
               </form>
            </div>
        </div>
