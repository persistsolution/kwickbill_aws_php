     ...
     <div class="layout-wrapper layout-1 layout-without-sidenav">
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <?php 
$id = $_GET['id'];
$sql7 = "SELECT te.*,tu.Fname,tu.Lname,tu.Photo AS Uphoto FROM tbl_advance_request te LEFT JOIN tbl_users tu ON tu.id=te.UserId WHERE te.id='$id'";
$row7 = getRecord($sql7);
$EmpId = $row7['UserId'];
...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_advance_request SET AdminApproveDate='$ApproveDate',AdminComment='$MannagerComment',AccAmount='$AccAmount',AdminStatus='$ManagerStatus',AccBy='$user_id',Status='$ManagerStatus' WHERE id = '$id'";
  $conn->query($query2);
  ...
  $sql = "INSERT INTO wallet SET UserId='$EmpId',Amount='$AccAmount',Narration='$Narration',Status='Dr',CreatedDate='$CreatedDate',CreatedTime='$CreatedTime',AdvId='$id'";
  $conn->query($sql);
  }
  echo "<script>alert('Approved Successfully!');window.location.href='advance-request.php';</script>";
...
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Approve Advance</h4>
 ...
 <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-3">
                                         ...
                                         <div class="form-group col-md-12">
                                            <label class="form-label">Advance For</label>
                                            <input type="text" name="TaskDate" class="form-control"
