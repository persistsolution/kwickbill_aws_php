...
$MainPage = "Account";
$Page = "Add-Customer-Borrowing-Amount";
?>
<!DOCTYPE html>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0"><?php if($_GET['id']) {?>Edit <?php } else{?> Receiev
                            <?php } ?> Customer Borrowing Amount</h4>
...
<div class="form-group col-md-12">
   <label class="form-label">Narration</label>
    ...
    function getCollections(CustId){
         var action = "getCollections";
         //var CustId = $('#CustId').val();
            $.ajax({
                url: "ajax_files/ajax_cust_borrowing_general_ledger.php",
                method: "POST",
                data: {
                    action: action,
                    CustId:CustId
...
//console.log(data);exit();
                        if (data == 0) {
                           ...
                           alert("Not Saved");
                            ...
                            alert("Saved");
                            setTimeout(function() {
                                window.location.href = 'view-cust-borrowing-amount.php';
                            }, 2000);
                        }
