            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO tbl_customer_invoice SET AccCode='$AccCode',SrNo='$MaxId',CustId='$CustId',CustName='$CustName',
                            ...
                            BankName2='$BankName2',UpiNo2='$UpiNo2',Amount1='$Amount1',Amount2='$Amount2',Status='$Status',Roll=2";
                    $conn->query($sql);
                    ...
                    echo "<script>alert('Invoice Created Successfully!');window.location.href='view-customer-invoices.php';</script>";
                }
                ?>
