...
$MainPage="Masters";
$Page = "Franchise-Location";
?>
<!DOCTYPE html>
<html lang="en" class="default-style">
<head>
<title><?php echo $Proj_Title; ?> | Franchise Location</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">List Of Franchise Location
...
<span class="font-weight-light">Franchise Location</span>
</h5>
...
function product_lists(){
  var action = 'view';
      $.ajax({
  type: "POST",
  url: "ajax_files/ajax_fracnhise_location.php",
   data:{action:action},  
