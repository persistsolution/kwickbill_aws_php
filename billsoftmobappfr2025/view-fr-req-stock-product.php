    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                ...
                <div>
                    <span class="label">Requested Qty:</span><span class="value"><?php echo $result['Qty']; ?></span>
                </div>
                ...
                <div>
                    <span class="label">Approved Qty:</span><span class="value"><?php echo $approveqty ?: '-'; ?></span>
                </div>
