...
<?php 
$id = $_GET['id'];
$query = "SELECT * FROM tbl_transfer_godown_raw_prod_stock_2025 WHERE id = '$id'";
$row = getRecord($query);
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="">
                            <div class="card-body p-2">
                                ...
                                <strong>STOCK TRANSFER JOURNAL</strong>
                                <br><br>
...
<strong><?php echo $row7['ShopName'];?></strong><br>
...
Mobile: <?php echo $row7['Phone'];?><br></div>
        ...
        <?php 
$i=1;
$sql44 = "SELECT ttg.*,tgp.ProductName FROM tbl_transfer_godown_raw_stock_items_2025 ttg LEFT JOIN tbl_cust_products2 tgp ON ttg.ProdId=tgp.id WHERE ttg.TransferId='$id'";
$row44 = getList($sql44);
...
?>                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-3">
                                                 ...
                                                 <td class="py-3">
                                                    <strong>₹<?php echo $TotPrice-$TotGst;?></strong>
                                                </td>
