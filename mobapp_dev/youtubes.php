        ...
        <div class="main-container">
            ...
            <div class="container mb-4">
                ...
                <div class="row">
                    ...
                    <?php 
            $i=1;
            $sql3 = "SELECT * FROM tbl_video_gallery WHERE Status=1 AND VideoFor IN (3)";
                   $rncnt2 = getRow($sql3);
                   if($rncnt2 > 0){
                    $res2 = getList($sql3);
                    foreach($res2 as $row){ 
...
<div class="lightboxjs-link" data-width="100%" data-height="auto" data-url="https://www.youtube.com/embed/<?php echo $row["Name"]; ?>?autoplay=1"><img width="100%" height="auto" src="../uploads/<?php echo $row["Photo"]; ?>"></div>
