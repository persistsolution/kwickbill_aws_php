...
<label class="custom-file">
<input type="file" class="custom-file-input" id="Photo2" name="Files2[]" style="opacity: 1;" multiple="">
<span class="custom-file-label"></span>
</label>
 <span id="show_photo2">
<?php 
...
<optgroup label="BDM">
 <?php 
  $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND Roll IN (134,145,181)";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
...
<div class="form-group col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php  
                                        $sql33 = "SELECT * FROM tbl_options WHERE BillSoft=0 ";
                                        $row33 = getList($sql33);
