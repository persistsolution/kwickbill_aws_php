...
$id = $_GET['id'];
$sql7 = "SELECT * FROM tbl_nso_vendor_expenses WHERE id='$id'";
...
?>
   ...
   <div class="card-body">
                           ...
                           <input type="hidden" id="TempPrdId2" name="TempPrdId2" value="<?php echo rand(10000,99999);?>">
                            ...
                            <input type="text" class="form-control" autocomplete="off" name="VedName" id="VedName" onClick="this.select();" placeholder="search vendor..." value="<?php echo $VedName;?>" required>
                          <div id="autocomplete-list" class="autocomplete-list" style="display: none; position: absolute;"></div>
                            <label class="form-control-label active">Vendor <span class="text-danger">*</span></label>                            
                        </div>
                       
                        
                        <div class="form-group float-label active">
                            <input type="text" class="form-control" name="VedId" id="VedId" value="<?php echo $row7['VedId']; ?>" readonly required>
                            <label class="form-control-label">Vendor ID <span class="text-danger">*</span></label>                            
                        </div>
                                        
                                        <div class="form-group float-label active">
                            <input type="text" class="form-control" name="TradeName" id="TradeName" value="<?php echo $row7['TradeName']; ?>" required>
                            <label class="form-control-label">Trade/Business Name <span class="text-danger">*</span></label>                            
                        </div>
                                        
                                         <div class="form-group float-label active">
                            <input type="number" class="form-control" name="VedPhone" id="VedPhone" value="<?php echo $row7['VedPhone']; ?>" required>
                            <label class="form-control-label">Vendor Mobile No <span class="text-danger">*</span></label>                            
                        </div>
                        ...
                        <div class="form-group float-label active">
                          ...
                          <div class="form-group float-label active">
                            ...
                            <label class="form-control-label">Invoice Amount <span class="text-danger">*</span></label>
                        </div>
                        
                         <div class="form-group float-label active">
                            <input type="date" class="form-control" name="ExpenseDate" id="ExpenseDate" value="<?php echo $row7['ExpenseDate']; ?>" required>
                            <label class="form-control-label">Invoice Date <span class="text-danger">*</span></label>                            
                        </div>
                         ...
                         <div class="form-group float-label active">
                          ...
                          <div class="form-group float-label active">
                            <input type="text" class="form-control" autocomplete="off" name="FrLocations" id="FrLocations" placeholder="search Location..." value="<?php echo $FrLocations; ?>" required onClick="this.select();">
                          <div id="autocomplete-list2" class="autocomplete-list" style="display: none; position: absolute;"></div>
                            <label class="form-control-label">Locations <span class="text-danger">*</span></label>                            
                        </div>
                        
                         <div class="form-group float-label active">
                            <input type="text" class="form-control" name="Locations" id="Locations" value="<?php echo $Locations; ?>" readonly required>
...
<option selected="" value="" disabled>Select Payment Type <span class="text-danger">*</span></option>
...
<option value="Tax Invoice" <?php if($row7["InvType"] == 'Tax Invoice') {?> selected <?php } ?>>
    Tax Invoice</option>
                                  ...
                                  <label class="form-control-label">Type Of Invoice <span class="text-danger">*</span></label>
                            </div>
                        ...
                        <div class="form-group float-label active">
                            <input type="file" class="form-control" id="Photo2" name="Photo2" accept=".pdf" required>
...
let currentFocus2 = -1;
 ...
 var action = "getNewFrLocationList";
            $.ajax({
                url :"ajax_files/ajax_dropdown.php",  
                method: "POST",
                data: {
    ...
    <script>
     ...
     $.ajax({  
                url :"ajax_files/ajax_nso_vendor_expenses.php",  
                method:"POST",  
...
function(isConfirm){
  if (isConfirm) {
          window.location.href="view-nso-vendor-expenses.php";
  }
}); });
