...
<?php 
$id = $_GET['id'];
$sql8 = "SELECT MAX(srno) AS MaxId FROM tbl_return_prod_stock WHERE ProdType=3";
$row8 = getRecord($sql8);
$MaxId = $row8['MaxId'] + 1;
$Invoice_No = "00" . $MaxId;
?>
...
<?php 
  if(isset($_POST['submit'])){
    ...
    if($_GET['id'] == ''){
     $qx = "INSERT INTO tbl_return_prod_stock SET srno='$srno',InvNo='$InvNo',VedId='$VedId',CreatedBy='$user_id',ReturnDate='$ReturnDate',Narration='$Narration',CreatedDate='$CreatedDate',FrId='$BillSoftFrId',ProdType=3";
  $conn->query($qx);
            ...
            if(trim($_POST["ProdId"][$i] != ''))  
              {
                ...
                $sql22 = "INSERT INTO tbl_return_prod_items SET InvId='$InvId',FrId='$BillSoftFrId',ProdId='$ProdId',Qty='$Qty',Unit='$Unit',CreatedBy='$user_id',ReturnDate='$ReturnDate',ReturnStatus='0',CreatedDate='$CreatedDate',ProdType=3";
                $conn->query($sql22);
              }  
  ...
  echo "<script>alert('Product Stock Return Successfully!Please Wait For admin Approval');window.location.href='return-godown-products.php';</script>";
}
...
<h4 class="font-weight-bold py-3 mb-0">Return Godown Product</h4>
