                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="text-secondary"><?php echo date("d/m/Y", strtotime(str_replace('-', '/',$result['StockDate'])))?><br>
                                           <strong style="font-family: arial;font-weight: bold;color: black !important;">Qty :</strong> <?php echo $result['Qty'];?> <br>
                                          <strong style="font-family: arial;font-weight: bold;color: black !important;"> Purchase Price :</strong> &#8377;<?php echo $result['PurchasePrice'];?> | <strong style="font-family: arial;font-weight: bold;color: black !important;">Sell Price :</strong> &#8377;<?php echo $result['SellPrice'];?>
                                       </p>
