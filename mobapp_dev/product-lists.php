       ...
       <div class="container mb-2"  >
                ...
                <div class="swiper-container categoriestab1 text-center">
                    <div class="swiper-wrapper">
                        ...
                        <?php 
                          $sql2 = "SELECT * FROM category WHERE Status='1' AND Roll IN(1,3)";
...
<div class="container mb-4">
    ...
    <?php 
     ...
     $start_from = ($page - 1) * $results_per_page;  
                        ...
                        $SubCatId = $_GET['subid'];
                        $brand_id = $_GET['brand_id'];
                        $query = "SELECT * FROM products WHERE Status='1' AND ProdFor IN(1,3)";
                        if($_GET['cat_id']!=''){
                        $query.= " AND CatId='$CatId'";
                        }
                        if($_GET['subid']!=''){
                        $query.= " AND SubCatId='$SubCatId'";
                        }
                        if($_GET['brand_id']!=''){
      ...
      <input type="hidden" id="qntno<?php echo $result["id"];?>" value="1">   
             ...
             <?php } ?>
                            ...
                            <div class="card-body " align="center">
                                 ...
                                 <!--<p class="mb-0"><small class="text-secondary">Ram <?php echo $result['Ram'];?> | Storage <?php echo $result['Hdd'];?></small></p>-->
                        ...
                        <br>-->
                                                        ...
                                                        <h5 class="mb-0" style="color:green;paddding-top:5px;padding-bottom:5px;"><?php if($result['MaxPrice'] != $result['MinPrice']){?>
                                                            <span id="MaxPrice3<?php echo $result["id"];?>"><del>&#8377;<?php echo number_format($result["MaxPrice"],2);?> </del></span><?php } ?>&nbsp;
                                                             <span id="MinPrice3<?php echo $result["id"];?>">&#8377;<?php echo number_format($result['MinPrice'],2);?>/-</span></h5>
...
transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;" onchange="getDiffSize(this.value,<?php echo $result["id"];?>)">
 <?php if($result['Size']=='0') {} else if($result['CatId'] != 0){?>
            ...
            <li class="page-item">
              <a class="page-link" href="<?php echo $_SERVER['PHP_SELF']; ?>?page=1&BrandId=<?php echo $_GET['BrandId'];?>" aria-label="Previous">
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
             ...
             ?>
                                <li class="<?php echo $activeclass ?>">
                                    <a class="page-link" href="<?php echo $_SERVER['PHP_SELF']; ?>?page=<?php echo $i;?>&BrandId=<?php echo $_GET['BrandId'];?>"><?php echo $i;?></a>
                                </li>
                                <?php }; ?>
                                <li class="page-item">
                                    <a class="page-link" href="<?php echo $_SERVER['PHP_SELF']; ?>?<?php if($total_pages>=1){?>page=<?php echo $total_pages;?><?php } else{?>&page=<?php echo $total_pages+1;}?>&BrandId=<?php echo $_GET['BrandId'];?>" aria-label="Next">
                                        <span aria-hidden="true">»</span>
