...
<head>
    <title><?php echo $Proj_Title; ?> - <?php if($_GET['id']) {?>Edit <?php } else{?> Add <?php } ?> User Account
    </title>
    <meta charset="utf-8">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="password" name="Password" class="form-control"
                                                placeholder="" value="<?php echo $row7["Password"]; ?>" required>
                                            <div class="clearfix"></div>
                                        </div>
...
<br>
                                    <div class="row">
                                        <?php  
                                        $sql33 = "SELECT * FROM tbl_options WHERE id NOT IN(10,11,14,15)";
                                        $row33 = getList($sql33);
                        ...
                        checked="checked" <?php } ?>>
                                    ...
                                    <?php  
                                        $sql33 = "SELECT * FROM tbl_options WHERE id IN(10,11,14,15)";
                                        $row33 = getList($sql33);
                                        foreach($row33 as $result){
                                        ?>
                                        <div class="form-group col-md-4">
...
<div class="clearfix"></div>
     ...
     <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="Roll" name="Roll" required="">
                                                ...
                                                <option value="1" <?php if($row7["Roll"]=='1') {?> selected
                                                    <?php } ?>>Super Admin</option>

                                                    <option value="7" <?php if($row7["Roll"]=='7') {?> selected
                                                    <?php } ?>> Admin</option>
                                                    
                                                <option value="2" <?php if($row7["Roll"]=='2') {?> selected
                                                    <?php } ?>>Telecaller</option>
                                                <option value="4" <?php if($row7["Roll"]=='4') {?> selected
                                                    <?php } ?>>Supervisior</option>

                                                 <option value="3" <?php if($row7["Roll"]=='3') {?> selected
                                                    <?php } ?>>Technician</option>
                                            </select>
                                            <div class="clearfix"></div>
                                        </div>
    ...
    $(document).ready(function() {
        ...
        $('#validation-form').on('submit', function(e) {
            ...
            if ($('#validation-form').valid()) {
                ...
                $.ajax({
                    url: "ajax_files/ajax_user_account.php",
                    method: "POST",
