...
<div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 " style="padding-top:10px;">
                        ...
                        <div id="gallery-thumbnails" class="row form-row">
                            ...
                            ?>
                            <div align="center" class="gallery-thumbnail col-sm-4 col-md-6 col-xl-3 mb-2" data-tag="cat<?php echo $result['id'];?>" style="">
                                ...
                                <strong style="text-align:center;font-size: 14px;"><?php echo $result2['ProductName'];?></strong><br>
