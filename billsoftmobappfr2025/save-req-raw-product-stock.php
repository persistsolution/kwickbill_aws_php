...
$row = getRecord($sql);
$InvNo = "R00".$row['NextId'];
$SrNo = $row['NextId'];
$sql = "INSERT INTO tbl_fr_req_stock_inv SET VedId='$VedId',FrId='$fr_id',SrNo='$SrNo',InvNo='$InvNo',StockDate='$StockDate',TotalQty='$TotQty',Narration='$Narration',bill='$bill',CreatedBy='$user_id',CreatedDate='$CreatedDate',ProdType=1";
$conn->query($sql);
