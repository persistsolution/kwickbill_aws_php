                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="custom-file-upload">
                                ...
                                <input type="file" name="photos[]" id="photos" accept=".png" multiple class="custom-file-input">
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="custom-file-upload">
                                ...
                                <input type="file" id="video" name="video" accept=".mp4" class="custom-file-input">
                            </div>
