...
State: Maharashtra</div>
        ...
        <?php 
$i=1;
$sql44 = "SELECT ttg.*,tgp.ProductName FROM tbl_request_product_stock_items_2025 ttg LEFT JOIN tbl_cust_products_2025 tgp ON ttg.ProdId=tgp.id WHERE ttg.TransferId='$id'";
$row44 = getList($sql44);
