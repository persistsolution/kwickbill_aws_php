        ...
        <div class="main-container">
            ...
            <div class="card">
                    <div class="card-body text-center ">
                        <div class="row">
                             <?php 
                          $sql2 = "SELECT * FROM category WHERE Status='1' AND Service!=1";
                        ...
                        <div class="card border-0 mb-4 overflow-hidden">
                            <div class="card-body position-relative" style="height:80px;">
                              
                                <a href="sub-category.php?cat_id=<?php echo $row2['id']; ?>" class="background" style="height:80px;">
                                     <?php if($row2["Photo"] == '') {?>
                  <img src="no_image.jpg" style="width: 166px;height: 150px;"> 
                 <?php } else if(file_exists('../uploads/'.$row2["Photo"])){?>
                 <img src="../uploads/<?php echo $row2["Photo"];?>" alt="" style="width: 166px;height: 150px;">
                  <?php }  else{?>
                 <img src="no_image.jpg" style="width: 166px;height: 150px;"> 
             <?php } ?>
