...
<h4 class="font-weight-bold py-3 mb-0">List Of Discount Percentage
...
<span class="font-weight-light">Discount Percentage</span>
</h5>
...
<input type="number" name="Name" class="form-control" id="Name" placeholder="" required>
  ...
  $(document).ready(function() {
    ...
    $('#example').DataTable( {
      ...
      $('#add_button').click(function(){  
           $('.modal-title').html("Add <span class='font-weight-light'>Discount</span>");  
           $('#action').val("Add");  
           $('#id').val('');
                ...
                success:function(data){  
                    ...
                    $('#Status').val(data.Status).attr("selected",true);  
                     ...
                     $('#action').val('Edit'); 
                       ...
                       $('#submit').text("Update");   
                       $('.insert_frm').modal('show');
                         $('.modal-title').html("Update <span class='font-weight-light'>Discount</span>"); 
 ...
 //alert(id);
   swal({
            ...
            if (isConfirm) {
                ...
                success:function(data){
              swal("Deleted!", "Discount has been deleted.", "success");
              ...
              category_lists();
                ...
                swal("Cancelled", "Discount is safe :)", "error");
            }
        });
