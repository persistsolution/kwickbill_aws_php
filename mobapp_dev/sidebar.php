    ...
    <div class="main-menu">
        <div class="row mb-4 no-gutters">
            ...
            <div class="col pl-3 text-left align-self-center">
                ...
                <p class="small text-default-secondary" style="color:#f06721;font-weight:bold;"> Wallet : &#8377;<?php echo number_format($mybalance,2);?> </p>
        ...
        <?php } } ?>
            <ul class="nav nav-pills flex-column ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/view-assets.php">
                        <div>
                            <span class="material-icons icon">local_shipping</span>
                            Your Assets
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/survey-form.php">
                        <div>
               ...
               <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/youtubes.php"> 
                        <div>
                            <span class="material-icons icon">help</span>
                            MahaTube Promotional
                        </div>
                        <!--<span class="arrow material-icons">chevron_right</span>-->
                    </a>
                </li>
                ...
                <li class="nav-item">
                     <a class="nav-link" href="youtubes.php">
                        <div>
                            <span class="material-icons icon">loyalty</span>
                            video
                        </div>
