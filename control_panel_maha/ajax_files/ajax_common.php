...
$qx = "INSERT INTO tbl_common_master SET Name = '$Name',Status='$Status',Roll='$Roll',Type='$Type'";
	$conn->query($qx);
	echo 1;
}
}
...
if($row_cnt > 0){
  ...
  $query2 = "UPDATE tbl_common_master SET Name = '$Name', Status='$Status',Roll='$Roll',Type='$Type' WHERE id = '$id'";
 	$conn->query($query2);
 }
  echo 1;
}
