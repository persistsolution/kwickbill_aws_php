...
{
  $id = $_REQUEST["id"];
  $sql11 = "DELETE FROM tbl_use_raw_stock WHERE id = '$id'";
  $conn->query($sql11);
  $sql11 = "DELETE FROM tbl_raw_stock WHERE UseRawId = '$id'";
  $conn->query($sql11);
  ?>
    <script type="text/javascript">
      alert("Deleted Successfully!");
      window.location.href="view-uses-raw-products.php";
    </script>
<?php } ?>
...
<h4 class="font-weight-bold py-3 mb-0">Use Raw Products
  <?php if(in_array("14", $Options)) {?> 
<span style="float: right;">
<a href="use-raw-products.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            <?php 
            $i=1;
            $sql = "SELECT tp.* FROM tbl_use_raw_stock tp 
