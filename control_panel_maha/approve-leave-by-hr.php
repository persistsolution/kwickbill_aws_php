        ...
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $query2 = "UPDATE tbl_leave_request SET HrApproveDate='$ApproveDate',HrComment='$HrComment',HrStatus='$HrStatus',HrBy='$user_id' WHERE id = '$id'";
                    $conn->query($query2);
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="TaskDate" class="form-control"
                                                        placeholder="" value="<?php echo $CityName; ?>" readonly>
                                                    <div class="clearfix"></div>
                                                </div>
...
<div class="form-group col-md-3">
                                         ...
                                         <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="TotDays" class="form-control"
                                                placeholder="" value="<?php echo $row7["TotDays"]; ?>" readonly>
                                            <div class="clearfix"></div>
                                        </div>
