...
<!-- page content start -->
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 600px; height: 250px; overflow: hidden;border-radius: 10px !important; ">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 250px; overflow: hidden;">
            <?php 
                           $sql = "SELECT Photo FROM home_sliders WHERE Roll IN(4,3) ORDER BY id ASC";
                           $rx = $conn->query($sql);
...
letter-spacing: 2px;">All </small></p>
                        </div>
                              ...
                              <?php 
                          $sql2 = "SELECT * FROM tbl_cust_category WHERE Status='1' AND CreatedBy='$FranchiseId' ORDER BY srno asc";
 ...
 <div class="container mb-4">
    ...
    <?php 
     ...
     $start_from = ($page - 1) * $results_per_page;  
                        $CatId = $_GET['cat_id'];
                        $SubCatId = $_GET['subid'];
                        $query = "SELECT * FROM tbl_cust_products WHERE Status='1' AND CreatedBy IN ($FranchiseId) AND QrDisplay='Yes' ORDER BY srno asc";
                        //echo $query;
