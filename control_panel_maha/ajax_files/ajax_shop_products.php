...
<label class="form-label d-none d-md-block">&nbsp;</label><button type="button" class="btn btn-primary" id="add"><i class="ion ion-md-add"></i>&nbsp; Add More</button>
</div>
<!-- <div class="form-row col-md-3">
<div class="form-group col-lg-6">
...
<button type="button" id="<?php echo $i;?>" class="btn btn-outline-danger btn_remove"><i class="ion ion-md-close"></i>&nbsp;Remove</button>
</div>
<!--<div class="form-row col-md-4">
 <div class="form-group col-lg-6">
...
<div class="form-row col-md-2">
    <label class="form-label d-none d-md-block">&nbsp;</label><button type="button" onclick="deleteAttr(<?php echo $row3['id']; ?>,<?php echo $ProdId; ?>);" class="btn btn-outline-danger"><i class="ion ion-md-close"></i>&nbsp;Remove</button>
<!-- <div class="form-group col-lg-6">
