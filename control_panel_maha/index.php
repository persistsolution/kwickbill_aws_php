<?php include_once 'config.php'; echo "<script>window.location.href='index-new.php';</script>";exit(); ?>
<!DOCTYPE html>
            ...
            <div class="d-flex col-lg-4 align-items-center bg-white p-5">
                ...
                <div class="d-flex col-sm-7 col-md-5 col-lg-12 px-0 px-xl-4 mx-auto">
                    <div class="w-100">
                        ...
                        <h4 class="text-center  font-weight-normal mt-3 mb-0">Sign in to your account</h4><br>
