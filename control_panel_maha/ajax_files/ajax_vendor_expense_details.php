...
if($_POST['action'] == 'Save'){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_vendor_expenses SET AdminApproveDate='$ApproveDate',AdminComment='$MannagerComment',AccAmount='$AccAmount',AdminStatus='$ManagerStatus',AccBy='$user_id',Status='$ManagerStatus' WHERE id = '$id'";
  $conn->query($query2);
  
  if($ManagerStatus == 1){
  $sql = "DELETE FROM wallet WHERE UserId='$EmpId' AND ExpId='$id'";
  $conn->query($sql);
  $Narration = "Amount Credited against Expense For ".$ExpenseFor;
  $sql = "INSERT INTO wallet SET UserId='$EmpId',Amount='$AccAmount',Narration='$Narration',Status='Cr',CreatedDate='$CreatedDate',CreatedTime='$CreatedTime',ExpId='$id'";
  $conn->query($sql);
  }
...
if($_POST['action'] == 'MgrSave'){
 ...
 //$TicketNo= "#".rand(1000,9999);
    echo $query2 = "UPDATE tbl_vendor_expenses SET ApproveDate='$ApproveDate',ManagerComment='$MannagerComment',MgrAmount='$MgrAmount',ManagerStatus='$ManagerStatus',MrgBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
