      ...
      text-align: center;
        ...
        <div class="main-container">
            <div class="container">
             ...
             <?php include 'start-attendance-new.php';?>
...
<form id="validation-form" method="post" autocomplete="off">
               <div class="card mb-4">
                 ...
                 <div class="col-lg-6 col-6">
                 <button type="button" class="btn btn-sm btn-default rounded" onclick="endAttendance()"  <?php if($rncnt9 > 0){?> disabled <?php } else if($rncnt8 > 0) {} else {?> disabled <?php } ?>>End Attendance</button>
                 </div>
                 </div>
...
<script type="text/javascript">
    function endAttendance(){
        window.location.href="end-attendance-form.php";
    }
    var markers = [
...
function uploadImageSingle(prdid){
 ...
 $(document).ready(function() {
    ...
    $('#add_more').click(function(){  
        ...
        html+='<div class="form-group float-label active">';
        html+='<div class="input-group">';
        html+='<input type="text" class="form-control" value="" name="Task[]" >';
        html+='<div class="input-group-append">';
        html+='<button class="btn btn-block btn-danger rounded btn_remove" type="button" id="'+i+'">X</button>';
        html+='</div>';
        html+='</div>';
        html+='<label class="form-control-label">Task</label>';
        html+='</div>';
        html+='</div>';
        html+='</div>';
