...
echo "<script>alert('Approved Successfully');window.location.href='view-raw-product-stock-request.php';</script>";
}
?>
            <div class="layout-container">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Approve Raw Product Stock Request</h4>
                                ...
                                <div id="alert_message"></div>
                                    ...
                                    <div class="form-row">
                                     ...
                                     <div class="form-group col-md-2">
                                        ...
                                        <?php 
                                         $sql2 = "SELECT tve.*,tcp.ProductName FROM tbl_fr_req_prod_stock tve INNER JOIN tbl_cust_products2 tcp ON tcp.id=tve.ProdId WHERE tve.InvId='".$_GET['id']."'";
               $rncnt2 = getRow($sql2);
               ?>
                                        <div class="form-group col-md-2">
