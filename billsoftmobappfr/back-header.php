    ...
    color: white;">&#8377;<?php echo number_format($mybalance,2);?></a>&nbsp;&nbsp;&nbsp;
                ...
                <?php } else{?>
                    <a href="shopping-cart.php" class=" btn btn-40 btn-link" style="padding-top:10px;" >
                        ...
                        <span  class="counter" style="color:#fff;font-weight:600;font-size:13px;"><span style="background-color:#287939;padding:4px;border-radius:10px;" id="showcount">0</span></span>
                    </a>
                <?php } ?>
