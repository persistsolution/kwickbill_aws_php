...
$Page = "View-Accessories";
?>
<!DOCTYPE html>
<html lang="en" class="default-style">
<head>
<title><?php echo $Proj_Title; ?> | View Accessories List</title>
<meta charset="utf-8">
...
{
  $id = $_REQUEST["id"];
  $sql11 = "DELETE FROM tbl_accessories WHERE id = '$id'";
  $conn->query($sql11);
  ?>
    <script type="text/javascript">
      alert("Deleted Successfully!");
      window.location.href="view-accessories.php";
    </script>
<?php } ?>
...
<h4 class="font-weight-bold py-3 mb-0">View Accessories List
    <?php if(in_array("14", $Options)) {?>   
<span style="float: right;">
<a href="add-accessories.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
        ...
        <tbody>
           ...
           <?php if(in_array("10", $Options) || in_array("11", $Options)) {?>
            <td>
              ...
              <a href="add-accessories.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="lnr lnr-pencil mr-2"></i></a>
