...
if($_GET["action"]=="deleteprd")
{
  ...
  ?>
    <script type="text/javascript">
      ...
      window.location.href="edit-customer-invoice.php?id=<?php echo $bid;?>";
    </script>
<?php }
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "DELETE FROM tbl_general_ledger WHERE SellId='$SellId' AND Flag='Customer-Invoice' AND Main=1";
                    $conn->query($sql);
                    ...
                    if ($number > 0) {
                        for ($i = 0; $i < $number; $i++) {
                            if (trim($_POST["ProdId"][$i] != '')) {
                                ...
                                $sql22 = "INSERT INTO tbl_customer_invoice_details SET InvId='$SellId',      ProdId='$ProdId',Qty='$Qty',Price='$Price',CreatedDate='$InvoiceDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',Total='$Total',CustProd=1,CgstAmt='$CgstAmt',SgstAmt='$SgstAmt',IgstAmt='$IgstAmt'";
                                $conn->query($sql22);
                                ...
                                $conn->query($sql22);
                                 ...
                                 $sql22 = "INSERT INTO tbl_product_stocks SET InvDetId='$InvDetId',InvId='$SellId',ProdId='$ProdId',Qty='$Qty',Price='$Price',StockDate='$InvoiceDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',Total='$Total',CrDr='dr',Roll='Franchise-Stock',UserId='$user_id'";
                                $conn->query($sql22);*/
                            }
                        }
                    }

      echo "<script>alert('Invoice Updated Successfully!');window.location.href='view-customer-invoices.php';</script>";
                }
                ?>
                <div class="layout-content">

                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Edit Customer Invoice</h4>
                                        ...
                                        <div class="form-group col-md-2">
                                         ...
                                         <input type="hidden" value="" id="PackageId" name="PackageId">
                                          <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="PkgAmt" id="PkgAmt" class="form-control" placeholder="" value="<?php echo $row7['PkgAmt'];?>" autocomplete="off" readonly>
                                            <div class="clearfix"></div>
                                        </div>
                                        
                                         <div class="form-group col-md-2">
                                            <label class="form-label">Prime Discount % </label>
                                            <input type="text" name="PkgDiscount" id="PkgDiscount" class="form-control" placeholder="" value="<?php echo $row7['PkgDiscount'];?>" autocomplete="off" readonly>
                                            <div class="clearfix"></div>
                                        </div>
                                        
                                         <div class="form-group col-md-2">
                                            <label class="form-label">Valid Upto  </label>
                                            <input type="date" name="PkgValidity" id="PkgValidity" class="form-control" placeholder="" value="<?php echo $row7['PkgValidity'];?>" autocomplete="off" readonly>
                                            <div class="clearfix"></div>
                                        </div>
...
$i=1;
 ...
 <input type="hidden" name="CgstAmt[]" id="CgstAmt<?php echo $i; ?>" value="<?php echo $result12["CgstAmt"]; ?>">
 <input type="hidden" name="SgstAmt[]" id="SgstAmt<?php echo $i; ?>" value="<?php echo $result12["SgstAmt"]; ?>">
 <input type="hidden" name="IgstAmt[]" id="IgstAmt<?php echo $i; ?>" value="<?php echo $result12["IgstAmt"]; ?>">
 ...
 <input type="hidden" name="CgstAmt[]" id="CgstAmt<?php echo $row_cnt; ?>" value="">
 <input type="hidden" name="SgstAmt[]" id="SgstAmt<?php echo $row_cnt; ?>" value="">
 <input type="hidden" name="IgstAmt[]" id="IgstAmt<?php echo $row_cnt; ?>" value="">
    ...
    <?php include_once 'footer_script.php'; ?>
       <script>
        function TotAmount(Price,Qty,CgstPer,SgstPer,IgstPer,Srno){
            var PrdPrice = Number(Price) * Number(Qty);
            var CgstAmt = Number(PrdPrice) * (Number(CgstPer) / 100);
            var SgstAmt = Number(PrdPrice) * (Number(SgstPer) / 100);
            var IgstAmt = Number(PrdPrice) * (Number(IgstPer) / 100);
            ...
            var Total_Amount = Number(PrdPrice) + Number(GstAmt);
