...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_request_product_stock SET AdminApproveDate='$AdminApproveDate',AdminComment='$AdminComment',AdminStatus='$AdminStatus',AdminBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);

  echo "<script>alert('Approved Successfully!');window.location.href='admin-pending-request-product-stock.php';</script>";
