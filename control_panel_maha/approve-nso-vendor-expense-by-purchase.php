...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_nso_vendor_expenses SET GrnNo='$GrnNo',Locations='$Locations',PurchaseApproveDate='$ApproveDate',PurchaseComment='$MannagerComment',PurchaseAmount='$MgrAmount',PurchaseStatus='$ManagerStatus',PurchaseBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
  ...
  echo "<script>alert('Approved Successfully!');window.location.href='nso-purchase-vendor-pending-expense-request.php';</script>";
...
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Approve NSO Vendor Expense By Purchase Dept</h4>
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="form-group col-md-2">
                                       ...
                                       <!-- <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="form-label">NSO Dept Approve Amount</label>
                                            <input type="text" class="form-control"
...
<option value="Final Payment" <?php if($row7["PaymentMode"] == 'Final Payment') {?> selected <?php } ?>>
    Final Payment</option>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="TaskDate" class="form-control"
                                                placeholder="" value="<?php echo $row7["AdvAmount"]; ?>" required>
                                            <div class="clearfix"></div>
                                        </div>
