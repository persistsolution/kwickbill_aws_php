...
<?php 
  $sql12 = "SELECT id,ProductName,MinPrice FROM tbl_cust_products_2025 WHERE Status='1' AND CreatedBy='$BillSoftFrId' AND delete_flag=0 AND ProdType=0 AND checkstatus=1";
  $row12 = getList($sql12);
