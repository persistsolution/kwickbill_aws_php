...
if ($_POST['action'] == 'saveExpenses') {
    ...
    if ($id == '') {
        ...
        $qx = "UPDATE tbl_expense_request SET SendToApproval='$SendToApproval',Narration = '$Remark',Amount='$TotAmt',ExpenseDate='$ExpenseDate',ModifedDate='$CreatedDate',ModifedBy='$user_id',Gst='$Gst',
            ...
            if (trim($_POST["Amount"][$i] != '')) {
               ...
               if (isset($_FILES['Photo2']['name'][$i]) && $_FILES['Photo2']['name'][$i] != ''){
                ...
                foreach ($_SESSION["cart_item$srno"] as $product) {
                    ...
                    $qx = "INSERT INTO tbl_emp_expense_prod_items SET srno='$srno',EmpId='$user_id',ExpId='$ExpId',ExpItemId='$ExpItemId',ProdId='$ProdId',Qty='$Qty',CreatedBy='$user_id',StockDate='$StockDate',Narration='$Narration',Status='Cr',UserId='$FrId',CreatedDate='$CreatedDate',FrId='$FrId',PurchasePrice='$PurchasePrice',SellPrice='$SellPrice'";
                    $conn->query($qx);
                    //$VedInvId = mysqli_insert_id($conn);

                    $qx = "INSERT INTO tbl_cust_prod_stock_2025 SET EmpExpItem='Yes',EmpExpId='$ExpId',ExpItemId='$ExpItemId',ProdId='$ProdId',Qty='$Qty',CreatedBy='$user_id',StockDate='$StockDate',Narration='$Narration',Status='Cr',UserId='$FrId',CreatedDate='$CreatedDate',FrId='$FrId',PurchasePrice='$PurchasePrice',SellPrice='$SellPrice'";
                    $conn->query($qx);
