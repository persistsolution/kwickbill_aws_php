            ...
            if(trim($_POST["CheckId"][$i] != ''))  
              {
                ...
                if($CheckId == 1){
                 ...
                 if($ProdType == 0){
                     $qx = "INSERT INTO tbl_cust_prod_stock_2025 SET PurchasePrice='$PurchasePrice',TransferId='$TransferId',ProdId='$ProdId',Qty='$Qty',CreatedBy='$UserId',StockDate='$CreatedDate',Narration='$Narration',Status='Cr',UserId='$UserId',CreatedDate='$CreatedDate',FrId='$UserId'";
                    $conn->query($qx);
                    $InvId = mysqli_insert_id($conn);
                    
                    $qx = "INSERT INTO tbl_cust_prod_stock_2025_backup SET PurchasePrice='$PurchasePrice',TransferId='$TransferId',ProdId='$ProdId',Qty='$Qty',CreatedBy='$UserId',StockDate='$CreatedDate',Narration='$Narration',Status='Cr',UserId='$UserId',CreatedDate='$CreatedDate',FrId='$UserId',orgstockid='$InvId'";
                    $conn->query($qx);
                  ...
                  $conn->query($sql);
                      ...
                      $qx = "INSERT INTO tbl_cust_prod_stock_2025 SET PurchasePrice='$PurchasePrice',TransferId='$TransferId',ProdId='$ProdId',Qty='$Qty',CreatedBy='$UserId',StockDate='$CreatedDate',Narration='$Narration',Status='Cr',UserId='$UserId',CreatedDate='$CreatedDate',FrId='$UserId',ProdType=1";
                    $conn->query($qx);
                    $InvId = mysqli_insert_id($conn);
                    
                     $qx = "INSERT INTO tbl_cust_prod_stock_2025_backup SET PurchasePrice='$PurchasePrice',TransferId='$TransferId',ProdId='$ProdId',Qty='$Qty',CreatedBy='$UserId',StockDate='$CreatedDate',Narration='$Narration',Status='Cr',UserId='$UserId',CreatedDate='$CreatedDate',FrId='$UserId',ProdType=1,orgstockid='$InvId'";
                    $conn->query($qx);
