...
echo $sql11 = "SELECT * FROM tbl_users WHERE id='$UserId'";
...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    height: 70% !important;
         ...
         <div class="container mt-3 mb-4 text-center" style="padding-top: 50px;">
            <p class="text-default-secondary" style="color:#fff;">Ask to scan this QR-Code<br>to accept money </p>
            <div class="avatar avatar-140 rounded mb-3">
                <div class="background">
                    <img src="../barcodes/<?php echo $QrCode;?>" alt="">
                </div>
            </div>

            <h2 class="text-white">&#8377;<?php echo number_format($Wallet,2);?></h2>
            <p class="text-white mb-4">Total Balance</p>
            
            <button onclick="scanQrCode()"class="btn btn-outline-default px-2 btn-block rounded" style="border: 1px solid #fff;color: #fff;"><span class="material-icons mr-1">qr_code_scanner</span> Scan QR</button>
        </div>
