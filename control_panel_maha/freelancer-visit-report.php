...
<h4 class="font-weight-bold py-3 mb-0">View Freelancer Visit List
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            LEFT JOIN tbl_users tu ON tu.id=tp.CustId WHERE tp.Status IN (0,1,2) AND tc.Roll=9";
            if($_POST['ExeId']){
                $ExeId = $_POST['ExeId'];
                if($ExeId == 'all'){
                    $sql.= " ";
