...
<div class="swiper-container categories2tab1 text-center mb-4">
                ...
                <input type="hidden" id="FromDate" value="<?php echo $_REQUEST['FromDate'];?>">
                <input type="hidden" id="ToDate" value="<?php echo $_REQUEST['ToDate'];?>">
                <br>
 ...
 <script type="text/javascript" src="js/toastr.min.js"></script>
  ...
  url: "ajax_files/ajax_customer_products.php",
   data:{action:action,SearchData:SearchData,ownfr:ownfr,CocoFranchiseAccess:CocoFranchiseAccess,Roll:Roll,calendar:calendar,FromDate:FromDate,ToDate:ToDate},  
