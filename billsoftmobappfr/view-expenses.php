...
{
  $id = $_REQUEST["id"];
  $sql11 = "DELETE FROM tbl_bill_expenses WHERE id = '$id'";
  $conn->query($sql11);
  ?>
...
$id = $_GET['id'];
$sql7 = "SELECT * FROM tbl_bill_expenses WHERE id='$id'";
...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_bill_expenses SET Photo='$Photo',Photo2='$Photo2',UserId = '$FranchiseId',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst'";
  $conn->query($qx);
  //$to = $row55['ExpMail'];
...
swal({
  title: "Thank you",
  text: "Your expenses added successfully.",
  type: "success",
...
<?php 
    ...
    $query2 = "UPDATE tbl_bill_expenses SET Photo='$Photo',Photo2='$Photo2',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',Gst='$Gst' WHERE id = '$id'";
  $conn->query($query2);
  ?>
  <script type="text/javascript">
        setTimeout(function () { 
swal({
  title: "Thank you",
  text: "Your expenses updated successfully .",
  type: "success",
  confirmButtonText: "OK"
},
function(isConfirm){
    ...
    By Online</option>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <?php 
                             $sql = "SELECT * FROM tbl_bill_expenses WHERE UserId='$FranchiseId' ORDER BY id DESC";
                            $row = getList($sql);
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="text-secondary"><?php echo $result['Narration'];?><br><?php echo date("d/m/Y", strtotime(str_replace('-', '/',$result['ExpenseDate'])))?>
                                    ...
                                    <div class="col-auto pl-0">
                                        ...
                                        <a href="view-expenses.php?action=delete&id=<?php echo $result['id'];?>"  class="btn-danger btn btn-sm btn-30 rounded"><i class="fa fa-trash"></i></a>
