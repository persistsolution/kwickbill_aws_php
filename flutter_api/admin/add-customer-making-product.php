...
<?php 
  if(isset($_POST['submit'])){
   //$id = $_POST['id'];
    ...
    if($id==''){
    $sql = "INSERT INTO tbl_cust_products2 SET SubTotal='$SubTotal',DiscPer='$DiscPer',Discount='$Discount',Unit='$Unit',PurchasePrice='$PurchasePrice',Transfer='$Transfer',ProdType2='$ProdType2',BrandId='$BrandId',SubCatId='$SubCatId',ProductName='$ProductName',CatId='$CatId',MinPrice='$MinPrice',Status='$Status',SrNo='$SrNo',CreatedDate='$CreatedDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',ProdPrice='$ProdPrice',CgstAmt='$CgstAmt',SgstAmt='$SgstAmt',IgstAmt='$IgstAmt',BarcodeNo='$BarcodeNo',StockQty='$StockQty',TempPrdId='$TempPrdId',MinQty='$MinQty'";
    $conn->query($sql);
    $ProdId = mysqli_insert_id($conn); 
    
    $Code2 = $Code."".$ProdId; 
    $sql2 = "UPDATE tbl_cust_products2 SET code='$Code2' WHERE id='$ProdId'";
    $conn->query($sql2);
    ...
    foreach($row as $result){
       ...
       if($rncnt > 0){
        ...
        $sql = "INSERT INTO tbl_cust_products_2025 SET SubTotal='$SubTotal',DiscPer='$DiscPer',Discount='$Discount',Unit='$Unit',modified_time='$modified_time',PurchasePrice='$PurchasePrice',Transfer='$Transfer',ProdType2='$ProdType2',code='$Code2',BrandId='$BrandId',SubCatId='$SubCatId',ProdId='$ProdId',checkstatus='$checkstatus',CreatedBy='$CreatedBy',ProductName='$ProductName',CatId='$CatId',MinPrice='$MinPrice',Status='$Status',SrNo='$SrNo',CreatedDate='$CreatedDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',ProdPrice='$ProdPrice',CgstAmt='$CgstAmt',SgstAmt='$SgstAmt',IgstAmt='$IgstAmt',BarcodeNo='$BarcodeNo',StockQty='$StockQty',TempPrdId='$TempPrdId',MinQty='$MinQty'";
        $conn->query($sql);
    }
            ...
            if(trim($_POST["MakingQty"][$i] != '' || $_POST["MakingQty"][$i] != 0))  
              {
                ...
                $sql22 = "INSERT INTO tbl_raw_prod_make_qty_2025 SET RawQty='$MakingQty',RawUnit='$RawUnit',RawProdId='$CustProdId',CustProdId='$ProdId',MakingQty='$MakingQty',MakingQty2='$MakingQty2',MakingQtyUnit2='$MakingQtyUnit2'";
                $conn->query($sql22);
              }  
  ...
  echo "<script>alert('Making Product Added Successfully!');window.location.href='add-customer-making-product.php';</script>";
}
else{
 

   $sql = "UPDATE tbl_cust_products2 SET SubTotal='$SubTotal',DiscPer='$DiscPer',Discount='$Discount',Unit='$Unit',PurchasePrice='$PurchasePrice',Transfer='$Transfer',ProdType2='$ProdType2',BrandId='$BrandId',SubCatId='$SubCatId',ProductName='$ProductName',CatId='$CatId',MinPrice='$MinPrice',Status='$Status',SrNo='$SrNo',ModifiedBy='$user_id',ModifiedDate='$CreatedDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',ProdPrice='$ProdPrice',CgstAmt='$CgstAmt',SgstAmt='$SgstAmt',IgstAmt='$IgstAmt',BarcodeNo='$BarcodeNo',StockQty='$StockQty',TempPrdId='$TempPrdId',MinQty='$MinQty' WHERE id='$id'";
    $conn->query($sql);
    
    $sql = "UPDATE tbl_cust_products_2025 SET SubTotal='$SubTotal',DiscPer='$DiscPer',Discount='$Discount',Unit='$Unit',modified_time='$modified_time',PurchasePrice='$PurchasePrice',Transfer='$Transfer',ProdType2='$ProdType2',BrandId='$BrandId',SubCatId='$SubCatId',ModifiedBy='$CreatedBy',ProductName='$ProductName',CatId='$CatId',MinPrice='$MinPrice',Status='$Status',SrNo='$SrNo',ModifiedDate='$CreatedDate',CgstPer='$CgstPer',SgstPer='$SgstPer',IgstPer='$IgstPer',GstAmt='$GstAmt',ProdPrice='$ProdPrice',CgstAmt='$CgstAmt',SgstAmt='$SgstAmt',IgstAmt='$IgstAmt',BarcodeNo='$BarcodeNo',StockQty='$StockQty',TempPrdId='$TempPrdId',MinQty='$MinQty' WHERE ProdId='$id'";
    $conn->query($sql);
  ...
  $sql = "DELETE FROM tbl_raw_prod_make_qty_2025 WHERE CustProdId='$id'";
$conn->query($sql);
     $number = count($_POST["CustProdId"]);
    if($number > 0)  
      {  
            ...
            if(trim($_POST["MakingQty"][$i] != '' || $_POST["MakingQty"][$i] != 0))  
              {
                ...
                $MakingQtyUnit2 = $_POST['MakingQtyUnit2'][$i];
                $RawUnit = $_POST['Unit'][$i];
                $sql22 = "INSERT INTO tbl_raw_prod_make_qty_2025 SET RawQty='$MakingQty',RawUnit='$RawUnit',RawProdId='$CustProdId',CustProdId='$id',MakingQty='$MakingQty',MakingQty2='$MakingQty2',MakingQtyUnit2='$MakingQtyUnit2'";
                $conn->query($sql22);
              }  
  ...
  echo "<script>alert('Making Product Updated Successfully!');window.location.href='add-customer-making-product.php';</script>";
