...
<h4 class="font-weight-bold py-3 mb-0">View Return Raw Product List
    <?php if(in_array("14", $Options)) {?>   
<span style="float: right;">
<a href="add-return-raw-product.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            <?php 
            $i=1;
            $sql = "SELECT tp.*,tu.Fname AS VedName FROM tbl_return_prod_stock tp INNER JOIN tbl_users tu ON tp.VedId=tu.id WHERE tp.FrId='$BillSoftFrId' AND tp.ProdType=2
