...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
     $query2 = "UPDATE tbl_vendor_stock_invoice SET AccountantApproveDate='$AdminApproveDate',AccountantComment='$AdminComment',AccountantStatus='$AdminStatus',AccountantBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);


  echo "<script>alert('Approved Successfully!');window.location.href='accountant-pending-ved-order-request.php';</script>";
