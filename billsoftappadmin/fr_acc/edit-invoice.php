...
<?php }
                ...
                ,CgstPer='$CgstPer',SgstPer='$SgstPer',GstAmt='$GstAmt',Total='$Total'";
                                $conn->query($sql22);
                ...
                ,CgstPer='$CgstPer',SgstPer='$SgstPer',GstAmt='$GstAmt',Total='$Total',CrDr='cr',Narration='Stock Added'";
                                $conn->query($sql22);
                            }
                        }
                    }
