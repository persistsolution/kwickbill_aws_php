...
<?php echo $row["Price"]; ?> Pts
</td>
</tr>
    <?php }} ?>
 <tr>
     <td colspan="1"><strong>Total Points</strong></td>
     <td class="align-middle p-4" style="width: 66px;"><strong>x<?php echo $TotalQty; ?></strong></td>
     <td class="text-right font-weight-semibold align-middle p-4" style="width: 100px;"><strong><?php echo $GrandTotal; ?> Pts</strong></td>
</tr> 
