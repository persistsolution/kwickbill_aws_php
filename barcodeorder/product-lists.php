...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="products">
 ...
 <?php include_once 'sidebar.php'; ?>
   ...
   <main class="flex-shrink-0 main">
        <!-- Fixed navbar -->
      <?php include_once 'top_header.php';  $FrId = $_SESSION['FrId'];?>
...
<div class="container mb-4">
    ...
    <?php 
     ...
     $start_from = ($page - 1) * $results_per_page;  
                        ...
                        $SubCatId = $_GET['subid'];
                        $brand_id = $_GET['brand_id'];
                        $query = "SELECT * FROM tbl_cust_products_2025 WHERE Status='1' AND CreatedBy IN ($FrId) AND ProdType=0 AND ProdType2!=3 AND checkstatus=1 AND delete_flag=0";
                        if($_GET['cat_id']!=''){
...
$.ajax({
  type: "POST",
  url: "ajax_files/ajax_shop_cart.php",
  data: {action:action,pid:pid,quantity:quantity,code:code,sizeid:sizeid,ramid:ramid,storageid:storageid,price:price,FrId:FrId},
   beforeSend:function(){
