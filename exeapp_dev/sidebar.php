...
$Lattitude = $row110['Lattitude'];
$Longitude = $row110['Longitude'];
$MgrCheckpoint = $row110['MgrCheckpoint'];
$BdmCheckpoint = $row110['BdmCheckpoint'];
$NsoVedPay = $row110['NsoVedPay'];
$PettyCash = $row110['PettyCash'];
$PettyAmount = $row110['PettyAmount'];
$VendorExpSecOpt = $row110['VendorExpSecOpt'];
$LoginStatus = $row110['Status'];
$EmpAppDashboard = $row110['EmpAppDashboard'];
 ...
 ?>
    ...
    <div class="main-menu">
        <div class="row mb-4 no-gutters">
            <div class="col-auto"><button class="btn btn-link btn-40 btn-close " ><span class="material-icons" style="color: #e2982d;">chevron_left</span></button></div>
                ...
                <div class="avatar avatar-40 rounded-circle position-relative">
                    <figure class="background">
                       <?php 
                        if($row110['Photo'] == ''){
                     ?>
                    <img src="user.jpg" alt="" style="width: 140px;height: 140px;">
                <?php } else  {?>
            ...
            <div class="col pl-3 text-left align-self-center">
                ...
                <p class="small text-default-secondary" style="color:#e2982d;font-weight:bold;"> Wallet : &#8377;<?php echo number_format($mybalance,2);?> </p>
        ...
        <?php } } ?>
            <ul class="nav nav-pills flex-column ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/profile.php">
                        <div>
                            <span class="material-icons icon">local_shipping</span>
                            Your Profile
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/mahatube.php">
                        <div>
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/mahatube-receipe.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            MahaTube Receipe
                        </div>
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/download-center.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            Download Center
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/view-query.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            Ask For Query
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/about-us.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            About Us
                        </div>
...
<li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/view-expenses-test.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            Expenses 2
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/view-vendor-expenses.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            Vendor Expenses
                        </div>
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/view-branch-expenses.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            Branch Expenses
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/image-gallery.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            Gallery
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/evening-attendance.php">
                        <div>
                            <span class="material-icons icon">help</span>
                            Evening Attendance
                        </div>
                ...
                ?>
                <li class="nav-item">
                     <a class="nav-link" href="refer-and-earn.php">
                        <div>
                ...
                <li class="nav-item">
                     <a class="nav-link" href="video_tutorial.php">
                        <div>
                            <span class="material-icons icon">loyalty</span>
                           Video Tutorial
                        </div>
                ...
                <!-- <li class="nav-item">
                     <a class="nav-link" href="developer-test.php">
                        <div>
                            <span class="material-icons icon">loyalty</span>
                            Developer Test
                        </div>
                ...
                <li class="nav-item">
                     <a class="nav-link" href="voice-note/">
                        <div>
                            <span class="material-icons icon">loyalty</span>
                            Voice Test
                        </div>
                ...
                <li class="nav-item">
                     <a class="nav-link" href="add-checklist2.php">
                        <div>
                            <span class="material-icons icon">loyalty</span>
                            Location Test
                        </div>
           ...
           <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/change-password.php.php">
                        <div>
                            <span class="material-icons icon">support_agent</span>
                            Change Password
                        </div>
