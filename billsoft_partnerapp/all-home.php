...
<div class="swiper-container categories2tab1 text-center mb-4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <?php if($ownfr == 1){?>
                            <a href="all-home.php?ownfr=1&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">COCO</a>
                            <?php } else {?>
                            <a href="all-home.php?ownfr=1&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">COCO</a>
                            <?php } ?>
                        </div>
                        <div class="swiper-slide">
                            <?php if($ownfr == 2){?>
                            <a href="all-home.php?ownfr=2&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">FOFO</a>
                            <?php } else {?>
                            <a href="all-home.php?ownfr=2&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">FOFO</a>
                            <?php } ?>
                        </div>
                        <div class="swiper-slide">
                           <?php if($ownfr == 0){?>
                            <a href="all-home.php?ownfr=0&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">Other</a>
                            <?php } else {?>
                            <a href="all-home.php?ownfr=0&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">Other</a>
                            <?php } ?>
                        </div>
