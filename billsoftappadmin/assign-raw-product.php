...
$sql = "UPDATE tbl_users SET AllocateRawProd='$AllocateProd' WHERE id='$frid' AND Roll=5";
$conn->query($sql);
$sql = "UPDATE tbl_users_bill SET AllocateRawProd='$AllocateProd' WHERE id='$frid' AND Roll=5";
$conn->query($sql);
