...
<head>
<title><?php echo $Proj_Title; ?> | Daily Report</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">Daily Report
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            <?php 
            $i=1;
            $sql = "SELECT tp.Amount,tp.ExpenseDate,tp.Narration,tp.PaymentMode,tb.Name As BranchName FROM tbl_expenses tp 
                    LEFT JOIN tbl_branch tb ON tb.id=tp.BranchId WHERE tp.Status=1 ";
           ...
           <?php 
            $i2=$i+1;
            $sql = "SELECT tp.Total,tp.InvoiceDate,tp.Narration,tp.PayType,tb.Name As BranchName FROM tbl_sell tp 
                    LEFT JOIN tbl_branch tb ON tb.id=tp.BranchId WHERE tp.Status=1 ";
           ...
           <?php $i2++;} ?>
            ...
            <?php 
            $i2=$i+1;
            $sql = "SELECT tp.TotalAmt,tp.InvoiceDate,tp.Narration,tp.PayType,tb.Name As BranchName FROM tbl_accessories_sell tp 
                    LEFT JOIN tbl_branch tb ON tb.id=tp.BranchId WHERE tp.Status=1 ";
