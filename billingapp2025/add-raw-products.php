...
if($_GET['id']==''){
    //  $qx = "INSERT INTO tbl_raw_products SET CustProdId='$CustProdId',MakingQty='$MakingQty',Qty='$Qty',FrId='$BillSoftFrId',CGST='$CGST',SGST='$SGST',IGST='$IGST',Photo2='$Photo2',ProductCode='$ProductCode',BrandId='$BrandId',CatId='$CatId',ProductName = '$ProductName',Status='$Status',ModelNo='$ModelNo',Photo='$Photo',Price = '$Price',Details='$Details',CreatedDate='$CreatedDate',CreatedBy='$user_id',Code='$Code',Unit='$Unit',Roll='$Roll'";
    
    $qx="INSERT INTO tbl_cust_products SET Qty='$Qty',ProductName = '$ProductName',Status='$Status',CreatedDate='$CreatedDate',CreatedBy='$BillSoftFrId',code='$Code',Unit='$Unit',ProdType='1',Transfer=1";
  $conn->query($qx);
  ...
  echo "<script>alert('Raw Product Added Successfully!');window.location.href='view-raw-products.php';</script>";
    ...
    // $query2 = "UPDATE tbl_raw_products SET CustProdId='$CustProdId',MakingQty='$MakingQty',Qty='$Qty',CGST='$CGST',SGST='$SGST',IGST='$IGST',Photo2='$Photo2',ProductCode='$ProductCode',BrandId='$BrandId',CatId='$CatId',ProductName = '$ProductName',Status='$Status',ModelNo='$ModelNo',Photo='$Photo',Price = '$Price',Details='$Details',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',Code='$Code',Unit='$Unit',Roll='$Roll' WHERE id = '$id'";
    $query2 = "UPDATE tbl_cust_products SET Qty='$Qty',ProductName = '$ProductName',Status='$Status',ModifiedDate='$CreatedDate',Unit='$Unit',ProdType='1' WHERE id = '$id'";
  $conn->query($query2);
