...
<a href="add-expenses.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add More</a></span><?php } ?>
</h4>
<br>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            $sql = "SELECT tp.*,tah.Name As AccountHead FROM tbl_expenses tp 
                    ...
                    LEFT JOIN tbl_account_head tah ON tah.id=tp.AccHeadId WHERE tp.Status=1 AND tp.FrId='$BillSoftFrId'";
