...
?>
   ...
   <div class="card-body">
                           ...
                           <!--<input type="hidden" class="form-control" name="VedPhone" id="VedPhone" value="<?php echo $row110['Phone']; ?>" required>-->
                            ...
                            <input type="text" class="form-control" name="TradeName" id="TradeName" value="<?php echo $TradeName; ?>" required>
                            <label class="form-control-label">Trade/Business Name <span class="text-danger">*</span></label>                            
                        </div>
                                        
                                         <div class="form-group float-label active">
                            <input type="number" class="form-control" name="VedPhone" id="VedPhone" value="<?php echo $row110['Phone']; ?>" required>
                        ...
                        <div class="form-group float-label active">
                                            ...
                                            <select class="form-control" name="TypeOfVendor" id="TypeOfVendor" required>
                                              <!--  <option value="" selected>...</option>-->
                                                <?php 
                                                    $sql = "SELECT * FROM tbl_common_master WHERE Roll=1 AND Status=1 AND id='$TypeOfVendor'";
                                                    $row = getList($sql);
                                            ...
                                            <label class="form-control-label">Type Of vendor <span class="text-danger">*</span></label>    
                                        </div>
...
<option value="Final Payment" <?php if($row7["PaymentMode"] == 'Final Payment') {?> selected <?php } ?>>
    Final Payment</option>
                                  ...
                                  <label class="form-control-label">Payment Type <span class="text-danger">*</span></label>
                            </div>
...
<option value="Tax Invoice" <?php if($row7["InvType"] == 'Tax Invoice') {?> selected <?php } ?>>
    Tax Invoice</option>
                        ...
                        <div class="form-group float-label active">
                            ...
                            <label class="form-control-label">Narration <span class="text-danger">*</span></label>                            
                        </div>
                        ...
                        <a href="../uploads/<?php echo $row7['Photo']; ?>"><?php echo $row7['Photo']; ?></a><?php } ?>
                            ...
                            <label class="form-control-label">Upload PDF <span class="text-danger">*</span></label>                            
                        </div>
