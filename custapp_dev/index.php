...
<html lang="en">
<head>
    <meta http-equiv="refresh" content="0; url=https://kwickfoods.in/mobapp" />
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <div class="content-body" style="background-color:#fff;">
        <div class="container vh-100">
            <div class="welcome-area">
                ...
                <div class="join-area">
                <a href="login.php" class="btn btn-primary btn-block mb-3">FRANCHISE LOGIN</a>
                <a href="login.php" class="btn btn-primary btn-block mb-3">EMPLOYEE LOGIN</a>
                <a href="login.php" class="btn btn-primary btn-block mb-3">BUSINESS PARTNER LOGIN</a>    
                </div>
