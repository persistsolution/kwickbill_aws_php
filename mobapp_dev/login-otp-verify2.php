                ...
                <div class="join-area h-50">
                    ...
                    <form>
                        ...
                        <div class="input-group form-item input-select">
                            ...
                            <input type="number" name="YourOtp" id="YourOtp" class="form-control" placeholder="Enter OTP" maxlength="4" value="" required>
                        </div>
 ...
 <script type="text/javascript">
         ...
         $(document).on("click", "#login", function(event){
          ...
          /*  else if(Password.trim() == ''){
                ...
                method:"POST",  
                data:{action:action,Phone:Phone,YourOtp:YourOtp,GetOtp:GetOtp},
                 beforeSend:function(){
