         ...
         <form id="validation-form" method="post" autocomplete="off">
            ...
            <div class="container mb-4">
                ...
                <div class="form-group mb-1">
                    <input type="number" name="Amount" id="Amount" class="form-control large-gift-card" value="" placeholder="00.00" autofocus>
                </div>
                <p class="text-center text-secondary mb-4">Available: &#8377;<?php echo number_format($mybalance,2); ?> </p>
