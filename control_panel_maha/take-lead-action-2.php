...
$sql77 = "SELECT * FROM tbl_bp_leads WHERE id='$CompId'";
...
if($ClainStatus=='1'){
    ...
    else if($ClainStatus=='2'){
    $Status = "Folloup Stage";
    } 
    else if($ClainStatus=='3'){
    $Status = "Closing Stage";
    } 
    else if($ClainStatus=='4'){
    $Status = "Reject  / hold / wrong lead";
    } 
    else{
     $Status = "Pending";   
    }
...
if($_GET['id']==''){
  ...
  $sql = "UPDATE tbl_bp_leads SET Status='$ClainStatus',NextDate='$NextDate',NextTime='$NextTime' WHERE id='$CompId'";
  $conn->query($sql);
  ...
  $Phone = $CellNo;
	 $smstxt = "Hello ".$CustName.", We have an update on the lead you added. Lead Details: Lead Name: ".$CustName." Lead Status: ".$Status." Thank you for your dedication.";
  $dltentityid = "1501701120000037351";
  $dlttempid = "1707169875458380916";
  ...
  $conn->query($query2);
   ...
   $sql = "UPDATE tbl_bp_leads SET ClainStatus='$ClainStatus',NextDate='$NextDate',NextTime='$NextTime' WHERE id='$CompId'";
  $conn->query($sql);
 ...
 $Phone = $CellNo;
  ...
  echo "<script>alert('Lead Record Updated Successfully!');
  window.close();
  window.opener.location.reload(true);</script>";
...
<option selected="" value="">Select</option>
  <option value="1" <?php if($row77["Status"]=='1') {?> selected
                                                    <?php } ?>>Interested</option>
                                                <option value="2" <?php if($row77["Status"]=='2') {?> selected
                                                    <?php } ?>>Folloup Stage</option>
                                                    <option value="3" <?php if($row77["Status"]=='3') {?> selected
                                                    <?php } ?>>Closing Stage</option>
                                                    
                                                    <option value="4" <?php if($row77["Status"]=='4') {?> selected
                                                    <?php } ?>>Reject</option>
                                                    
                                                    <option value="5" <?php if($row77["Status"]=='5') {?> selected
                                                    <?php } ?>>Hold / wrong lead</option>
                                                    
                                                    <option value="6" <?php if($row77["Status"]=='6') {?> selected
