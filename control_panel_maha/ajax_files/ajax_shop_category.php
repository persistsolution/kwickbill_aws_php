...
if($row_cnt > 0){
 ...
 $qx = "INSERT INTO category SET Name = '$Name', Icon = '$Icon',Status='$Status',Featured='$Featured',Photo='$Photo',Photo2='$Photo2',CreatedDate='$CreatedDate',Roll='$Roll'";
  $conn->query($qx);
  echo 1;
}
}
...
if($row_cnt > 0){
  ...
  $query2 = "UPDATE category SET Name = '$Name',Icon = '$Icon',Status='$Status',Featured='$Featured',Photo='$Photo',Photo2='$Photo2',ModifiedDate='$ModifiedDate',Roll='$Roll' WHERE id = '$id'";
  $conn->query($query2);
  echo 1;
}
}
  ...
  ?>
           <tr>
             ...
             <td><?php echo $nx['Name']; ?></td>
              <td><?php if($nx['Roll']=='1'){echo "Franchise";} else if($nx['Roll']=='2'){echo "Employee";} else if($nx['Roll']=='4') { echo "Customer"; } 
             else { echo "All";} ?></td>
