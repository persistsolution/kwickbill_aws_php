...
if($id == ''){
 ...
 $rncnt2 = getRow($sql2);
 if($rncnt2 > 0){
     echo "<script>alert('Phone No Already Exists!');window.location.href='../view-production.php';</script>";
 }   
 else{
...
$conn->query($sql3);
  ...
  echo "<script>alert('Record Created Successfully!');window.location.href='../view-production.php';</script>";
}
}
else{
 ...
 $rncnt2 = getRow($sql2);
 if($rncnt2 > 0){
     echo "<script>alert('Phone No Already Exists!');window.location.href='../view-production.php?id=$id';</script>";
 }  
 else{
     $filename = $id.".png";
$codeContents = $Phone;
...
$conn->query($sql3);
  ...
  echo "<script>alert('Record Updated Successfully!');window.location.href='../view-production.php';</script>";
}
}
