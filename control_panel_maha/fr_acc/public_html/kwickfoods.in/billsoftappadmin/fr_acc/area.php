...
<head>
<title><?php echo $Proj_Title; ?> | Area</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">List Of Area
...
<span class="font-weight-light">Area</span>
</h5>
...
function update_toast(){
   ...
   var action = "getCity";
    ...
    success:function(data)
    {
      ...
      $('#add_button').click(function(){  
           $('.modal-title').html("Add <span class='font-weight-light'>Area</span>");  
           $('#action').val("Add");  
           $('#id').val('');
      ...
      $('#Status').attr("selected","selected").val(1);
       $('#CountryId').attr("selected","selected").val(null);
        ...
        $('#CityId').val(null).attr("selected",true);
       $('#submit').text('Submit');
 ...
 $.ajax({  
                ...
                success:function(data){  
                 ...
                 $('#StateId').val(data.StateId).attr("selected",true); 
                 ...
                 getCity(StateId,CityId); 
                     ...
                     $('#action').val('Edit'); 
                       ...
                       $('#submit').text("Update");   
                       $('.insert_frm').modal('show');
                         $('.modal-title').html("Update <span class='font-weight-light'>Area</span>"); 
   ...
   swal({
            ...
            if (isConfirm) {
              ...
              category_lists();
                ...
                swal("Cancelled", "Area is safe :)", "error");
            }
        });
