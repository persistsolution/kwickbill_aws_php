...
echo "<script>alert('Record Created Successfully!');window.location.href='../view-dealer.php';</script>";
}
else{
$sql = "UPDATE tbl_users SET Fname='$Fname',Mname='$Mname',Lname='$Lname',Phone='$Phone',EmailId='$EmailId',Password='$Password',Phone2='$Phone2',CountryId='$CountryId',StateId='$StateId',CityId='$CityId',Address='$Address',Pincode='$Pincode',Status='$Status',Photo='$Photo',Roll='9',ModifiedDate='$CreatedDate',ModifiedBy='$user_id',Photo2='$Photo2',Photo3='$Photo3',Details='$Details',CatId='$CatId',AadharCard='$AadharCard',AadharCard2='$AadharCard2',PanCard='$PanCard',PanCard2='$PanCard2',AadharNo='$AadharNo',PanNo='$PanNo',GstCertificate='$GstCertificate',GstNo='$GstNo',AccountName='$AccountName',BankName='$BankName',AccountNo='$AccountNo',IfscCode='$IfscCode',Branch='$Branch',UpiNo='$UpiNo',GumastaNo='$GumastaNo',Gumasta='$Gumasta',MsmeNo='$MsmeNo',Msme='$Msme',Options='$Options' WHERE id='$id'";
$conn->query($sql);
$sql2 = "DELETE FROM tbl_vendor_price WHERE VedId='$id'";
$conn->query($sql2);

echo "<script>alert('Record Updated Successfully!');window.location.href='../view-dealer.php';</script>";
}
