...
$UnderFrId = $row110['UnderFrId'];
$MonthlyWeekOff = $row110['MonthlyWeekOff'];
$JoinDate = $row110['JoinDate'];
$NsoVedPay = $row110['NsoVedPay'];
$PettyCash = $row110['PettyCash'];
$ReportingMgr = $row110['ReportingMgr'];
$PettyAmount = $row110['PettyAmount'];
$AssignFranchiseBdm = $row110['AssignFranchiseBdm'];
$CashHandover = $row110['CashHandover'];
                ...
                <?php if($_SESSION['Roll'] == 3){
                   ...
                   <a href="<?php echo $profileurl; ?>" class="avatar avatar-30 shadow-sm rounded-circle ml-2">
                        <figure class="m-0">
                            ...
                            <img src="user.jpg" alt="" style="width: 30px;height: 30px;">
                            <?php } else { ?>
