...
$sql73 = "INSERT INTO tbl_set_target SET frid='$frid',month='$month',year='$year',target='$target',createddate='$CreatedDate',createdby='$user_id'";
   $conn->query($sql73);
  ...
  echo "<script>alert('New Target SET Successfully!');window.location.href='view-set-target.php';</script>";
        ...
        $sql73 = "UPDATE tbl_set_target SET frid='$frid',month='$month',year='$year',target='$target',modifieddate='$CreatedDate',modifiedby='$user_id' WHERE id='$id'";
   $conn->query($sql73);
