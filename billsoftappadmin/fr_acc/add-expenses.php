        ...
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $AccName = $row['Name'];
                    if ($_GET['id'] == '') {
                        $qx = "INSERT INTO tbl_expenses SET BranchId = '$BranchId',Status='$Status',AccHeadId='$AccHeadId',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',CrDr='dr',FrId='$BillSoftFrId'";
                        $conn->query($qx);
                        ...
                        $sql4 = "INSERT INTO tbl_general_ledger SET ExpenseId='$ExpenseId',SrNo='$SrNo',Code='$Code',UserId='$AccHeadId',AccCode='$AccCode',AccountName='$AccName',InvoiceNo='',Amount='$Amount',CrDr='cr',Roll=0,Type='EV',CreatedDate='$CreatedDate',PaymentDate='$ExpenseDate',PayMode='$PaymentMode',Narration='$Narration',Flag='Expenses',AccRoll='AccHead',BillSoftFrId='$BillSoftFrId'";
                        $conn->query($sql4);

                        $sql4 = "INSERT INTO tbl_general_ledger SET ExpenseId='$ExpenseId',SrNo='$SrNo',Code='$Code',UserId='0',AccCode='AC1',AccountName='Comapny Account',InvoiceNo='',Amount='$Amount',CrDr='dr',Roll=0,Type='EV',CreatedDate='$CreatedDate',PaymentDate='$ExpenseDate',PayMode='$PaymentMode',Narration='$Narration',Flag='Expenses',AccRoll='Company',BillSoftFrId='$BillSoftFrId'";
                        $conn->query($sql4);
