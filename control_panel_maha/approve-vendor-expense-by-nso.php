     ...
     <div class="layout-wrapper layout-1 layout-without-sidenav">
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <?php 
$id = $_GET['id'];
$sql7 = "SELECT te.*,tu.Fname,tu.Lname,tu.Photo AS Uphoto FROM tbl_nso_vendor_expenses te LEFT JOIN tbl_users tu ON tu.id=te.VedId WHERE te.id='$id'";
$row7 = getRecord($sql7);
$VedId = $row7['VedId'];
...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_nso_vendor_expenses SET Locations='$Locations',BdmApproveDate='$ApproveDate',BdmComment='$MannagerComment',BdmAmount='$MgrAmount',BdmStatus='$ManagerStatus',BdmBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
   if($ManagerStatus == 2){
  /* $query2 = "UPDATE tbl_nso_vendor_expenses SET PurchaseStatus='0',BdmStatus='0',ManagerStatus='0' WHERE id = '$id'";
  $conn->query($query2);*/
   }
  ...
  $VedPhone = $row['Phone'];
  if($ManagerStatus == 1){
  $smstxt = "Dear ".$VedName.", We are pleased to inform you that the Bills has been approved. It has now been sent to the Purchase Dept for verification. - Mahachai";
  $dltentityid = "1501701120000037351";
  $dlttempid = "1707174567019579416";
  }
  if($ManagerStatus == 2){
  $smstxt = "Dear ".$VedName.", We regret to inform you that your Bills has been reviewed and rejected. Please contact in case of queries. - Mahachai";
  $dltentityid = "1501701120000037351";
  $dlttempid = "1707174567025998983";
  }
  $Phone = $VedPhone;
  include '../incsmsapi.php'; 
  
  
  echo "<script>alert('Approved Successfully!');window.location.href='nso-vendor-pending-expense-request.php';</script>";
...
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Approve Vendor Expense By NSO</h4>
