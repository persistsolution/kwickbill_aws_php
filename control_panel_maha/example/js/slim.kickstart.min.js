    ...
    if (t)
        if (t.Slim = function() {
                ...
                function i(t, e, i, n) {
                    if (!(e >= 1)) {
                        for (var o = t.width, a = t.height, r = Math.max(n.width, Math.min(i.width, Math.round(t.width * e))), s = Math.max(n.height, Math.min(i.height, Math.round(t.height * e))), h = t, u = null; o > r && a > s;) {
                            ...
                            o = Math.round(.5 * h.width), a = Math.round(.5 * h.height), o < r && (o = r), a < s && (a = s), l.width = o, l.height = a, u = l.getContext("2d"), u.drawImage(h, 0, 0, o, a), h = l, l = null
                        }
                        t.width = r, t.height = s, u = t.getContext("2d"), u.drawImage(h, 0, 0, r, s)
                    }
                }! function() {
                    function t(t, i) {
                        i = i || {
                ...
                var u = function() {
                    ...
                    l = function() {
                        ...
                        function i(t, e, i, r, s, h) {
                            var u, l, p, c, d, f, _, m, g, v, y, w, b, k, x, S, C, E, P, M, R, T, I, L, O = t.data,
                                z = h + h + 1,
                                D = r - 1,
                                A = s - 1,
                                U = h + 1,
                            ...
                            var j = o[h],
                                V = a[h];
                            for (l = 0; l < s; l++) {
                                for (S = C = E = P = m = g = v = y = 0, w = U * (M = O[f]), b = U * (R = O[f + 1]), k = U * (T = O[f + 2]), x = U * (I = O[f + 3]), m += H * M, g += H * R, v += H * T, y += H * I, B = N, p = 0; p < U; p++) B.r = M, B.g = R, B.b = T, B.a = I, B = B.next;
                                for (p = 1; p < U; p++) c = f + ((D < p ? D : p) << 2), m += (B.r = M = O[c]) * (L = U - p), g += (B.g = R = O[c + 1]) * L, v += (B.b = T = O[c + 2]) * L, y += (B.a = I = O[c + 3]) * L, S += M, C += R, E += T, P += I, B = B.next;
                                for (W = N, q = F, u = 0; u < r; u++) O[f + 3] = I = y * j >> V, 0 != I ? (I = 255 / I, O[f] = (m * j >> V) * I, O[f + 1] = (g * j >> V) * I, O[f + 2] = (v * j >> V) * I) : O[f] = O[f + 1] = O[f + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = _ + ((c = u + h + 1) < D ? c : D) << 2, S += W.r = O[c], C += W.g = O[c + 1], E += W.b = O[c + 2], P += W.a = O[c + 3], m += S, g += C, v += E, y += P, W = W.next, w += M = q.r, b += R = q.g, k += T = q.b, x += I = q.a, S -= M, C -= R, E -= T, P -= I, q = q.next, f += 4;
                                _ += r
                            }
                            for (u = 0; u < r; u++) {
                                for (C = E = P = S = g = v = y = m = 0, f = u << 2, w = U * (M = O[f]), b = U * (R = O[f + 1]), k = U * (T = O[f + 2]), x = U * (I = O[f + 3]), m += H * M, g += H * R, v += H * T, y += H * I, B = N, p = 0; p < U; p++) B.r = M, B.g = R, B.b = T, B.a = I, B = B.next;
                                for (d = r, p = 1; p <= h; p++) f = d + u << 2, m += (B.r = M = O[f]) * (L = U - p), g += (B.g = R = O[f + 1]) * L, v += (B.b = T = O[f + 2]) * L, y += (B.a = I = O[f + 3]) * L, S += M, C += R, E += T, P += I, B = B.next, p < A && (d += r);
                                for (f = u, W = N, q = F, l = 0; l < s; l++) c = f << 2, O[c + 3] = I = y * j >> V, I > 0 ? (I = 255 / I, O[c] = (m * j >> V) * I, O[c + 1] = (g * j >> V) * I, O[c + 2] = (v * j >> V) * I) : O[c] = O[c + 1] = O[c + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = u + ((c = l + U) < A ? c : A) * r << 2, m += S += W.r = O[c], g += C += W.g = O[c + 1], v += E += W.b = O[c + 2], y += P += W.a = O[c + 3], W = W.next, w += M = q.r, b += R = q.g, k += T = q.b, x += I = q.a, S -= M, C -= R, E -= T, P -= I, q = q.next, f += r
                            }
                            return t
                        }
                ...
                var p = function() {
                    ...
                    d = null,
                    f = function() {
                        return null === d && (d = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream), d
                    },
                    _ = function(t) {
                        if ("undefined" == typeof t.dataset) {
                            var e, i, n = {},
                                o = t.attributes;
                            for (e in o) o.hasOwnProperty(e) && o[e].name && /^data-[a-z_\-\d]*$/i.test(o[e].name) && (i = m(o[e].name.substr(5)), n[i] = o[e].value);
                            return n
                        }
                        return t.dataset
                    },
                    ...
                    x = /(\.png|\.bmp|\.gif|\.jpg|\.jpe|\.jpg|\.jpeg)$/,
                    S = function(t, e) {
                    ...
                    H = function() {
                        var t = [],
                            e = void 0,
                            i = void 0;
                        for (e in k) k.hasOwnProperty(e) && (i = k[e], t.indexOf(i) == -1 && t.push(i));
                        return t
                    },
                    N = function(t) {
                        return "image/jpeg" === t
                    ...
                    B = function(t) {
                        var e = void 0;
                        for (e in k)
                            if (k.hasOwnProperty(e) && k[e] === t) return e;
                        return t
                    },
                    F = function(t) {
                        var e = void 0;
                        for (e in k)
                            if (k.hasOwnProperty(e) && t.indexOf(k[e]) !== -1) return k[e];
                        return null
                    },
                    W = function(t) {
                    ...
                    j = function(t) {
                        return t.getFullYear() + "-" + q(t.getMonth() + 1, "00") + "-" + q(t.getDate(), "00") + "_" + q(t.getHours(), "00") + "-" + q(t.getMinutes(), "00") + "-" + q(t.getSeconds(), "00")
                    },
                    V = function(t) {
                        return "undefined" == typeof t.name ? j(new Date) + "." + B(G(t)) : t.name
                    },
                    G = function(t) {
                    ...
                    $ = function(t, e, i, n, o, a) {
                        ...
                        r.open("GET", t, !0), e(r), r.responseType = "json", r.onload = function() {
                            return "failure" === this.response.status ? void o(this.response.message) : void Z(this.response.body, i, a)
                        }, r.send()
                    },
                    Z = function(t, e, i, n) {
                        ...
                        o.open("GET", t, !0), e(o), o.responseType = "blob", o.onload = function(e) {
                            if (o.status >= 200 && o.status < 300 || 0 === o.status && this.response instanceof Blob) {
                                var a = W(t),
                                    r = F(this.response.type);
                                x.test(a) || (a += "." + B(r));
                                var s = Y(this.response, a);
                                i(vt(s, r))
                    ...
                    Q = function(t, e) {
                        for (var i = K(t), n = new ArrayBuffer(i.length), o = new Uint8Array(n), a = 0; a < i.length; a++) o[a] = i.charCodeAt(a);
                        var r = bt(t);
                        return "undefined" == typeof e && (e = j(new Date) + "." + B(r)), Y(tt(n, r), e)
                    },
                    tt = function(t, e) {
                    ...
                    nt = function(t) {
                        ...
                        if (h) {
                            var v = h.width / a.width,
                                y = h.height / a.height,
                                w = Math.min(v, y);
                            i(a, w, h, l), u.sharpen > 0 && at(a, st(u.sharpen))
                        }
                        o(a)
                    },
                    ot = function(t) {
                    ...
                    at = function(t, e) {
                        var i = t.getContext("2d");
                        i.putImageData(e(ot(t), t.width, t.height), 0, 0)
                    },
                    rt = function(t, e, i) {
                    ...
                    st = function(t) {
                        return function(e, i, n) {
                            for (var o = [0, -1, 0, -1, 5, -1, 0, -1, 0], a = Math.round(Math.sqrt(o.length)), r = .5 * a | 0, s = rt(i, n), h = s.data, u = e.data, l = n, p = void 0; l--;)
                                for (p = i; p--;) {
                    ...
                    pt = function(t, e) {
                        ...
                        lt(e) ? i.drawImage(t, 0, 0, e.width, e.height) : (e.width = t.width, e.height = t.height, i.drawImage(t, 0, 0))
                    },
                    ct = function(t) {
                    ...
                    yt = function(t) {
                        var e = gt(t);
                        return e.input.file = vt(t.input.file), e.output.image = t.output.image, e
                    },
                    wt = function(t, i, n) {
                        if (!t || !i) return null;
                        var o = t;
                        return "IMG" === t.nodeName && (o = document.createElement("canvas"), o.width = t.width, o.height = t.height, o.getContext("2d").drawImage(t, 0, 0)), o.toDataURL(i, N(i) && "number" == typeof n ? n / 100 : e)
                    },
                    bt = function(t) {
                        if (!t) return null;
                    ...
                    kt = function(t) {
                        ...
                        return z("input", i) && !a && (r.input.image = wt(t.input.image, t.input.type)), z("output", i) && (r.output = {
                            name: o ? X(t.input.name) + "." + o : t.input.name,
                            type: k[o] || t.input.type,
                            width: t.output.width,
                            height: t.output.height
                        }, r.output.image = wt(t.output.image, r.output.type, n), r.output.type = bt(r.output.image), "image/png" === r.output.type && (r.output.name = X(r.input.name) + ".png")), z("actions", i) && (r.actions = gt(t.actions)), r
                    },
                    xt = function(t, i, n) {
                        var o = t.output.image,
                            a = n ? X(t.input.name) + "." + n : t.input.name,
                            r = k[n] || t.input.type;
                        "image/png" === r && (a = X(t.input.name) + ".png"), o.toBlob(function(t) {
                    ...
                    Tt = function(t, e, i, n) {
                        return Rt(t, e, i, 0, 360 * n)
                    },
                    It = function() {
                        var i = {
                            n: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return r = t.y + t.height, o = O(e.y, 0, r), r - o < i.min.height && (o = r - i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, o = r - h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || Math.round(a) > Math.round(i.width)) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, o = r - u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            s: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return o = t.y, r = O(e.y, o, i.height), r - o < i.min.height && (r = o + i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, r = o + h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || Math.round(a) > Math.round(i.width)) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, r = o + u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            e: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return s = t.x, a = O(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : t.height, u < i.min.height && (u = i.min.height, a = s + u / n), l = .5 * (u - t.height), o = t.y - l, r = t.y + t.height + l, (o < 0 || Math.round(r) > Math.round(i.height)) && (p = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - p, r = t.y + t.height + p, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            w: function n(t, e, i, o) {
                                var a, r, s, h, n, u, l, p;
                                return r = t.x + t.width, h = O(e.x, 0, r), r - h < i.min.width && (h = r - i.min.width), u = o ? (r - h) * o : t.height, u < i.min.height && (u = i.min.height, h = r - u / o), l = .5 * (u - t.height), a = t.y - l, s = t.y + t.height + l, (a < 0 || Math.round(s) > Math.round(i.height)) && (p = Math.min(t.y, i.height - (t.y + t.height)), a = t.y - p, s = t.y + t.height + p, u = s - a, n = u / o, h = r - n), {
                                    x: h,
                                    y: a,
                                    width: r - h,
                                    height: s - a
                            ...
                            ne: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return s = t.x, r = t.y + t.height, a = O(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : O(r - e.y, i.min.height, r), u < i.min.height && (u = i.min.height, a = s + u / n), o = t.y - (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            se: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return s = t.x, o = t.y, a = O(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : O(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, a = s + u / n), r = t.y + t.height + (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), r = t.y + t.height + l, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            sw: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return a = t.x + t.width, o = t.y, s = O(e.x, 0, a), a - s < i.min.width && (s = a - i.min.width), u = n ? (a - s) * n : O(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, s = a - u / n), r = t.y + t.height + (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), r = t.y + t.height + l, u = r - o, h = u / n, s = a - h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            nw: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return a = t.x + t.width, r = t.y + t.height, s = O(e.x, 0, a), a - s < i.min.width && (s = a - i.min.width), u = n ? (a - s) * n : O(r - e.y, i.min.height, r), u < i.min.height && (u = i.min.height, s = a - u / n), o = t.y - (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = r - o, h = u / n, s = a - h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                        ...
                        return function() {
                            ...
                            return p(n, [{
                                ...
                                value: function() {
                                    ...
                                    this._element.appendChild(o), C(document, b.DOWN, this)
                                }
                            }, {
                                key: "reset",
                                value: function() {
                                ...
                                value: function(t, e, i, n) {
                                    this._interaction = null, this._rect = {
                                        x: O(t, 0, this._space.width - this._minWidth),
                                        y: O(e, 0, this._space.height - this._minHeight),
                                        width: O(i, this._minWidth, this._space.width),
                                        height: O(n, this._minHeight, this._space.height)
                                    }, this._rectChanged = !0, this._redraw(), this._element.dispatchEvent(new CustomEvent("change"))
                                }
                            }, {
                                key: "handleEvent",
                                ...
                                key: "_onStartDrag",
                                value: function(t) {
                                    this._element.contains(t.target) && (t.preventDefault(), C(document, b.MOVE, this), C(document, b.UP, this), this._interaction = {
                                ...
                                value: function(t) {
                                    ...
                                    "c" === n ? (this._rect.x = O(e.x - this._interaction.offset.x, 0, this._space.width - this._rect.width), this._rect.y = O(e.y - this._interaction.offset.y, 0, this._space.height - this._rect.height)) : i[n] && (this._rect = i[n](this._rect, {
                                        x: e.x - this._space.x,
                                        y: e.y - this._space.y
                                    }, {
                                        x: 0,
                                ...
                                key: "_onStopDrag",
                                value: function(t) {
                                    t.preventDefault(), E(document, b.MOVE, this), E(document, b.UP, this), this._interaction = null, this._element.setAttribute("data-dragging", "false"), this._element.dispatchEvent(new CustomEvent("change"))
                                }
                            }, {
                                key: "_redraw",
                                value: function() {
                                ...
                                key: "destroy",
                                value: function() {
                                    this._interaction = !1, this._rectChanged = !1, E(document, b.DOWN, this), E(document, b.MOVE, this), E(document, b.UP, this), Et(this._element)
                                }
                            }, {
                                key: "element",
                                get: function() {
                            ...
                            n = function() {
                                ...
                                return p(n, [{
                                    ...
                                    value: function() {
                                        ...
                                        }), this._utilsGroup = S("div", "slim-editor-utils-group");
                                        var e = S("button", "slim-editor-utils-btn slim-btn-rotate" + (this._options.buttonRotateClassName ? " " + this._options.buttonRotateClassName : ""));
                                    ...
                                    value: function() {
                                        if (!this._rotating) {
                                            var t = this._wrapperRotation % 180 !== 0,
                                                ...
                                                i = ft(e, t ? this._input.height : this._input.width, t ? this._input.width : this._input.height);
                                    ...
                                    value: function() {
                                        ...
                                        if (!this._rotating) {
                                            ...
                                            e && M(e, 90), this._updateWrapperScale(), this._hideCropper(), u(this._previewWrapper, {
                                    ...
                                    value: function(t, e, i, n, o) {
                                        ...
                                        var r = this._wrapperRotation % 180 !== 0,
                                            s = _t(i, r ? t.height : t.width, r ? t.width : t.height);
                                        this._preview.onload = function() {
                                            a._preview.onload = null, a._cropper.ratio = a.ratio, a._redraw(), a._redrawCropper(s), o(), a._element.style.opacity = ""
                                        }, this._preview.src = "", this._preview.src = ut(this._input, Math.min(this._container.offsetWidth / this._input.width, this._container.offsetHeight / this._input.height) * this._options.devicePixelRatio).toDataURL()
                                    }
                                }, {
                                    key: "_redrawCropper",
                                    value: function(t) {
                                        ...
                                        p = t ? {
                                            ...
                                            width: t.width * s,
                                            height: t.height * h
                                        } : it(s, h, this._ratio || h / s), this._cropper.resize(p.x, p.y, p.width, p.height)
                                    }
                                }, {
                                    key: "_redraw",
                                    value: function() {
                                        ...
                                        this._wrapper.style.cssText = "\n\t\t\t\tleft:" + a + "px;\n\t\t\t\ttop:" + r + "px;\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewBlurred.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._preview.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewSize = {
                                            width: n,
                                            height: o
                                        }, this._blurredPreview || (this._previewBlurred.width = 300, this._previewBlurred.height = this._previewBlurred.width * t, pt(this._input, this._previewBlurred), ct(this._previewBlurred, 3), this._blurredPreview = !0)
                                    }
                                }, {
                                    key: "show",
                                    value: function() {
                                    ...
                                    value: function() {
                                        var t = this;
                                        Ct(this._btnGroup.children).forEach(function(e) {
                        ...
                        return function() {
                            ...
                            return p(n, [{
                                ...
                                value: function(t) {
                                    ...
                                    return null === e || e ? (this._dragPath || (this._dragPath = []), this._dragPath.push(v(t)), void this._element.dispatchEvent(new CustomEvent("file-over", {
                                        detail: {
                                            x: L(this._dragPath).x,
                                            y: L(this._dragPath).y
                                        }
                    ...
                    zt = function() {
                        return function() {
                            ...
                            return p(i, [{
                                key: "_init",
                                value: function() {
                                    this._element = S("div", "slim-popover"), this._element.setAttribute("data-state", "off"), document.body.appendChild(this._element), this._element.addEventListener("touchmove", function(t) {
                                        t.preventDefault()
                                    }, !0)
                                }
                            }, {
                                ...
                                value: function() {
                                    ...
                                    u(this._element, {
                                        ...
                                        duration: 500,
                                        complete: function() {
                                            A(t._element), t._element.setAttribute("data-state", "off"), i()
                                        }
                                    })
                                }
                            }, {
                    ...
                    Ht = ["x", "y", "width", "height"],
                    Nt = ["file-invalid-drop", "file-invalid", "file-drop", "file-over", "file-out", "click"],
                    Bt = ["cancel", "confirm"],
                    Ft = ["remove", "edit", "download", "upload"],
                    Wt = null,
                    qt = 0,
                    ...
                    Yt = function() {
                        ...
                        return p(i, [{
                            ...
                            value: function(t, e) {
                                if ("number" == typeof t || t % 90 === 0) {
                                    ...
                                    if (this._data.input.image) {
                                        ...
                                        this._data.actions.crop = it(n, o, this._ratio), this._data.actions.crop.type = Ut.AUTO
                                    }
                            ...
                            key: "setSize",
                            value: function(t, e) {
                                "string" == typeof t && (t = Gt(t)), t && t.width && t.height && (this._options.size = gt(t), this._data.actions.size = gt(t), this._data.input.image && e && this._manualTransform(e))
                            }
                        }, {
                            key: "setForceSize",
                            value: function(t, e) {
                                "string" == typeof t && (t = Gt(t)), t && t.width && t.height && (this._options.size = gt(t), this._options.forceSize = gt(t), this._data.actions.size = gt(t), this.setRatio(this._options.forceSize.width + ":" + this._options.forceSize.height, e))
                            }
                        }, {
                            key: "setRatio",
                            value: function(t, e) {
                                ...
                                if (t && "string" == typeof t && (this._options.ratio = t, this._isFixedRatio())) {
                                    var n = Dt(this._options.ratio, ":");
                                    this._ratio = n[1] / n[0],
                                        this._data.input.image && e ? this._cropAuto(function(t) {
                                            i._scaleDropArea(i._ratio), e && e(t)
                                        }) : (this._data.input.image && (this._data.actions.crop = it(this._data.input.image.width, this._data.input.image.height, this._ratio), this._data.actions.crop.type = Ut.AUTO), this._scaleDropArea(this._ratio), e && e(null))
                                }
                            }
                        }, {
                            key: "isAttachedTo",
                            ...
                            key: "_isAutoCrop",
                            value: function() {
                                return this._data.actions.crop.type === Ut.AUTO
                            }
                        }, {
                            key: "_toggleButton",
                            value: function(t, e) {
                                St('.slim-btn[data-action="' + t + '"]', e, this._element)
                            }
                        }, {
                            key: "_clearState",
                            value: function() {
                            ...
                            key: "_addState",
                            value: function(t) {
                                z(t, this._state) || (this._state.push(t), this._updateState())
                            }
                        }, {
                            key: "_updateState",
                            value: function() {
                            ...
                            value: function() {
                                ...
                                } else this._output = S("input"), this._output.type = "hidden", this._output.name = this._input.name || this._options.defaultInputName, this._element.appendChild(this._output);
                                this._input.removeAttribute("name");
                                var o = S("div", "slim-area"),
                                ...
                                if (this._isImageOnly()) o.innerHTML = "\n\t\t\t\t" + jt + "\n\t\t\t\t" + Vt + "\n\t\t\t\t" + h + '\n\t\t\t\t<div class="slim-status"><div class="slim-label-loading">' + (this._options.labelLoading || "") + "</div></div>\n\t\t\t";
                                    ...
                                    z("input", this._options.post) && (this._data.input.field = this._inputReference, this._options.service || (this._input.name = this._inputReference));
                                    var u = void 0;
                                    this._input.hasAttribute("accept") && "image/*" !== this._input.getAttribute("accept") ? u = this._input.accept.split(",").map(function(t) {
                                        return t.trim()
                                    }).filter(function(t) {
                                        return t.length > 0
                                    }) : (u = H(), this._input.setAttribute("accept", u.join(","))), this._imageHopper = new Ot, this._imageHopper.accept = u, this._imageHopper.allowURLs = "string" == typeof this._options.fetcher, this._element.appendChild(this._imageHopper.element), Nt.forEach(function(e) {
                                        t._imageHopper.element.addEventListener(e, t)
                                    }), o.innerHTML = "\n\t\t\t\t" + jt + "\n\t\t\t\t" + Vt + '\n\t\t\t\t<div class="slim-drip"><span><span></span></span></div>\n\t\t\t\t<div class="slim-status"><div class="slim-label">' + (this._options.label || "") + '</div><div class="slim-label-loading">' + (this._options.labelLoading || "") + "</div></div>\n\t\t\t\t" + h + "\n\t\t\t", this._input.addEventListener("change", this)
                                }
                                if (this._element.appendChild(o), this._btnGroup = S("div", "slim-btn-group"), this._btnGroup.style.display = "none", this._element.appendChild(this._btnGroup), Ft.filter(function(e) {
                            ...
                            value: function() {
                                ...
                                var e = function() {
                                    var e = setTimeout(function() {
                                        Xt(t._timers, e), t._options.didInit.apply(t, [t.data, t])
                                    }, 0);
                                    t._timers.push(e)
                                };
                            ...
                            value: function(t) {
                                if (t = Math.min(.99999, t), this._element && this._progressEnabled) {
                                    ...
                                    if (e) {
                                        ...
                                        .5 * i < o || (n[0].setAttribute("d", Tt(.5 * i, .5 * i, .5 * i - o, .9999)), n[1].setAttribute("d", Tt(.5 * i, .5 * i, .5 * i - o, t)))
                                    }
                                }
                            }
                        }, {
                            ...
                            value: function(t) {
                                ...
                                e || (e = S("div", "slim-error"), this._element.querySelector(".slim-status").appendChild(e)), e.innerHTML = t, this._options.didThrowError.apply(this, [t])
                            }
                        }, {
                            key: "_removeError",
                            value: function() {
                            ...
                            value: function(t) {
                                ...
                                u(i, {
                                    ...
                                    duration: 200,
                                    complete: function() {
                                        A(i.firstChild), e._load(t.target.files[0])
                                    }
                                })
                            }
                        }, {
                            ...
                            value: function(t, i) {
                                ...
                                if (!this._isBeingDestroyed) {
                                    ...
                                    if ("string" == typeof t) return void(J(t) ? this._load(Q(t), i, o) : (a(), Z(t, this._options.willLoad, function(t) {
                                        n._load(t, i, o)
                                    }, function(t) {
                                        setTimeout(function() {
                                    ...
                                    if ("undefined" != typeof t.remote) return J(t.remote) ? void this._load(Q(t.remote), i, o) : void(this._options.fetcher && $(this._options.fetcher, this._options.willFetch, this._options.willLoad, t.remote, function(t) {
                                    ...
                                    if (s.size && this._options.maxFileSize && U(s.size) > this._options.maxFileSize) return r(), this._onOverWeightFile(), void(i && i.apply(this, ["file-too-big"]));
                                    this._imageEditor && this._imageEditor.dirty(), this._data.input.name = o && o.name ? o.name : V(s), this._data.input.type = G(s), this._data.input.size = s.size, this._data.input.file = s;
                                    var h = this._options.internalCanvasSize;
                                    f() && (h = this._options.internalCanvasSizeLowMemory), et(s, h, function(t, e) {
                                        var a = function() {
                                        ...
                                        if (!dt(t, n._options.minSize)) return a(), n._onImageTooSmall(), void(i && i.apply(n, ["image-too-small"]));
                            ...
                            value: function(t, e, i, n) {
                                ...
                                if (n || (n = {}), !this._isBeingDestroyed) {
                                    f() ? (this._data.input.image = new Image, this._data.input.image.src = t.toDataURL()) : this._data.input.image = t, this._data.input.width = t.width, this._data.input.height = t.height, this._initialRotation && (this._data.actions.rotation = this._initialRotation, this._initialRotation = null);
                                    ...
                                    var r = function() {
                                        o._options.size && (o._data.actions.size = {
                                            ...
                                            a.src = "", a.src = ut(t, r * h).toDataURL(), a.onload = function() {
                                                a.onload = null, o._isBeingDestroyed || e && e(s)
                                            }
                                        })
                                    };
                                    this._initialCrop ? (this._data.actions.crop = gt(this._initialCrop), this._data.actions.crop.type = Ut.INITIAL, this._initialCrop = null, r()) : this._options.willCropInitial.apply(this, [this.data, function(e) {
                                        e ? (o._data.actions.crop = e, o._data.actions.crop.type = Ut.INITIAL) : (o._data.actions.crop = it(a ? t.height : t.width, a ? t.width : t.height, o._ratio), o._data.actions.crop.type = Ut.AUTO), r()
                                    }, this])
                                }
                            }
                        }, {
                            ...
                            value: function(t, e) {
                                ...
                                n.filters = {
                                    ...
                                    var n = t;
                                    if (i._options.forceSize || i._options.size && 1 == ht(i._options.size, t)) {
                                        n = S("canvas"), n.width = i._options.size.width, n.height = i._options.size.height;
                                        var o = n.getContext("2d");
                                    ...
                                    if (i._options.forceMinSize && i._options.size && i._options.minSize.width === i._options.size.width && i._options.minSize.height === i._options.size.height && (n.width < i._options.minSize.width || n.height < i._options.minSize.height)) {
                                        ...
                                        n = S("canvas"), n.width = a, n.height = r;
                                    ...
                                    if (i._options.forceMinSize && 1 === i._ratio && (n.width < i._options.minSize.width || n.height < i._options.minSize.height)) {
                                        n = S("canvas"), n.width = i._options.minSize.width, n.height = i._options.minSize.height;
                            ...
                            value: function() {
                                var t = this;
                                this._imageEditor || (this._imageEditor = new Lt(S("div"), {
                            ...
                            value: function(t) {
                                ...
                                i ? this._startProgress(function() {
                                    e._updateProgress(.1)
                                }) : this._startProgressLoop(), this._removeState("editor"), this._addState("busy"), this._output.value = "", this._data.actions.rotation = t.detail.rotation, this._data.actions.crop = t.detail.crop, this._data.actions.crop.type = Ut.MANUAL, this._applyTransforms(this._data.input.image, function(t) {
                            ...
                            value: function() {
                                var t = arguments.length > 0 && arguments[0] !== e ? arguments[0] : function(t) {},
                                    ...
                                    n = it(i ? this._data.input.image.height : this._data.input.image.width, i ? this._data.input.image.width : this._data.input.image.height, this._ratio);
                                this._crop(n.x, n.y, n.width, n.height, t, Ut.AUTO)
                            }
                        }, {
                            key: "_crop",
                            value: function(t, i, n, o) {
                                var a = arguments.length > 4 && arguments[4] !== e ? arguments[4] : function(t) {},
                                    r = arguments.length > 5 && arguments[5] !== e ? arguments[5] : Ut.MANUAL;
                            ...
                            value: function(t) {
                                ...
                                this._startProgressLoop(), this._addState("busy"), this._applyTransforms(this._data.input.image, function(i) {
                                    ...
                                    var r = "auto" === e._options.devicePixelRatio ? window.devicePixelRatio : e._options.devicePixelRatio;
                                    o.src = "", o.src = ut(i, o.offsetWidth / i.width * r).toDataURL(), o.onload = function() {
                                    ...
                                    var o = i._element.querySelector(".slim-upload-status"),
                                        ...
                                        h = function(t) {
                                            ...
                                            var a = setTimeout(function() {
                                                Xt(i._timers, a), o.innerHTML = n, o.setAttribute("data-state", "error"), o.style.opacity = 1
                                            }, 250);
                                            i._timers.push(a), e(t)
                                        };
                                    "string" == typeof i._options.service ? D(i._options.service, i._options.uploadMethod, n, a, r, s, h) : "function" == typeof i._options.service && i._options.service.apply(i, ["file" === i._options.serviceFormat ? t : n, r, s, h, i])
                                }, t)
                            }
                        }, {
                            key: "requestOutput",
                            value: function(t, e) {
                                ...
                                return this._data.input.file ? (e || (e = this.dataBase64), void n.parseMetaData(this._data.input.file, function(o) {
                                    var a = [],
                                        r = new FormData;
                                    if (z("input", i._options.post) && (a.push(i._data.input.file), r.append(i._inputReference, i._data.input.file, i._data.input.file.name)), z("output", i._options.post) && null !== i._data.output.image && i._options.uploadBase64 === !1) {
                                        var s = Q(e.output.image, e.output.name);
                                        if (o.imageHead && i._options.copyImageHead) try {
                                            s = new Blob([o.imageHead, n.blobSlice.call(s, 20)], {
                                                type: bt(e.output.image)
                                            }), s = Y(s, e.output.name)
                                        } catch (h) {}
                                        a.push(s);
                            ...
                            key: "_showEditor",
                            value: function() {
                                Wt.className = this._options.popoverClassName, Wt.show(), this._imageEditor.show()
                            }
                        }, {
                            key: "_hideEditor",
                            value: function() {
                            ...
                            value: function(t) {
                                ...
                                if (!this._isImageOnly()) {
                                    ...
                                    var o = setTimeout(function() {
                                        Xt(e._timers, o), e._isBeingDestroyed || (e._hideButtons(function() {
                            ...
                            value: function() {
                                ...
                                t && xt(this._data, this._options.jpegCompression, this._options.forceType)
                            }
                        }, {
                            key: "_doDestroy",
                            value: function() {
                                ...
                                this._isBeingDestroyed = !0, this._timers.forEach(function(t) {
                                    clearTimeout(t)
                                }), this._timers = [], u(this._element, "detach"), this._imageHopper && (Nt.forEach(function(t) {
                                ...
                                }), this._imageEditor.destroy(), this._imageEditor = null), Ct(this._btnGroup.children).forEach(function(t) {
                                ...
                                }), qt = Math.max(0, qt - 1), Wt && 0 === qt && (Wt.destroy(), Wt = null), this._originalElement = null, this._element = null, this._input = null, this._output = null, this._btnGroup = null, this._options = null
                            }
                        }, {
                            key: "dataBase64",
                            get: function() {
                                return kt(this._data, this._options.post, this._options.jpegCompression, this._options.forceType, null !== this._options.service)
                            }
                        }, {
                            key: "data",
                            get: function() {
                                return yt(this._data)
                            }
                        }, {
                            key: "element",
                            get: function() {
                            ...
                            value: function() {
                                ...
                                return Ft.concat(Lt.Buttons).concat("rotate").forEach(function(e) {
                                    var i = I(e);
                ...
                return function() {
                    ...
                    Ft.concat(Lt.Buttons).concat("rotate").forEach(function(t) {
                        var e = I(t);
                        f.forEach(function(t) {
                            d["button" + e + t] = o
                        })
                    }), Yt.supported = function() {
                        ...
                        var e, i, n, o = [];
                        for (e = t.querySelectorAll(".slim:not([data-state])"), n = e.length; n--;) i = e[n], o.push(Yt.create(i, Yt.getOptionsFromAttributes(i)));
                        return o
                    }, Yt.getOptionsFromAttributes = function(t) {
                        var e = _(t),
                            i = {
                                meta: {}
                            };
                        for (var n in e) {
                            var o = d[n],
                                a = e[n];
                            o ? (a = o(a), a = null === a ? gt(Yt.options()[n]) : a, i[n] = a) : 0 === n.indexOf("meta") && (i.meta[T(n.substr(4))] = a)
                        }
                        return i
                    }, Yt.find = function(t) {
                        ...
                        if (!Yt.find(t)) {
                            e || (e = Yt.getOptionsFromAttributes(t));
                            var n = new Yt(t, e);
                            return i.push(n), n
                        }
