<?php
$from = 'From: Maha Buddy';
$subject = 'Order Placed Successfully From Maha Buddy';
...
$body .= 'Net Payment:  &#8377;'.number_format($Total_Order,2).'<br>';
...
$body .= '<h3>Order Details :</h3><br><table style="border: 1px solid #ddd;text-align: left;border-collapse: collapse;width: 100%;">
  ...
  if($row_cnt > 0){
    while($row = $res2->fetch_assoc()){
 	...
 	<img src="https://mahabuddy.com/uploads/'.$row['Photo'].'" alt="" style="width: 50px;"></td>
       <td style="border: 1px solid #ddd;text-align: left;padding: 15px;">
...
if($Discount>0){
     $body .= '<tr>
    <td colspan="2" style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong> Discount <br>(Coupon Applied)<</strong></td>
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"></td>
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong style="color:red;">- &#8377;'.number_format($Discount,2).'</strong></td>
    </tr>';
  }
  if($WalletAmt>0){
      $body .= '<tr>
    <td colspan="2" style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong>Wallet Amount Used<</strong></td>
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"></td>
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong style="color:red;">- &#8377;'.number_format($WalletAmt,2).'</strong></td>
    </tr>';
  }
    $body .= '
    <tr>
   <td colspan="2" style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong>Grand Total</strong></td>
    ...
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong>&#8377;'.number_format($GrandTotal+$ShippingCharge-$Promoprice-$Discount-$WalletAmt-$SevenDaysFreeAmt,2).'</strong></td>
    </tr>';
$body .= '</table><br>';
