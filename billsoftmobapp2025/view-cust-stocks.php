        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="add-cust-stock.php" class="btn btn-sm btn-default rounded">Add New</a>
                    ...
                    INNER JOIN tbl_cust_products_2025 p ON ts.ProdId=p.id WHERE ts.FrId='$FranchiseId' AND ts.Status='Cr' AND ts.Qty>0 AND ts.ProdType=0";
                            $row = getList($sql);
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="text-secondary"><?php echo date("d/m/Y", strtotime(str_replace('-', '/',$result['StockDate'])))?><br>
                                           Qty : <?php echo $result['Qty'];?> | Min Qty : <?php echo $result['MinQty'];?>
                                       </p>
