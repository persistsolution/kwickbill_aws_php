                            ...
                            <li class="list-group-item" style="border-radius: 10px;">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto" align="right" >
                                         <p class="small text-secondary"><strong>&#8377;<?php echo number_format($NetAmount3,2);?></strong></p>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class=" px-0">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item" style="border-radius: 10px;">
                                ...
                                <div class="row align-items-center">
                                    <div class="col align-self-center pr-0" width="80%">
                                        <h6 class="font-weight-normal mb-1" style="color:black;"><?php echo $result['ShopName'];?></h6>
                                          <p class="small text-secondary"><?php echo $result['Address'];?></p>
                                       
                                    </div>
                                    <div class="col-auto" align="right" >
                                         <p class="small text-secondary"><strong>&#8377;<?php echo number_format($NetAmount,2);?></strong></p>
                                    </div>
                                </div>
                            </li>
                            </a>
