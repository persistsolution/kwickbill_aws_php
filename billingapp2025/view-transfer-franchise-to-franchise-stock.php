...
{
  $id = $_REQUEST["id"];
  $sql11 = "DELETE FROM tbl_transfer_franchise_prod_stock WHERE id = '$id'";
  $conn->query($sql11);
  $sql11 = "DELETE FROM tbl_transfer_franchise_prod_stock_items WHERE TransferId = '$id'";
  $conn->query($sql11);
  $sql11 = "DELETE FROM tbl_cust_prod_stock WHERE TransferId = '$id'";
  $conn->query($sql11);
  ?>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            <?php 
            $i=1;
            $sql = "SELECT tp.*,tu.Fname AS GodownName,tu2.ShopName FROM tbl_transfer_franchise_prod_stock tp 
