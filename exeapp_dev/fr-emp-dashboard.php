...
?>
  ...
  <div class="row">
    ...
    <!-- Today Present -->
    <div class="col-6 mb-3-half">
      <a href="bdm-employee.php?val=present&frid=<?php echo $frid;?>" class="dashboard-card" style="background: linear-gradient(135deg, #00ACC1, #26C6DA);">
    ...
    <!-- Today Absent -->
    <div class="col-6 mb-3-half">
      <a href="bdm-employee.php?val=absent&frid=<?php echo $frid;?>" class="dashboard-card" style="background: linear-gradient(135deg, #E53935, #EF5350);">
    ...
    <div class="col-6 mb-3-half">
      <a href="all-attendance.php?frid=<?php echo $frid;?>&start_date=<?php echo $yesterday;?>&end_date=<?php echo $yesterday;?>" class="dashboard-card" style="background: linear-gradient(135deg, #E53935, #EF5350);">
    <span class="material-icons dashboard-icon">check_circle</span>
        <p class="dashboard-title">&nbsp;&nbsp;Date Wise<br>Attendance </p>
        <p class="dashboard-count"></p>
      </a>
    </div>

    <!-- Today Joining -->
    <div class="col-6 mb-3-half">
      <a href="bdm-employee.php?val=todayjoin&frid=<?php echo $frid;?>" class="dashboard-card" style="background: linear-gradient(135deg, #8E24AA, #BA68C8);">
    ...
    <!-- Below 6 Months -->
    <div class="col-6 mb-3-half">
      <a href="bdm-employee.php?val=below6month&frid=<?php echo $frid;?>" class="dashboard-card" style="background: linear-gradient(135deg, #F57C00, #FFA726);">
    ...
    <!-- 6 Months to 1 Year -->
    <div class="col-6 mb-3-half">
      <a href="bdm-employee.php?val=above6month&frid=<?php echo $frid;?>" class="dashboard-card" style="background: linear-gradient(135deg, #6D4C41, #A1887F);">
    ...
    <!-- Above 1 Year -->
    <div class="col-6 mb-3-half">
      <a href="bdm-employee.php?val=above1year&frid=<?php echo $frid;?>" class="dashboard-card" style="background: linear-gradient(135deg, #455A64, #90A4AE);">
