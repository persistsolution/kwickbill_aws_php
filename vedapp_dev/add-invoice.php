...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0 main">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($_GET['id'] == '') {
                $qx = "INSERT INTO tbl_vendor_expense_invoices SET BranchId='$BranchId',Photo='$Photo',Photo2='$Photo2',UserId = '$UserId',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst'";
                $conn->query($qx);
                $to = $row55['ExpMail'];
        ...
        ?>
            ...
            <?php
                ...
                $query2 = "UPDATE tbl_vendor_expense_invoices SET BranchId='$BranchId',Photo='$Photo',Photo2='$Photo2',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',Gst='$Gst' WHERE id = '$id'";
                $conn->query($query2);
            ?>
                <script type="text/javascript">
                    setTimeout(function() {
