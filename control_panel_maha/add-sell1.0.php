            ...
            if(trim($_POST["EmiDate"][$i] != ''))  
              {
                ...
                $sql22 = "INSERT INTO tbl_emi SET SellId='$SellId',CustId='$CustId',EmiDate='$EmiDate',EmiAmt='$EmiAmt',EmiChequeNo='$EmiChequeNo'";
                $conn->query($sql22);
              }  
...
$sql = "DELETE FROM tbl_emi WHERE SellId='$SellId'";
$conn->query($sql);
}
...
$sql2 = "SELECT MAX(SrNo) as maxid FROM tbl_general_ledger WHERE Type='PR'";
    ...
    $sql3 = "INSERT INTO tbl_general_ledger SET SrNo='0',Code='',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',TotAmt='$Total',TotPaidAmt='0',TotBalAmt='0',PaidAmt='$Total',BalAmt='0',CrDr='dr',Roll=5,Type='INV',ProcFees='$ProcFees',CreatedDate='$CreatedDate',SellId='$SellId'";
    $conn->query($sql3);

    $sql4 = "INSERT INTO tbl_general_ledger SET SrNo='$SrNo',Code='$Code',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',TotAmt='$Total',TotPaidAmt='$DownPayment',TotBalAmt='$Balance',PaidAmt='$DownPayment',BalAmt='$Balance',CrDr='cr',Roll=5,Type='PR',CreatedDate='$CreatedDate',SellId='$SellId'";
    $conn->query($sql4);
...
<input type="number" name="Qty" id="Qty" class="form-control" placeholder="e.g.,1" value="1" autocomplete="off" min="1" oninput="getTotal(document.getElementById('Qty').value,document.getElementById('Price').value,document.getElementById('DownPayment').value,document.getElementById('Total').value,document.getElementById('ProcFees').value)">
</div>
...
<input type="text" name="Price" id="Price" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" oninput="getTotal(document.getElementById('Qty').value,document.getElementById('Price').value,document.getElementById('DownPayment').value,document.getElementById('Total').value,document.getElementById('ProcFees').value)">
</div>
...
<input type="text" name="Total" id="Total" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" readonly>
</div>
...
<input type="text" name="Balance" id="Balance" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" readonly>
</div>

<div class="form-group col-md-4">
<label class="form-label">EMI Month </label>
<input type="number" name="EmiMonth" id="EmiMonth" class="form-control" placeholder="e.g.,150" value="" autocomplete="off" min="1" oninput="calEmi()">
</div>
