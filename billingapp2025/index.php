                    ...
                    <div class="form-info">
                        <div class="form-section align-self-center">
                            <!--<div class="btn-section clearfix">
                                <a href="index.php" class="link-btn active btn-1 active-bg default-bg">OTP Login</a>
                            ...
                            <h1>Welcome!</h1>
                            <div class="typing">
                                <h3>Sign Into Your Account dd</h3>
                            </div>
                            <div class="clearfix"></div>
                            <form id="validation-form" method="post">
                                <div class="form-group">
                                    <label for="first_field" class="form-label">Mobile Number</label>
                                    <input name="Username" type="number" class="form-control" id="Username" placeholder="Mobile Number" aria-label="Email Address">
                                </div>
                                <div class="form-group">
                                    <label for="first_field" class="form-label">Printer Type</label>
                                    <select class="form-control" name="PrintType" id="PrintType">
                                        <option value="0" selected>Wired Printer</option>
                                        <option value="1" >Bluetooth Printer</option> 
                                    </select>
                                </div>
                                ...
                                <div class="form-group clearfix">
                                    <button type="submit" id="submit" class="btn btn-primary btn-lg btn-theme">Send OTP</button>
                                </div>
                            </form>
                            <!-- <p>Help & Support</p>
...
<script type="text/javascript">
     ...
     $('#submit').text('Please Wait...');
                ...
                success:function(data){ 
                 ...
                 window.location.href = 'login-otp-verify.php?phone='+Username+"&PrintType="+PrintType+"&uid="+uid; 
