...
<h4 class="font-weight-bold py-3 mb-0">List Of Category
...
<div class="form-row">
<div class="form-group col">
<label class="form-label">Category Icon <span class="text-danger">(e.g. ion ion-ios-power)</span></label>
<input type="text" name="Icon" class="form-control" id="Icon" placeholder="Category Icon">
<div class="clearfix"></div>
</div>
</div>
...
<input type="checkbox" name="Featured" id="Featured" class="custom-control-input" onclick="featured()">
<span class="custom-control-label">Main Category</span>
</label>
</div>
</div>
...
function category_lists(){
  var action = 'view';
      $.ajax({
  type: "POST",
  url: "ajax_files/ajax_shop_category.php",
   data:{action:action},  
