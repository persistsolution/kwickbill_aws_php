        ...
        else
        {
            ...
            else
            {
                ...
                $name2 = $filename2;
                 ...
                 unlink($filename2);
                 $Roll = $_GET['Roll'];
                 $sql = "DELETE FROM tbl_crop_image WHERE SessionId='$sessionid' AND UserId = '$UserId' AND SrNo = '$Roll'";
                 $conn->query($sql);
                $q = "INSERT INTO tbl_crop_image SET Image = '$my_image_path',SessionId='$sessionid',UserId = '$UserId',SrNo = '$Roll'";
                $conn->query($q);  
