 ...
 ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                ...
                <div class="card mb-4">
                    <form id="validation-form" method="post" enctype="multipart/form-data" action="save-req-raw-product-stock.php">
                        <div class="card-body">
<div class="form-row">
...
<?php 
$sql12 = "SELECT tp.ProductName,tp.id FROM tbl_cust_products2 tp WHERE tp.id IN ($AllocatedProdIds) AND tp.ProdType='1' ORDER BY tp.ProductName";
  $row12 = getList($sql12);
