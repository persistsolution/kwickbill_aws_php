...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE tbl_users SET ShopName='$ShopName',Address='$Address',Phone='$Phone',GstNo='$GstNo',terms_condition='$terms_condition',bottom_title='$bottom_title' WHERE id=5";
    $conn->query($sql);
...
<div class="form-group col-md-12">
   <label class="form-label">Comapany Name <span class="text-danger">*</span></label>
     <input type="text" name="ShopName" id="ShopName" class="form-control"
                                                placeholder="" value="<?php echo $row55['ShopName'];?>"
                                                autocomplete="off" >
 ...
 <div class="form-group col-md-6">
   <label class="form-label">Mobile No <span class="text-danger">*</span></label>
     <input type="text" name="Phone" id="Phone" class="form-control"
                                                placeholder="" value="<?php echo $row55['Phone'];?>"
                                                autocomplete="off" >
    <div class="clearfix"></div>
 </div>
