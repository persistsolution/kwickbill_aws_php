...
<?php }
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql4 = "INSERT INTO tbl_general_ledger SET SrNo='0',Code='OB',UserId='$CustId',
                            ...
                            SellId='$SellId',Flag='Invoice',AccRoll='Vendor',Main=1";
                    $conn->query($sql4);
                    ...
                    if ($Advance > 0) {
                        ...
                        $sql4 = "INSERT INTO tbl_general_ledger SET SrNo='$SrNo',Code='$Code',UserId='0',
                            ...
                            Type='PW',CreatedDate='$CreatedDate',PaymentDate='$InvoiceDate',
                            PayMode='$PayType',Narration='$Narration',
                            SellId='$SellId',Flag='Invoice',AccRoll='Company',PostId='$PostId',Main=1";
                        $conn->query($sql4);
                    }

                    $sql = "DELETE FROM tbl_invoice_details WHERE InvId='$SellId'";
                    $conn->query($sql);
                    $sql = "DELETE FROM tbl_raw_stock WHERE InvId='$SellId'";
                    $conn->query($sql);
...
<!-- 
                                                            <div class="form-group col-md-1">
                                                                ...
                                                                <input type="text" name="CgstPer[]" id="CgstPer1" class="form-control" placeholder="" value="<?php echo $result12["CgstPer"];?>" autocomplete="off" 
                                                            ...
                                                            <div class="form-group col-md-1">
                                                                ...
                                                                <input type="text" name="SgstPer[]" id="SgstPer1" class="form-control" placeholder="" value="<?php echo $result12["SgstPer"];?>" autocomplete="off" 
                                                                oninput="TotAmount(document.getElementById('Price1').value,
                                                                document.getElementById('SgstPer1').value,
                                                                document.getElementById('CgstPer1').value,
                                                                document.getElementById('ServiceAmt1').value,
                                                            ...
                                                            <div class="form-group col-md-2">
                                                                ...
                                                                <input type="text" name="GstAmt[]" id="GstAmt1" class="form-control" placeholder="" value="<?php echo $result12["GstAmt"];?>" autocomplete="off" readonly>
                                                            </div> -->
...
<label class="form-label">Qty<span class="text-danger">*</span></label>
<div class="input-group">
<input type="text" name="Qty[]" id="Qty<?php echo $row_cnt; ?>" class="form-control" placeholder="e.g.,S12" value="<?php echo $result12["Qty"];?>" autocomplete="off"
                                                                oninput="TotAmount(document.getElementById('Price<?php echo $row_cnt; ?>').value,
                                                                document.getElementById('Qty<?php echo $row_cnt; ?>').value,
                                                                document.getElementById('srno<?php echo $row_cnt; ?>').value)">
...
<input type="hidden" name="UnitId[]" id="UnitId<?php echo $row_cnt; ?>"  value="">
