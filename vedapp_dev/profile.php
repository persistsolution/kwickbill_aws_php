                ...
                <div class="card bg-default-secondary shadow-default">
                    <div class="card-body text-center ">
                        <div class="row justify-content-equal no-gutters">
                            ...
                            <div class="col-4 col-md-2 mb-3">
                                <a href="view-expenses.php" class="icon icon-50 rounded-circle mb-1 bg-default-light text-default"><span class="material-icons">view_list</span></a>
                                <p class="text-secondary"><small style="color:#fff;">My Expenses</small></p>
                            </div>
                            <div class="col-4 col-md-2 mb-3">
