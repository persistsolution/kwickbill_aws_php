...
$query = "SELECT * FROM tbl_locations WHERE Name = '$Name'";
...
$qx = "INSERT INTO tbl_locations SET Name = '$Name',Status='$Status'";
	$conn->query($qx);
	echo 1;
}
}
...
$query = "SELECT * FROM tbl_locations WHERE Name = '$Name' AND id != '$id'";
$result = $conn->query($query);
$row_cnt = mysqli_num_rows($result);
if($row_cnt > 0){
  echo 0;
  ...
  $query2 = "UPDATE tbl_locations SET Name = '$Name', Status='$Status' WHERE id = '$id'";
 	$conn->query($query2);
 }
  echo 1;
}
  ...
  if($_POST['action'] == 'delete') {
      ...
      $query = "DELETE FROM tbl_locations WHERE id = '$id'";
      $conn->query($query);
