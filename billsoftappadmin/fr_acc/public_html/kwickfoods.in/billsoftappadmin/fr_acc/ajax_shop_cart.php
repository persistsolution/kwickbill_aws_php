...
<!--<tr>
                                                    ...
                                                    <tr class="border-top">
                                                        <td>
                                                            <h5 class="m-0" style="font-size: 14px;">Total Amount:</h5>
                                                        </td>
                                                        <td class="font-weight-semibold" style="font-size:14px;color:#3fb51b;">
                                                             &#8377; <?php echo number_format($total_price3,2); ?>
                                                        </td>
                                                    </tr>
...
?>
                                                    ...
                                                    <tr class="border-top">
                                                        <td>
                                                            <h5 class="m-0" style="font-size: 14px;">Discount:</h5>
                                                        </td>
                                                        <td class="font-weight-semibold" style="font-size:14px;color:#3fb51b;">
                                                     ...
                                                     <tr class="border-top">
                                                        <td>
                                                            <h5 class="m-0" style="font-size: 14px;">Payable Amount:</h5>
                                                        </td>
                                                        <td class="font-weight-semibold" style="font-size:14px;color:#3fb51b;">
