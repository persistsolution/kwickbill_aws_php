...
<head>
<title><?php echo $Proj_Title; ?> | Products</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">List Of Products
  ...
  $(document).ready(function() {
    ...
    $('#example').DataTable( {
      ...
      $('#add_button').click(function(){  
           $('.modal-title').html("Add <span class='font-weight-light'>Product</span>");  
           $('#action').val("Add");  
           $('#id').val('');
