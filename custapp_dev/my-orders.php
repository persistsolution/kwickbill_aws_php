...
padding-left: 1px;">
                ...
                <div class="card mb-3">
                     <div class="card-header border-bottom">
                        <h6 class="mb-0" style="text-align: center;">My Orders</h6>
                    </div>
                     <?php 
                                     ...
                                     $ToDate = date("Y-m-d", strtotime(str_replace('/', '-',$_POST['ToDate'])));
                                       ...
                                       $sql2 = "SELECT ord.* FROM tbl_customer_invoice ord WHERE ord.CustId='$user_id' AND Status=1 AND ShopFrom='CustApp' ORDER BY ord.InvoiceDate DESC"; 
                                    ...
                                    //echo $sql2;
                                        ...
                                        $Total_Order = $row["NetAmount"];
                                     ?>
                    <div class="card-body position-relative">
                        <div class="row mb-2">
                            <div class="col">
                                <h6 class="mb-1 text-default"><a href="my-orders-details.php?oid=<?php echo $row['Unqid'];?>"><strong>Inv No : </strong><?php echo $row['InvoiceNo'];?></a></h6>
                                <p class="text-secondary small">Order On : <?php echo date("d/m/Y", strtotime(str_replace('-', '/',$row['InvoiceDate'])))." ".$row['CreatedTime'];?></p>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="media">                            
                            ...
                            <a href="my-orders-details.php?oid=<?php echo $row['Unqid'];?>" style="padding-top: 10px;"><button class="btn btn-sm btn-default rounded">View Details</button></a>                          
                        </div>
                    </div>
                    <hr >
                <?php }} ?>
