    ...
    <main class="flex-shrink-0 main">
        ...
        <div class="main-container">
            ...
            <div class="container mb-4">
                ...
                <div class="row">
                    <?php  
                        $sql11 = "SELECT * FROM tbl_page_files WHERE Status=1";
                        $row11 = getList($sql11);
                        foreach($row11 as $result){
                            $url =  $Uploadurl.'/uploads/'.$result["Files"];
                    ?>
                   <div class="col-12 col-md-12 col-lg-12">
                        <div class="card border-0 mb-4 overflow-hidden">
                            ...
                            <div class="card-body ">
                               ...
                               <button class="btn btn-default btn-block rounded" type="button" id="button-addon2" href="JavaScript:Void(0);" 
onclick="onDownloadFileFromUrl('<?php echo $url;?>','<?php echo $result["Files"];?>','1')">Download PDF</button>
                            </div>
                        </div>
                    </div>
                <?php } ?>
