...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_nso_vendor_expenses SET Locations='$Locations',ApproveDate='$ApproveDate',MannagerComment='$MannagerComment',MgrAmount='$MgrAmount',ManagerStatus='$ManagerStatus',MrgBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
  ...
  echo "<script>alert('Approved Successfully!');window.location.href='manager-nso-vendor-pending-expense-request.php';</script>";
