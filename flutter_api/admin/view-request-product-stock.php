...
<h4 class="font-weight-bold py-3 mb-0">View Request Product Stocks
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            LEFT JOIN tbl_users_bill tu2 ON tu2.id=tp.ToFrId WHERE tp.UpdateStatus=0 
            ...
            <tr>
               <td><?php echo $i; ?> </td>
                <!--<td><a href="edit-product-stock.php?id=<?php echo $row['id']; ?>" target="_blank">#<?php echo $row['id']; ?></a></td>-->
                <td><a href="request-product-print.php?id=<?php echo $row['id']; ?>" target="_blank">#<?php echo $row['id']; ?></a></td>
               <td><?php echo $row['GodownName']; ?></td>
             
                 <td><?php echo date("d/m/Y", strtotime(str_replace('-', '/',$row['StockDate']))); ?></td>
               <td><a href="request-product-print.php?id=<?php echo $row['id']; ?>" target="_blank"><?php echo $rncnt2; ?></a></td> 
               <td><a href="download-excel.php?id=<?php echo $row['id']; ?>" target="_blank">Download</a></td>
