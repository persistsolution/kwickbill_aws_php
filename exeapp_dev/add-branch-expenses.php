...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_branch_expenses SET BranchId='$BranchId',Photo='$Photo',Photo2='$Photo2',UserId = '$UserId',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst'";
  $conn->query($qx);
  $to = $row55['ExpMail'];
...
swal({
  title: "Thank you",
  text: "Branch Expenses submitted successfully .",
  type: "success",
...
<?php 
    ...
    $query2 = "UPDATE tbl_branch_expenses SET BranchId='$BranchId',Photo='$Photo',Photo2='$Photo2',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',Gst='$Gst' WHERE id = '$id'";
  $conn->query($query2);
  ?>
  <script type="text/javascript">
        setTimeout(function () { 
swal({
  title: "Thank you",
  text: "Branch Expenses updated successfully .",
  type: "success",
  confirmButtonText: "OK"
},
function(isConfirm){
    ...
    By Online</option>
                        ...
                        <div class="form-group float-label active">
                         ...
                         <div class="form-group float-label active">
                            ...
                            <label class="form-control-label">Upload Bill</label>                            
                        </div>
