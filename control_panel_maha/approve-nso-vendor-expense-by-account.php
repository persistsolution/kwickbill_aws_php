...
$MainPage = "Account-Vendor-Expense-Request";
$Page = "Account-Vendor-Peding-Expense-Request";
?>
<!DOCTYPE html>
...
if(isset($_POST['submit'])){
  ...
  $AccAmount = addslashes(trim($_POST["MgrAmount"]));
  $ManagerStatus = addslashes(trim($_POST["ManagerStatus"]));
  $Locations = addslashes(trim($_POST["Locations"]));

 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_nso_vendor_expenses SET Locations='$Locations',AdminApproveDate='$ApproveDate',AdminComment='$MannagerComment',AccAmount='$AccAmount',AdminStatus='$ManagerStatus',AccBy='$user_id',Status='$ManagerStatus' WHERE id = '$id'";
  $conn->query($query2);
  echo "<script>alert('Approved Successfully!');window.location.href='account-nso-vendor-pending-expense-request.php';</script>";
...
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Approve NSO Vendor Expense</h4>
...
<option value="Tax Invoice" <?php if($row7["InvType"] == 'Tax Invoice') {?> selected <?php } ?>>
 ...
 <div class="form-group col-md-12">
                        ...
                        <a href="../uploads/<?php echo $row7['Photo']; ?>" target="_blank">View</a><?php } ?>
                                            <div class="clearfix"></div>
                                        </div>
                        ...
                        <a href="../uploads/<?php echo $row7['Photo2']; ?>" target="_blank">View</a><?php } ?>
                                            <div class="clearfix"></div>
                                        </div>
