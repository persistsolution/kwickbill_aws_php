...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO tbl_transfer_godown_raw_prod_stock SET GodownId='$GodownId',FranchiseId='$FranchiseId',StockDate='$StockDate',TotQty='$TotQty',Narration='$Narration',CreatedBy='$user_id',CreatedDate='$CreatedDate'";
    $conn->query($sql);
                    ...
                    if ($number > 0) {
                        for ($i = 0; $i < $number; $i++) {
                            if (trim($_POST["ProdId"][$i] != '')) {
                                ...
                                $sql33 = "INSERT INTO tbl_transfer_godown_raw_stock_items SET GodownId='$GodownId',FranchiseId='$FranchiseId',ProdId='$ProdId',FrProdId='$FrProdId',Qty='$Qty',Unit='$Unit',CreatedDate='$CreatedDate',TransferId='$UseRawId',CreatedBy='$user_id',StockDate='$StockDate'";
                                $conn->query($sql33);
                                
                                $sql22 = "INSERT INTO tbl_godown_raw_prod_stock SET GodownId='$GodownId',FranchiseId='$FranchiseId',ProdId='$ProdId',Qty='$Qty',Unit='$Unit',CreatedDate='$CreatedDate',TransferId='$UseRawId',Status='Dr',Narration='$Narration',StockDate='$StockDate',CreatedBy='$user_id'";
                                $conn->query($sql22);
                            }
                        }
                    }

                    echo "<script>alert('Record Saved Successfully!');window.location.href='view-transfer-godwon-raw-stock.php';</script>";
}
...
<?php 
  $sql12 = "SELECT * FROM tbl_users_bill WHERE Roll=5 AND Status=1 AND id=9";
  $row12 = getList($sql12);
