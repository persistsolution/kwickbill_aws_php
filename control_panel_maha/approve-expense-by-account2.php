...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_expense_request SET AdminApproveDate='$ApproveDate',AdminComment='$MannagerComment',AccAmount='$AccAmount',AdminStatus='$ManagerStatus',AccBy='$user_id',Status='$ManagerStatus',ExpCatId='$ExpCatId' WHERE id = '$id'";
  $conn->query($query2);
...
<table>
 ...
 <tr>
  ...
  <div id="image-gallery">
    <?php if ($result["Photo"] != '' && file_exists('../expense_files/' . $result["Photo"])) { ?>
      <img src="../expense_files/<?php echo $result["Photo"]; ?>" style="height:100px; margin-right:5px;" />
    <?php } ?>
    
    <?php if ($result["Photo2"] != '' && file_exists('../expense_files/' . $result["Photo2"])) { ?>
      <img src="../expense_files/<?php echo $result["Photo2"]; ?>" style="height:100px; margin-right:5px;" />
    <?php } ?>
    
    <?php if ($result["Photo4"] != '' && file_exists('../expense_files/' . $result["Photo4"])) { ?>
      <img src="../expense_files/<?php echo $result["Photo4"]; ?>" style="height:100px; margin-right:5px;" />
    <?php } ?>
  </div>
      ...
      <!--<img src="../expense_files/<?php echo $result["Photo"];?>" -->
      <!--     style="height:100px; object-fit:cover; image-orientation: from-image;">-->
    

                 <!--<a href="../expense_files/<?php echo $result["Photo"];?>" target="_blank">-->
                 <!--    <img src="../expense_files/<?php echo $result["Photo"];?>" style="height:100px; object-fit:cover; image-orientation: from-image;">-->
                 <!--</a>-->
                  <?php }  else{?>
                <span style="color:red;">No Receipt Found</span>
             <?php } ?></td>
              ...
              <td><?php if($result["Photo2"] == '') {?>
                ...
                <!--     <img src="../expense_files/<?php echo $result["Photo2"];?>" style="height:100px;"/>-->
                <!--</div>-->
                  <?php }  else{?>
                <span style="color:red;">No Receipt Found</span>
             <?php } ?></td>
             ...
             <td><?php if($result["Photo4"] == '') {?>
                ...
                <!--  <div id="image-gallery3">-->
                <!--     <img src="../expense_files/<?php echo $result["Photo4"];?>" style="height:100px;"/>-->
                <!--</div>-->
                  <?php }  else{?>
                <span style="color:red;">No Image Found</span>
             <?php } ?></td>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (gallery) {
      new Viewer(gallery, {
        ...
        zoomable: true,
        viewed(image) {
          // auto-rotate based on EXIF is handled by browser if supported
        }
      });
    }
  });
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    const gallery = document.getElementById('image-gallery3');
    if (gallery) {
      new Viewer(gallery, {
        toolbar: true,
        navbar: false,
