                    ...
                    <div class="form-info">
                        <div class="form-section align-self-center">
                           <!-- <div class="btn-section clearfix">
                            ...
                            <?php if($_REQUEST['phone'] == '8956431679' || $_REQUEST['phone'] == '8956627166'){
     ...
     $('#submit').text('Please Wait...');
                ...
                success:function(data){ 
                  ...
                  var Username = res.Username;
                    ...
                    if(Roll == 5){
                window.location.href = 'https://kwickfoods.in/billsoftappadmin2025/fr_acc/dashboard.php'; 
                    }
                    else{
                       window.location.href = 'https://kwickfoods.in/billsoftappadmin2025/fr_acc/employee-dashboard.php';  
                    }
                    }, 1000);
