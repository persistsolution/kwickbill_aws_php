                ...
                <div class="card">
                    ...
                    <div class="card-body px-0 pt-0">
                        <ul class="list-group list-group-flush" id="show_prod">
                             <?php 
                                $sql2 = "SELECT * FROM tbl_users WHERE Roll='3' AND CreatedBy='$UserId' ORDER BY id DESC"; 
                ...
                <?php } else if(file_exists("../uploads/".$row['Photo'])) {?>
                 ...
                 <?php } ?>           
                                    ...
                                    <div class="col align-self-center pr-0">
                                        <h6 class="font-weight-normal mb-1" style="color: #212529"><?php echo $row['Fname']." ".$row['Lname']; ?></h6>
                        ...
                        <?php }} else{ ?><br>
                           <div class="col-auto">
                                        <h6 class="text-danger">Oops! No Vendor Found..</h6>
                                    </div>
                           <?php } ?>
                        </ul>
                    </div>
