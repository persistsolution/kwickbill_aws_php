...
$sql77 = "SELECT * FROM tbl_users_bill WHERE id='".$row['FromFrId']."'";
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="">
                            <div class="card-body p-2">
                                ...
                                <strong>REQUEST PRODUCT STOCK INVOICE</strong>
                                <br><br>
...
State: Maharashtra</div>
        ...
        <?php 
$i=1;
$sql44 = "SELECT ttg.*,tgp.ProductName FROM tbl_request_product_stock_items ttg LEFT JOIN tbl_cust_products tgp ON ttg.ProdId=tgp.id WHERE ttg.TransferId='$id'";
$row44 = getList($sql44);
...
?>                            <tr>
                                                ...
                                                <td class="py-3">
                                                    <strong><?php echo $result['MinPrice'];?></strong>
                                                </td>
                                                 <td class="py-3">
