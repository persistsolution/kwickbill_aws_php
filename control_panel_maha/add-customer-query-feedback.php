...
$CreatedTime = date('h:i a');
      ...
      $qx = "INSERT INTO tbl_customer_query_feedback SET SellId='0',CustId='$CustId',CustName='$CustName',Phone = '$Phone',Status='1',Address='$Address',CreatedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime',Details='$Details',CreatedDate='$CreatedDate',CreatedTime='$CreatedTime',Diaposition='$Diaposition'";
  $conn->query($qx);
...
$i=2;
$id = $_GET['id'];
  $sql2 = "SELECT tp.*,tu.Fname,tu.Lname FROM tbl_customer_query_feedback tp 
                                                    ...
                                                    <div class="d-flex col">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="card bg-light my-3 p-3 hid-md">
                                                                <h6><img src="assets/img/user/avatar-5.jpg" alt="" class="wid-20 avatar mr-2 rounded">Conversations</h6>
