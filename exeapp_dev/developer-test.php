...
<option value="Online" <?php if($row7["PaymentMode"] == 'Online') {?> selected <?php } ?>>
 ...
 <div class="form-group float-label active">
                        ...
                        <div class="form-group float-label active">
                         ...
                         <div class="form-group float-label active">
                            <input type="file" class="form-control" id="Photo" name="Photo" accept=".jpeg">
                      ...
                      <div class="form-group float-label active">
                            <input type="file" class="form-control" id="Photo2" name="Photo2" accept=".jpg">
                            <label class="form-control-label">Upload Image By Camera</label>                            
                        </div>
                        ...
                        <a href="../uploads/<?php echo $row7['Photo3']; ?>"><?php echo $row7['Photo3']; ?></a><?php } ?>
                         ...
                         <div class="form-group float-label active">
                            <input type="file" class="form-control" id="Photo4" name="Photo4" accept=".mp4">
                        ...
                        <a href="../uploads/<?php echo $row7['Photo4']; ?>"><?php echo $row7['Photo4']; ?></a><?php } ?>
                            ...
                            <div class="form-group float-label active">
                            <input type="file" class="form-control" id="Photo3" name="Photo3[]" multiple accept=".png">
                            <label class="form-control-label">Upload Multiple</label>                            
                        </div>
