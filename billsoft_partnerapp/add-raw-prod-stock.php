...
<?php 
$id = $_GET['id'];
$sql7 = "SELECT * FROM tbl_fr_raw_stock WHERE id='$id'";
...
<?php 
  if(isset($_POST['submit'])){
    ...
    if($_GET['id'] == ''){
     $qx = "INSERT INTO tbl_fr_raw_stock SET FrId='$FranchiseId',ProdId='$ProdId',Qty='$Qty',Unit='$Unit',CreatedBy='$user_id',StockDate='$StockDate',Narration='$Narration',Status='Cr',CreatedDate='$CreatedDate'";
  $conn->query($qx);
  ...
  echo "<script>alert('Product Stock Added Successfully!');window.location.href='view-fr-raw-stock.php';</script>";
    ...
    $sql = "UPDATE tbl_fr_raw_stock SET ProdId='$ProdId',Qty='$Qty',Unit='$Unit',ModifiedBy='$user_id',StockDate='$StockDate',Narration='$Narration',Status='Cr',ModifiedDate='$CreatedDate' WHERE id='$id'";
    $conn->query($sql);
...
<?php 
  $sql12 = "SELECT * FROM tbl_cust_products WHERE Status='1' AND CreatedBy='$FranchiseId' AND ProdType='1'";
  $row12 = getList($sql12);
...
<div class="input-group">
    <input type="text" name="Qty" id="Qty" class="form-control" placeholder="" value="<?php echo $row7["Qty"]; ?>" autocomplete="off" required style="width: 200px;">
        <div class="input-group-append">
