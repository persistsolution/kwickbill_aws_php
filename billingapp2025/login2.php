                    ...
                    <div class="form-info">
                        <div class="form-section align-self-center">
                            <div class="btn-section clearfix">
                                <a href="index.php" class="link-btn active btn-1">OTP Login</a>
                                <a href="login2.php" class="link-btn btn-2  active-bg default-bg">PIN Login</a>
                            </div>
                            <div class="logo">
                                <a href="index.php">
                            ...
                            <form id="validation-form" method="post">
                                ...
                                <input type="hidden" name="action" class="form-control" value="Login2">
                                <div class="form-group clearfix">
