...
$qx = "INSERT INTO tbl_nso_vendor_expenses SET InvType='$InvType',TradeName='$TradeName',TypeOfVendor='$TypeOfVendor',PoNo='$PoNo',Locations='$Locations',AdvAmount='$AdvAmount',VedId='$VedId',UserId = '$user_id',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst',TempPrdId='$TempPrdId',TempPrdId2='$TempPrdId2',VedPhone='$VedPhone',FrId='$FrId',Photo='$Photo',Photo2='$Photo2',InvoiceNo='$InvoiceNo'";
  ...
  echo 1;
    ...
    $sql = "UPDATE tbl_nso_vendor_expenses SET InvType='$InvType',TradeName='$TradeName',TypeOfVendor='$TypeOfVendor',PoNo='$PoNo',Locations='$Locations',AdvAmount='$AdvAmount',VedId='$VedId',UserId = '$user_id',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst',TempPrdId='$TempPrdId',TempPrdId2='$TempPrdId2',VedPhone='$VedPhone',FrId='$FrId',Photo='$Photo',Photo2='$Photo2',InvoiceNo='$InvoiceNo',ManagerStatus=0,AdminStatus=0,BdmStatus=0,PurchaseStatus=0 WHERE id='$id'";
    $conn->query($sql);
      echo 1;
}
}
