...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_expense_request SET UserId = '$UserId',Status='0',Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',CreatedDate='$CreatedDate',CreatedBy='$user_id',Gst='$Gst',TempPrdId='$TempPrdId',TempPrdId2='$TempPrdId2',VedPhone='$VedPhone',FrId='$FrId'";
  $conn->query($qx); 
  $to = $row55['ExpMail'];
 ...
 ?>
        <div class="main-container">
            <div class="container">
                 ...
                 <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-default rounded">Add Newmm</a>
...
function(isConfirm){
  if (isConfirm) {
          window.location.href="view-expenses-test.php";
  }
}); });
