...
<?php 
  $sql12 = "SELECT * FROM tbl_cust_products2 WHERE Status=1 AND ProdType2 IN (1,3) ORDER BY ProductName";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
