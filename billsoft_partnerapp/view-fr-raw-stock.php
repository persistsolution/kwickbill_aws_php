        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="add-raw-prod-stock.php" class="btn btn-sm btn-default rounded">Add New</a>
                        ...
                        <?php 
                             $sql = "SELECT tp.*,twp.ProductName FROM tbl_fr_raw_stock tp INNER JOIN tbl_cust_products twp ON tp.ProdId=twp.id WHERE tp.FrId='$FranchiseId' AND tp.Status='Cr' ORDER BY tp.CreatedDate DESC";
                            $row = getList($sql);
