...
<head>
    <title><?php echo $Proj_Title; ?> - <?php if($_GET['id']) {?>Edit <?php } else{?> Add <?php } ?> Agency Account
    </title>
    <meta charset="utf-8">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0"><?php if($_GET['id']) {?>Edit <?php } else{?> Add
                            <?php } ?> Agency Account</h4>

                        <div class="card mb-4">
                            <div class="card-body">
                                <div id="alert_message"></div>
                                <form id="validation-form" method="post" autocomplete="off" action="ajax_files/ajax_agency.php" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" id="userid">
                                    <input type="hidden" name="action" value="Save" id="action">
                                          <fieldset>
 <legend>Agency Detail</legend>
                                    <div class="form-row">
    ...
    $(document).ready(function() {
        ...
        $('#validation-form').on('submit', function(e) {
            ...
            if ($('#validation-form').valid()) {
                ...
                $.ajax({
                    url: "ajax_files/ajax_agency.php",
                    method: "POST",
