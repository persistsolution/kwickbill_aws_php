...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_vendor_expenses SET GrnNo='$GrnNo',Locations='$Locations',PurchaseApproveDate='$ApproveDate',PurchaseComment='$MannagerComment',PurchaseAmount='$MgrAmount',PurchaseStatus='$ManagerStatus',PurchaseBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
