...
<?php 
  ...
  $sql = "UPDATE tbl_cust_products SET PurchasePrice='$PurchasePrice' WHERE id='$ProdId'";
  $conn->query($sql);
...
<input type="text" name="BarcodeNo" id="BarcodeNo" class="form-control" placeholder="" value="" autocomplete="off" required oninput="checkBarcodeNo(document.getElementById('BarcodeNo').value,<?php echo $BillSoftFrId;?>)">
...
<?php include_once 'footer_script.php'; ?>
 <script>
 function checkBarcodeNo(barcode,frid){
