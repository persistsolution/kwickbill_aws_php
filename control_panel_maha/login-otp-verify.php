...
<body>
    ...
    <div class="authentication-wrapper authentication-3">
        <div class="authentication-inner">
           ...
           <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover x p-5" style="background-image:url(back22.jpg);">
            ...
            <div class="d-flex col-lg-4 align-items-center bg-white p-5">
                ...
                <div class="d-flex col-sm-7 col-md-5 col-lg-12 px-0 px-xl-4 mx-auto">
                    <div class="w-100">
                        ...
                        <h4 class="text-center  font-weight-normal mt-3 mb-0">OTP Verification</h4>
<?php if($_REQUEST['phone'] == '8956431679' || $_REQUEST['phone'] == '9595454975'){
                                $fillotp = $_SESSION['otp'];
                            }
                            else if($_SERVER['REMOTE_ADDR'] == '49.36.35.28'){
                                 //$fillotp = $_SESSION['otp'];
                                 $fillotp = "";
                            }
                            else{
...
<label class="form-label">OTP</label>
  <input type="text" name="YourOtp" id="YourOtp" class="form-control" placeholder="" aria-label="Username" value="<?php echo $fillotp;?>" required="">
...
<input class="form-control" type="hidden" autocomplete="off" name="Uid" placeholder="Phone No" id="Uid" value="<?php echo $_REQUEST['Uid'];?>">
<input type="hidden" name="action" class="form-control" value="VerifyOtp">
