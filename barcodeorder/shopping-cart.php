            ...
            <div class="container" id="show_prod">
              ...
              $FrId = $_SESSION['FrId'];
                                    foreach ($_SESSION["cart_item"] as $product){
                                        ...
                                        $sql = "SELECT * FROM tbl_cust_products_2025 WHERE code = '$Prod_code' AND CreatedBy='$FrId'";
...
?>
            <div class="container mb-4">
                <div class="row my-3 h6 font-weight-normal">
                    <div class="col" style="font-weight:bold;color:rgba(232,37,37,1);">Net Payable</div>
                    <div class="col text-right text-mute" id="subtotal" style="font-weight:bold;">&#8377;<?php echo number_format($total_price3,2); ?></div>
                </div>
             <input type="hidden" id="totalprice" value="<?php echo $total_price3;?>">
              <hr>
               <div class="form-group col-md-12">
                                        ...
                                        <input type="hidden" name="FrId" id="FrId" value="<?php echo $_SESSION['FrId'];?>">
                                          ...
                                          <div class="form-group col-lg-12">
                                            ...
                                            <select class="form-control" id="PayType" name="PayType">
                                               ...
                                               <!-- <option selected="" value="Cash">Cash</option>-->
                                                 ...
                                                 <option <?php if ($row7['PayType2'] == 'Online Payment') { ?> selected <?php } ?> value="Online Payment">Online Payment</option>
            ...
            <div class="container">
               <a href="javascript:void(0)" onclick="savePrint()" id="saveprint" class="btn btn-default btn-block rounded">Place Order</a>
            </div><br><br>
            </form>
          <?php } else if(!isset($_SESSION["cart_item"]) && !isset($_SESSION["cart_item2"])) {?>
            
            <div class="container">
              <h5 style="color: red; text-align:center;">Your Cart Is Empty!!</h5>
                <a href="order/<?php echo $_SESSION['FrId'];?>" class="btn btn-default btn-block rounded"><span class="material-icons">local_mall</span> Order Now</a>
            </div>
          <?php } ?>
        </div>
    </main>
...
function savePrint(){
  ...
  data: {action:action,CellNo:CellNo,CustName:CustName,PayType:PayType,CustId:CustId,PackageId:PackageId,PkgAmt:PkgAmt,PkgDiscount:PkgDiscount,PkgValidity:PkgValidity,PkgId:PkgId,PrimeDiscount:PrimeDiscount,Featured:Featured,Print:Print,AccCode:AccCode,FrId:FrId},
  beforeSend:function(){
   ...
   success: function(data){
       ...
       if(PayType == 'Cash'){
        ...
        window.location.href="order/"+FrId;
       }
       else{
        var url = 'razorpay/pay.php?oid='+oid+'&FrId='+FrId+'&amount='+amount;
