                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form id="validation-form" method="post" autocomplete="off" action="ajax_files/ajax_employee.php" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="pageval" value="service" id="pageval">
                                    <fieldset>
...
<div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="Roll" id="Roll">
                                                ...
                                                <?php 
                                        $q = "select * from tbl_user_type WHERE Status=1 AND id=6";
                                        $r = $conn->query($q);
