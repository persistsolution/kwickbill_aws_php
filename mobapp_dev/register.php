...
<style type="text/css">
  ...
  margin-right: auto;
        ...
        <div class="main-container">
            ...
            <div class="container">
                ...
                <div class="alert alert-success" style="font-size: 15px;" align="center">
                          If Already Registered! <a href="index.php" >Sign In</a></div>
                <div class="card">
                  ...
                  <!-- <div class="form-group float-label active">
                    <select class="form-control" id="Roll" name="Roll">
                        <option value="55" selected>Customer</option>
      ...
      <!-- <div class="form-group float-label position-relative">
                        ...
                        <!--<input type="hidden" name="Roll" id="Roll" value="5"> -->
...
<script type="text/javascript">
 ...
 <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 ">
                      ...
                      <!--<div class="form-group float-label active">
                            <input type="text" class="form-control" id="ReferCode" name="ReferCode" value="">
                            <label class="form-control-label">Refer Code</label>                            
                        </div>-->
                    ...
                    <div class="card-footer">
                        <button class="btn btn-block btn-default rounded" type="submit" id="submit">Register & OTP Verify</button>
                    </div>
                </form>
                </div>
            </div>
                ...
                success:function(data){ 
                  //console.log(data);exit();
                   var res = JSON.parse(data);
                    ...
                    window.location.href="login-otp-verify2.php?roll="+roll+"&uid="+uid+"&phone="+Username;
                     }
