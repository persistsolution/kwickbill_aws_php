...
$ModifiedDate = date('Y-m-d');
    ...
    $query2 = "UPDATE tbl_expense_request SET Narration = '$Narration',Amount='$Amount',PaymentMode = '$PaymentMode',ExpenseDate='$ExpenseDate',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',Gst='$Gst' WHERE id = '$id'";
  $conn->query($query2);
...
<option value="Online" <?php if($row7["PaymentMode"] == 'Online') {?> selected <?php } ?>>
    By Online</option>
                        ...
                        <div class="form-group float-label active">
                          ...
                          <div class="form-group float-label active">
                         <main>
    <div class="slim" data-service="example/async_up1.php?mid=<?php echo $_GET['id'];?>&Roll=3" data-did-remove="handleImageRemoval">
        <?php if($row7['Photo'] != ''){?>
         <img src="../uploads/<?php echo $row7['Photo'];?>" alt="" id="img" style="height: 200px;width: 90%;">
         <?php } ?>
...
<label class="form-control-label">Upload Receipt</label>    
 ...
 <div class="form-group float-label active">
                         <main>
    <div class="slim" data-service="example/async_up1.php?mid=<?php echo $_GET['id'];?>&Roll=4" data-did-remove="handleImageRemoval">
        <?php if($row7['Photo2'] != ''){?>
          <img src="../uploads/<?php echo $row7['Photo2'];?>" alt="" id="img" style="height: 200px;width: 90%;">
          <?php } ?>
        <input type="file" name="slim[]" id="Photo" name="car3_logo" class="input_css"/>
