            ...
            <div class="container h-100">
                <div class="row h-100">
                    <div class="col-12 col-md-6 col-lg-4 align-self-center text-center my-3 mx-auto">
                        ...
                        <h2>&#8377;<?php echo number_format($_REQUEST['amount'],2); ?></h2>
                        <h6 class="text-secondary mb-3">Paid To <?php echo $_REQUEST['paidto'];?> </h6>
                        <p class="text-secondary"><?php echo date("M d, Y h:i a"); ?> </p> 
                    </div>
                </div>
            </div>
        </div>
