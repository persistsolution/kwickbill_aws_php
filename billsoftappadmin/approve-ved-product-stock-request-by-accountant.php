     ...
     <div class="layout-wrapper layout-1 layout-without-sidenav">
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <?php 
$id = $_GET['id'];
$sql7 = "SELECT tp.*,tu.Fname AS GodownName,tu2.Fname FROM tbl_cust_stock_ved_inv tp 
            LEFT JOIN tbl_users_bill tu ON tu.id=tp.FrId 
            LEFT JOIN tbl_users tu2 ON tu2.id=tp.VedId 
            WHERE tp.id='$id'";
$row7 = getRecord($sql7);

$sql2 = "SELECT * FROM tbl_cust_ved_prod_stock WHERE InvId='$id'";
$rncnt2 = getRow($sql2);
...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_cust_stock_ved_inv SET AccountantApproveDate='$AdminApproveDate',AccountantComment='$AdminComment',AccountantStatus='$AdminStatus',AccountantBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);

  echo "<script>alert('Approved Successfully!');window.location.href='accoutant-ved-pending-request-product-stock.php';</script>";
...
?>
                            ...
                            <div class="card-body">
                                ...
                                <div id="alert_message"></div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <?php 
                                        $sql88 = "SELECT * FROM tbl_cust_ved_prod_stock WHERE InvId='$id'";
                                        $row88 = getList($sql88);
                                        foreach($row88 as $result){
                                        if($row7['ProdType'] == 1){
                                            $sql99 = "SELECT ProductName FROM tbl_cust_products2 WHERE id='".$result['ProdId']."'";
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="" value="<?php echo $result['Qty2']." ".$result['Unit2']; ?>" readonly>
                                            <div class="clearfix"></div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <?php } else {
                                            $sql99 = "SELECT ProductName FROM tbl_cust_products_2025 WHERE id='".$result['ProdId']."'";
                                            $row99 = getRecord($sql99);
 ...
 <div class="form-group col-md-4">
                                            ...
                                            <input type="date" name="AdminApproveDate" class="form-control"
                                                placeholder="" value="<?php echo $row7["AccountantApproveDate"]; ?>" required>
                                            <div class="clearfix"></div>
                                        </div>
 ...
 <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="AdminStatus" name="AdminStatus" required="">
                                                ...
                                                <option value="1" <?php if($row7["AccountantStatus"]=='1') {?> selected
                                                    <?php } ?>>Approved</option>
                                                <option value="0" <?php if($row7["AccountantStatus"]=='0') {?> selected
                                                    <?php } ?>>Pending</option>
                                                    <option value="2" <?php if($row7["AccountantStatus"]=='2') {?> selected
                                                    <?php } ?>>Reject</option>
                                            </select>
                                            <div class="clearfix"></div>
                                        </div>
 <div class="form-group col-md-12">
                                            ...
                                            <textarea name="AdminComment" class="form-control"
                                                placeholder=""><?php echo $row7["AccountantComment"]; ?></textarea>
                                            <div class="clearfix"></div>
                                        </div>
