  ...
  <header class="header">
    ...
    color: white;">&#8377;<?php echo number_format($mybalance,2);?></a>&nbsp;&nbsp;&nbsp;
                    ...
                    <a href="shopping-cart.php" class=" btn btn-40 btn-link" style="padding-top:10px;">
                        ...
                        <span  class="counter" style="color:#fff;font-weight:600;font-size:13px;"><span style="background-color:#287939;padding:4px;border-radius:10px;" id="showcount"></span></span> 
                    </a>
                   ...
                   $profileurl = "profile.php"; 
                    ...
                    ?>
                    <a href="<?php echo $SiteUrl;?>/<?php echo $profileurl; ?>" class="avatar avatar-30 shadow-sm rounded-circle ml-2">
                        <figure class="m-0">
