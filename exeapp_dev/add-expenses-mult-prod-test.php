...
if($_GET['id']!=''){
    ...
    foreach($row as $result){
        ...
        $ProdId = $result['ProdId'];
         $productByCode = $db_handle->runQuery("SELECT id,code,ProductName FROM tbl_cust_products_2025 WHERE id='$ProdId'");
     $itemArray = array($productByCode[0]["code"]=>array('code'=>$productByCode[0]["code"],'prdsrno'=>$prdsrno,'id'=>$ProdId,'ProductName'=>$productByCode[0]["ProductName"],'PurchasePrice'=>$result["PurchasePrice"],'SellPrice'=>$result["SellPrice"],'Qty'=>$result["Qty"]));
    ...
    <main class="flex-shrink-0 main">
        ...
        <div class="main-container">
            <div class="container">
                ...
                <div class="card">
                    <form id="validation-form" method="post" autocomplete="off" enctype="multipart/form-data" action="">
                        <div class="card-body">
...
<div class="form-group float-label active">
                                <select class="form-control" name="ExpCatId[]" id="ExpCatId<?php echo $i;?>" required>
                                ...
                                <label class="form-control-label">Expense Category</label>
                                    ...
                                    <div class="form-group float-label active col-6">
                                        <input type="date" class="form-control" name="ExpenseDate[]" id="ExpenseDate<?php echo $i;?>" value="<?php echo $result33['ExpenseDate']; ?>" required>
...
<div class="form-group float-label active">
                                <select class="form-control" name="ExpCatId[]" id="ExpCatId<?php echo $i;?>">
                                    <option selected="" value="" disabled>Select Expense Category</option>
                                ...
                                <div class="form-group float-label active col-6">
                                    <input type="text" class="form-control txt" name="Amount[]" id="Amount<?php echo $i;?>" value="" autofocus oninput="calTotAmt()">
                                    <label class="form-control-label">Amount</label>
                                </div>

                                <div class="form-group float-label active col-6">
                                    <input type="date" class="form-control" name="ExpenseDate[]" id="ExpenseDate<?php echo $i;?>" value="">
                                    <label class="form-control-label">Expense Date</label>
                                </div>


                                <div class="form-group float-label active col-6">
                                    <select class="form-control" name="PaymentMode[]" id="PaymentMode<?php echo $i;?>">
                                        <option selected="" value="" disabled>Select Payment Type</option>
                                        <option value="Cash">
                                            By Cash</option>
                                        <option value="Online">
                                ...
                                <div class="form-group float-label active col-6">
                                    <input type="number" class="form-control" name="VedPhone[]" id="VedPhone<?php echo $i;?>" value="">
                                    <label class="form-control-label">Vendor Mobile No</label>
                                </div>


                                <div class="form-group float-label active col-12">
                                    <input type="text" class="form-control" id="Narration<?php echo $i;?>" name="Narration[]" value="">
                                    <label class="form-control-label">Narration</label>
                                </div>
...
<input type="hidden" id="TotalAmt<?php echo $i;?>" class="form-control">
                ...
                <div class="form-row" style="padding-left: 20px;">
                    ...
                    <div class="form-group float-label active col-6">
                        <input type="date" class="form-control" id="ExpDate" name="ExpDate" value="<?php echo $ExpDate; ?>" required>
...
function loadExpenseRow() {
    ...
    $.ajax({
        url: "ajax_files/ajax_expenses_mult_prod_test.php",
        method: "POST",
        data: {
            action: action,
            id: expenseRowCount
