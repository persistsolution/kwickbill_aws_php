...
<head>
<title><?php echo $Proj_Title; ?> | Scheme</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">List Of Employee Scheme
...
<span class="font-weight-light">Employee Scheme</span>
</h5>
...
function product_lists(){
  var action = 'view';
      $.ajax({
  type: "POST",
  url: "ajax_files/ajax_emp_scheme.php",
   data:{action:action},  
  ...
  $(document).ready(function() {
    ...
    $('#example').DataTable( {
      ...
      $('#add_button').click(function(){  
           $('.modal-title').html("Add <span class='font-weight-light'>Scheme</span>");  
           $('#action').val("Add");  
           $('#id').val('');
