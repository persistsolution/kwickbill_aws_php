     ...
     <div class="layout-wrapper layout-1 layout-without-sidenav">
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <?php 
$id = $_GET['id'];
$sql7 = "SELECT te.*,tu.Fname,tu.Lname,tu.Photo AS Uphoto,tu.CustomerId FROM tbl_vendor_expenses te LEFT JOIN tbl_users tu ON tu.id=te.VedId WHERE te.id='$id'";
$row7 = getRecord($sql7);
$CustId = $row7['VedId'];
$CustName = $row7['Fname'];
...
if(isset($_POST['submit'])){
 ...
 //$TicketNo= "#".rand(1000,9999);
    $query2 = "UPDATE tbl_vendor_expenses SET UtrNo='$UtrNo',PayAmount='$PayAmount',BalAmt='$BalAmt',PaymentDate='$PaymentDate',PaymentStatus='$PaymentStatus',PayBy='$user_id',PayNarration='$PayNarration' WHERE id = '$id'";
  $conn->query($query2);
  
    $sql = "INSERT INTO tbl_vendor_expense_ledger SET UtrNo='',UserId='$CustId',AccCode='$AccCode',AccountName='$CustName',InvoiceNo='$InvoiceNo',
  ...
  echo "<script>alert('Amount Paid Successfully!');window.location.href='view-payable-amount-vendors.php';</script>";
...
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Pay Amount To Vendor</h4>
...
<option value="Tax Invoice" <?php if($row7["InvType"] == 'Tax Invoice') {?> selected <?php } ?>>
    Tax Invoice</option>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="MgrAmount"
                                       ...
                                       <!-- <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="PayAmount" id="PayAmount" class="form-control"
                                                placeholder="" value="<?php echo $row7["MgrAmount"]; ?>" required oninput="calBalAmount()" readonly>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label class="form-label">Balance Amount</label>
                                            <input type="text" name="BalAmt" id="BalAmt" class="form-control"
                                                placeholder="" value="<?php echo $row7["Amount"]-$row7["MgrAmount"]; ?>" readonly>
                                            <div class="clearfix"></div>
                                        </div>
...
<br>
 ...
 <script>
     function calBalAmount(){
         var MgrAmount = $('#MgrAmount').val();
         var PayAmount = $('#PayAmount').val();
         var BalAmt = Number(MgrAmount)-Number(PayAmount);
