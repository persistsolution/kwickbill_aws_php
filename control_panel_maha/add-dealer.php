...
<head>
    <title><?php echo $Proj_Title; ?> - <?php if($_GET['id']) {?>Edit <?php } else{?> Add <?php } ?> Dealer Account
    </title>
    <meta charset="utf-8">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form id="validation-form" method="post" autocomplete="off" action="ajax_files/ajax_dealer.php" enctype="multipart/form-data">
 ...
 <legend>Dealer Detail</legend>
                                    <div class="form-row">
                                       ...
                                       <div class="form-group col-md-12">
                                            <label class="form-label">Dealer Name <span
    ...
    $(document).ready(function() {
        ...
        $('#validation-form').on('submit', function(e) {
            ...
            if ($('#validation-form').valid()) {
                ...
                $.ajax({
                    url: "ajax_files/ajax_dealer.php",
                    method: "POST",
