...
$sql = "INSERT INTO tbl_task_new SET UserId='$ExeId',TaskDate='$TaskDate',DueDate='$DueDate',TaskName='$TaskName',CreatedBy='$user_id',CreatedDate='$CreatedDate',Status='0',Photo='$Photo'";
                $conn->query($sql);
