                    ...
                    if ($number > 0) {
                        for ($i = 0; $i < $number; $i++) {
                            if (trim($_POST["ProdId"][$i] != '')) {
                                ...
                                $sql22 = "INSERT INTO tbl_raw_stock SET ProdId='$ProdId',Qty='$Qty',CreatedDate='$CreatedDate',UseRawId='$UseRawId',CrDr='dr',Narration='$Narration',Unit='$Unit',UnitId='$UnitId'";
                                $conn->query($sql22);
                            }
                        }
                    }
...
<input type="text" name="Qty[]" id="Qty1" class="form-control" placeholder="e.g.,S12" value="" autocomplete="off" oninput="getSubTotal()">
