...
$PurchaseProdPrice = addslashes(trim($_POST['PurchaseProdPrice']));
...
$id = $_POST['id'];
$sql = "SELECT MinPrice,PurchasePrice FROM tbl_cust_products WHERE id='$id'";
$row = getRecord($sql);
...
$frid = $_POST['frid'];
$sql = "SELECT id,ProductName FROM tbl_cust_products WHERE BarcodeNo='$barcode' AND CreatedBy='$frid'";
$row = getRecord($sql);
