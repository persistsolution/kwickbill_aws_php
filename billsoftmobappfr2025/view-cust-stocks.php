...
<?php } ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="add-cust-stock.php" class="btn btn-sm btn-default rounded">Add New</a>
                    ...
                    $sql = "SELECT * FROM tbl_cust_stock_inv_2025 WHERE FrId='$FranchiseId'";
                            $row = getList($sql);
...
WHERE InvId = '".$result['id']."'";
             
                $row2 = getRecord($sql2);
                            ?>
                        <div class="card mb-4">
                            <a href="view-product.php?id=<?php echo $result['id'];?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                    ...
                                    <div class="col-auto pl-0" style="padding-top: 20px;">
                                        <?php if($row2['checkstatus_1_count']>0){?>
                                         <span style="color:green;font-weight: 500;">Stock Added</span>
                                        <?php } else{?>
                                       <span style="color:red;font-weight: 500;">Stock In Pending</span>
                                       <?php } ?>
