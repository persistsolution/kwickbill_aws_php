...
<h4 class="font-weight-bold py-3 mb-0">Night End Attendance
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            LEFT JOIN tbl_users tc ON tc.id=tp.UserId WHERE tp.Type=1 AND tp.AttRoll=1 AND tp.CreatedDate>='2024-09-01'";
            if($_POST['ExeId']){
                $ExeId = $_POST['ExeId'];
                if($ExeId == 'all'){
                    $sql.= " ";
           ...
           if($_POST['FromDate']){
            ...
            <tr>
                ...
                <td><a href="take-night-end-attendance.php?id=<?php echo $row['id']; ?>" target="_new">Click For End Attendance</a></td>
