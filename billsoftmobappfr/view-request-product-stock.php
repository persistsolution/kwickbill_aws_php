...
<?php } ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="request-product-stock.php" class="btn btn-sm btn-default rounded">Add New</a>
                        ...
                        <?php 
                             ...
                             $sql = "SELECT tp.*,tu.Fname AS GodownName,tu2.ShopName FROM tbl_request_product_stock_2025 tp 
            ...
            ORDER BY tp.CreatedDate DESC";
                            ...
                            foreach($row as $result){
                                $sql2 = "SELECT * FROM tbl_request_product_stock_items_2025 WHERE TransferId='".$result['id']."'";
               $rncnt2 = getRow($sql2);
                            ?>
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="mb-1">#<?php echo $result['id'];?> </h5>
                                        <p class="text-secondary"><?php echo date("d/m/Y", strtotime(str_replace('-', '/',$result['StockDate'])))?><br>
                                           Total Qty : <?php echo $rncnt2;?><br>
                                           Narration : <?php echo $result['Narration'];?>
                                       </p>
                                    ...
                                    <div class="col-auto pl-0">
                                        ...
                                        if($result['ApproveStatus']==1){?>
                                            <a href="view-product-stock.php?id=<?php echo $result['id'];?>" class="btn btn-sm btn-default rounded">View Stock</a>
                                        <?php } else if($result['UpdateStatus'] == 1){?>
                                       <a href="check-product-stock.php?id=<?php echo $result['id'];?>" class="btn btn-sm btn-default rounded">Check Stock</a>
                                   <?php } else {?>
<a href="view-request-product-stock-items.php?id=<?php echo $result['id'];?>" class="btn btn-sm btn-default rounded">View Items</a>
                                   <?php } ?>
