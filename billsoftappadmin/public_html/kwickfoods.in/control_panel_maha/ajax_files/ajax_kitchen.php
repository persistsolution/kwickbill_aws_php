...
$conn->query($sql3);
  ...
  echo "<script>alert('Record Created Successfully!');window.location.href='../view-kitchen-accounts.php';</script>";
 ...
 if($rncnt2 > 0){
     ...
     echo "<script>alert('Phone No Already Exists!');window.location.href='../add-kitchen-account.php?id=$id';</script>";
...
$conn->query($sql3);*/
  ...
  echo "<script>alert('Record Updated Successfully!');window.location.href='../view-kitchen-accounts.php';</script>";
