...
$CreatedTime = date('h:i a');
      ...
      $qx = "INSERT INTO tbl_other_feedback SET FeedId='$id',CustId='$CustId',CustName='$Fname',Phone = '$Phone',EmailId='$EmailId',Status='1',Address='$Address',CreatedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime',Details='$Details',CreatedDate='$CreatedDate',CreatedTime='$CreatedTime'";
  $conn->query($qx);
...
$i=2;
$id = $_GET['id'];
 $sql2 = "SELECT tp.*,tu.Fname,tu.Lname FROM tbl_other_feedback tp 
...
$id = $_GET['id'];
  $sql2 = "SELECT tp.*,tu.Fname,tu.Lname FROM tbl_other_feedback tp 
          LEFT JOIN tbl_users tu ON tp.CreatedBy=tu.id WHERE tp.FeedId='$id'
          ORDER BY tp.id DESC"; 
