...
<div class="form-group col-md-3">
                                    ...
                                    <br>
                                    <?php if ($user_id == 2651 || $user_id == 2650 || $user_id == 5 || $user_id == 415) { ?>
<div class="row">
    ...
    <?php
    $sql33 = "SELECT * FROM tbl_option_cp WHERE id IN (75,85,19,29,30,31,32,33,34,35,36,37,39,49,50,51,60,61,62,74,100,101)";
    $row33 = getList($sql33);
    foreach ($row33 as $result) {
    ?>
    <div class="form-group col-md-4">
    ...
    <?php
    $sql33 = "SELECT * FROM tbl_option_cp WHERE id IN (21,22,23,24,25,26,27,77,79,80,81,82,83,84,78,96,97,98)";
    $row33 = getList($sql33);
    foreach ($row33 as $result) {
    ?>
    <div class="form-group col-md-4">
    ...
    <?php
    $sql33 = "SELECT * FROM tbl_option_cp WHERE id IN (52,53,54,55,56,57,58,59,94)";
    $row33 = getList($sql33);
    foreach ($row33 as $result) {
    ?>
    <div class="form-group col-md-4">
...
<div class="form-row">               
 ...
 <?php  
                                        $sql33 = "SELECT * FROM  tbl_users_bill WHERE Roll=5 AND Status=1 AND OwnFranchise=1";
                                        $row33 = getList($sql33);
                                        foreach($row33 as $result){
                                        ?>
