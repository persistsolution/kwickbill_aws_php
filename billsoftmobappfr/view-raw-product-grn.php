...
<?php } ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="add-raw-product-grn.php" class="btn btn-sm btn-default rounded">Add New</a>
                    ...
                    $sql = "SELECT tc.*,tu.Fname FROM tbl_cust_stock_ved_inv tc LEFT JOIN tbl_users tu ON tu.id=tc.VedId WHERE tc.FrId='$FranchiseId' AND ProdType=1";
                            $row = getList($sql);
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-auto pl-0" style="padding-top: 20px;">
                                        <a href="view-raw-product-grn-lists.php?id=<?php echo $result['id'];?>" class="btn btn-sm btn-success rounded">
                                       View
                                       </a>
