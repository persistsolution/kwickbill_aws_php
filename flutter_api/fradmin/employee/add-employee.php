...
$row7 = getRecord($sql7);
$row7['MenuId'] = explode(',', $row7['MenuId']);
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                       ...
                       <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form id="validation-form" method="post" autocomplete="off" action="save_employee.php" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" id="userid">
                                       <input type="hidden" name="frid" value="<?php echo $_REQUEST['user_id']; ?>" id="frid">
...
<div class="form-group col-md-4">
                                    ...
                                    <br>
                                       ...
                                       <?php  
$sql33 = "SELECT * FROM tbl_dynamic_menu WHERE id != '27'";
$row33 = getList($sql33);
    ...
    <fieldset>
        <legend>
            <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" name="MenuId[]" value="<?php echo $result['id']; ?>" 
                <?php if (in_array($result['id'], $row7['MenuId'])) { ?>checked="checked"<?php } ?>>
                <span class="custom-control-label"><?php echo $result['title']; ?></span>
            </label>
        </legend>

        <div class="form-row">
            <?php  
            $sqlSub = "SELECT * FROM tbl_sub_menu WHERE menuid = '" . $result['id'] . "'";
            $rowSub = getList($sqlSub);
            foreach ($rowSub as $result33) {
            ?>
                <div class="form-group col-md-6">
                    <label class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" name="submenuid[]" value="<?php echo $result33['id']; ?>"
                        <?php if (in_array($result33['id'], $row7['submenuid'])) { ?>checked="checked"<?php } ?>>
                        <span class="custom-control-label"><?php echo $result33['title']; ?></span>
                    </label>
                </div>
            <?php } ?>
        </div>
