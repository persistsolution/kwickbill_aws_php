...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="analytics">
 ...
 $sql = "SELECT * FROM tbl_customer_invoice_2025 tci WHERE tci.FrId='$FranchiseId' AND tci.ShopFrom NOT IN ('CustApp','Barcode')";
                            ...
                            <li class="list-group-item" style="border-radius: 10px;">
                                <div class="row align-items-center">
                                    <div class="col align-self-center pr-0">
                                        <h6 class="font-weight-normal mb-1" style="color:black;"><?php echo $result['InvoiceNo'];?></h6>
                                        <p class="small text-secondary">Date : <?php echo date("d/m/Y", strtotime(str_replace('-', '/',$result['InvoiceDate'])));?> | Time : <?php echo date("h:i a", strtotime(str_replace('-', '/',$result['CreatedTime'])));?> </p>
                                    </div>
                                    <div class="col-auto">
