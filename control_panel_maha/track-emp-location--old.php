...
<?php 
$sql22 = "SELECT Lattitude,Longitude,UnderFrId FROM tbl_users WHERE id='".$_GET['id']."'";
$row22 = getRecord($sql22);
 $Lattitude = $row22['Lattitude'];
...
<script type="text/javascript">
    var markers = [
        <?php 
        $sql = "SELECT Lattitude,Longitude FROM tbl_users WHERE id='".$row22['UnderFrId']."'";
        $row = getRecord($sql);?>
        {
            "title": 'Employee Location',
            "latitude": '<?php echo $Lattitude;?>',
