       ...
       <div class="container mb-2"  >
                ...
                <div class="swiper-container categoriestab1 text-center">
                    <div class="swiper-wrapper">
                        ...
                        <?php 
                          $sql2 = "SELECT * FROM category WHERE Status='1' AND Roll IN(2,3)";
             ...
             <?php } ?>
                                 ...
                                 <p class="" style="line-height: 12px;padding-top: 5px;"><small style="color: white;"><?php echo $row2["Name"];?></small></p>
                                </div>
...
<div class="container mb-4">
    ...
    <?php 
     ...
     $start_from = ($page - 1) * $results_per_page;  
                        ...
                        $SubCatId = $_GET['subid'];
                        $brand_id = $_GET['brand_id'];
                        $query = "SELECT * FROM products WHERE Status='1' AND ProdFor IN(2,3)";
                        if($_GET['cat_id']!=''){
      ...
      <input type="hidden" id="qntno<?php echo $result["id"];?>" value="1">   
             ...
             <?php } ?>
                        ...
                        <br> -->
                                                        ...
                                                        <h5 class="mb-0" id="MinPrice3<?php echo $result["id"];?>">
                                         <?php if($result['MaxPrice'] != $result['MinPrice']){?>                   <del>&#8377;<?php echo number_format($result["MaxPrice"],2);?> </del>
                                         <?php } ?>
