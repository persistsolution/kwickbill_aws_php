...
$adminSections = [
    // Roll = 1
    ['title' => 'Dashboard',               'ids' => [1,2,3],                                        'roll' => 1],
    ['title' => 'Top Sell Dashboard',      'ids' => [4,5,6],                                        'roll' => 1],
    ['title' => 'Accounts',                'ids' => [7,8,61],                                       'roll' => 1],
    ['title' => 'Selling Products',        'ids' => [9,12,13,15,16,17,18,19,20,21,22,58,68,69],  'roll' => 1],
    ['title' => 'Raw Products',            'ids' => [23,24,25,26,27],                               'roll' => 1],
    ['title' => 'Godown Products',        'ids' => [118,119,70,120],  'roll' => 1],
    ['title' => 'Godown',                  'ids' => [28,29,30,31,35,122],                      'roll' => 1],
    ['title' => 'Franchise Stock Request', 'ids' => [36,37,38],                                     'roll' => 1],
    ['title' => 'Target Complete',         'ids' => [39,40,41,42,43],                               'roll' => 1],
    ['title' => 'Reports',                 'ids' => [44,45,46,47,48,49,50],                         'roll' => 1],
    ['title' => 'Franchise Reports 2025',  'ids' => [51,52,53,54,55,56,57,58,59],                   'roll' => 1],
    ['title' => 'Franchise Reports 2024',  'ids' => [63,64,65,66,67],                               'roll' => 1],
    ['title' => 'Action',                  'ids' => [10,11,14],                                     'roll' => 1],
];

$franchiseSections = [
    // Roll = 2
    ['title' => 'Other Access',        'ids' => [71,72,73,112,113],               'roll' => 2],
    ...
    ['title' => 'Return Products',     'ids' => [107,108],                          'roll' => 2],
    ['title' => 'Receive Stocks',      'ids' => [109,110,111],                      'roll' => 2],
...
<div class="form-row">               
                        ...
                        checked="checked" <?php } ?>>
                                    ...
                                    <?php } ?>
                                     ...
                                     <fieldset>
 <legend>FOCO Franchise Access</legend>
<div class="form-row">               
                        ...
                        checked="checked" <?php } ?>>
                                    ...
                                    <?php } ?>
                                     ...
                                     <fieldset>
 <legend>COFO Franchise Access</legend>
<div class="form-row">               
