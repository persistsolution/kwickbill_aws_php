...
State: Maharashtra</div>
        ...
        <?php 
$i=1;
$sql44 = "SELECT ttg.*,tgp.ProductName FROM tbl_cust_ved_prod_stock ttg LEFT JOIN tbl_cust_products2 tgp ON ttg.ProdId=tgp.id WHERE ttg.InvId='$id'";
$row44 = getList($sql44);
...
?>                            <tr>
                                                ...
                                                <td class="py-3">
                                                    <strong><?php echo $result['Qty2']." ".$result['Unit2'];?></strong>
                                                </td>
                                                <!-- <td class="py-3">
                                                ...
                                                <td class="py-3">
                                                 ...
                                                 <td class="py-3">
                                                    <strong><?php echo $result['PurchasePrice']*$result['Qty2'];?></strong>
                                                </td>
