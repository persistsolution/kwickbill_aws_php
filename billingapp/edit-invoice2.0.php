                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                <label class="form-label">Train/Flight Name <span class="text-danger">*</span></label>
                                                                <input type="text" name="TrainName[]" class="form-control" placeholder="e.g.,Nagpur To Pune" value="<?php echo $result12["TrainName"];?>" autocomplete="off" required>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-1">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="Age[]" id="Age<?php echo $i; ?>" class="form-control" placeholder="e.g.,32" value="<?php echo $result12["Age"];?>" autocomplete="off" >
                                                    ...
                                                    <div class="card-header">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-1">
                                                                <label class="form-label">Age</label>
                                                                <div class="input-group">
                                                                    <input type="text" name="Age[]" id="Age<?php echo $row_cnt; ?>" class="form-control" placeholder="e.g.,32" value="" autocomplete="off">
