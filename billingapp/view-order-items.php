...
<table id="example" class="table mb-0 dataTable no-footer" role="grid" aria-describedby="report-table_info">
        ...
        <tbody>
            <?php 
              ...
              if($_REQUEST['year'] == '2025'){
                $sql = "SELECT tcid.*,tcp.ProductName FROM tbl_customer_invoice_details_2025 tcid INNER JOIN tbl_cust_products_2025 tcp ON tcid.ProdId=tcp.id WHERE tcid.ServerInvId='".$_GET['id']."'";  
              }
              else{
